...
export const KNIP_UNUSED_EXPORT_BASELINE = [
  ...
  "src/channels/status-footer.ts: finalizeStatusFooterRun",
  "src/channels/status-footer.ts: noteStatusFooterRunStarted",
  "src/channels/status-footer.ts: resetStatusFooterStateForTest",
