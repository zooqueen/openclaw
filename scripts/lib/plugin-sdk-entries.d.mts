...
export const packagedPrivateRuntimePluginSdkEntrypoints: string[];
export const packageBuildPluginSdkEntrypoints: string[];
...
export function listPackagedPrivateRuntimePluginSdkDistArtifacts(): string[];
