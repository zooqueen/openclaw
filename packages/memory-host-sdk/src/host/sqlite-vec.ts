...
const SQLITE_VEC_CONFIG_HINT =
  "Set agents.defaults.memory.search.store.vector.extensionPath, or an agent-specific memory.search.store.vector.extensionPath, to a sqlite-vec loadable extension path.";
