...
`,
      ...
      expect(calls).toContain("pnpm test:changed .local/gates-test.log pnpm test:changed\n");
      expect(calls).toContain(
        "pnpm test:changed (lease-retry) .local/lease-retry-test.log pnpm test:changed\n",
      );
