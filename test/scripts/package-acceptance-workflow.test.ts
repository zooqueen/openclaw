...
describe("package artifact reuse", () => {
  ...
  it("runs full release children from the trusted workflow ref", () => {
    ...
    expectTextToIncludeAll(workflow, [
      ...
      "Verify release checks accepted advisory lanes",
      "release_checks_advisory_only",
      "release_check_blocking_job",
      "is a blocking release-check lane",
      '"Run repo/live E2E validation" | \\',
      '"Run repo/live E2E validation / "* | \\',
      '"Run Docker release-path validation" | \\',
      '"Run Docker release-path validation / "* | \\',
      '"Enforce QA Lab runtime tool coverage" | \\',
      '"Enforce QA Lab runtime tool coverage / "* | \\',
      '"Run package acceptance" | \\',
      '"Run package acceptance / "* | \\',
      'startswith("Run repo/live E2E validation / ")',
      'startswith("Run Docker release-path validation / ")',
      'startswith("Run package acceptance / ")',
      'startswith("cross_os_release_checks / ")',
      'startswith("Enforce QA Lab runtime tool coverage / ")',
      'startswith("install_smoke_release_checks / ")',
