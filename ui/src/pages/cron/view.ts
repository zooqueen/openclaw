                          ...
                          <label class="field cron-span-2">
                            ...
                            >
                              ...
                              <option value="disabled">
                                ${t("cron.form.failureAlertDisabled")}
                              </option>
                          ...
                          ${props.form.failureAlertMode === "custom"
                            ? html`
                                <label class="field">
                                  ...
                                  />
                                  <div class="cron-help">
                                    ${t("cron.form.failureAlertAfterHelp")}
                                  </div>
                                  ${renderFieldError(
                                    props.fieldErrors.failureAlertAfter,
                                    errorIdForField("failureAlertAfter"),
                                ...
                                <label class="field">
                                  ...
                                  />
                                  <div class="cron-help">
                                    ${t("cron.form.failureAlertCooldownHelp")}
                                  </div>
                                  ${renderFieldError(
                                    props.fieldErrors.failureAlertCooldownSeconds,
                                    errorIdForField("failureAlertCooldownSeconds"),
                                ...
                                <label class="field">
                                  ${renderFieldLabel(t("cron.form.failureAlertMode"))}
                                  <select
                                  ...
                                  >
                                    <option value="announce">
                                      ${t("cron.form.failureAlertAnnounce")}
                                    </option>
                                    <option value="webhook">
                                      ${t("cron.form.failureAlertWebhook")}
                                    </option>
                                  </select>
                                </label>
                                <label class="field">
