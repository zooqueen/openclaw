...
export const pl: TranslationMap = {
  ...
  sessionsView: {
    ...
    sessionsArchived: "Zarchiwizowano wątki: {count}",
    deleteAllArchived: "Usuń wszystkie zarchiwizowane…",
    deleteAllArchivedConfirm: "Usunąć zarchiwizowane wątki ({count}) i ich transkrypcje?",
    ...
    dashboardAvailable: "Panel jest dostępny",
    approvalNeeded: "Wymagane zatwierdzenie",
    ...
    customEmoji: "Niestandardowy emoji",
    invalidEmojiIcon: "Wprowadź dokładnie jeden emoji.",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint: "JPEG, PNG lub WebP. Obrazy są kadrowane względem środka i skalowane do 512 px.",
      profileLoadFailed: "Nie udało się wczytać Twojego profilu.",
      profileSaveFailed: "Nie udało się zapisać Twojego profilu.",
  ...
  configView: {
    ...
    syncedHint: "Synchronizowane między Twoimi urządzeniami za pośrednictwem gateway.",
    notifications: {
    ...
    sidebarPrefs: {
      title: "Pasek boczny",
      hint: "Wybierz, co ma być wyświetlane podczas trwania sesji.",
      liveActivity: "Pokazuj aktywność agenta na żywo na pasku bocznym",
      liveActivityHint:
  ...
  execApproval: {
    ...
    reviewRequest: "Sprawdź prośbę o zatwierdzenie od {agent}: {command}",
  ...
  subtitles: {
    ...
    apps: "Aplikacje towarzyszące na telefon, zegarek, komputer i do przeglądarki.",
    ...
    labs: "Eksperymentalne możliwości agentów i narzędzi.",
  ...
  custodian: {
    title: "OpenClaw",
    subtitle: "Przewodnik po konfiguracji systemu",
    ...
    history: {
      ...
      description: "Zmiany wprowadzone w tym systemie, od najnowszych.",
      loading: "Ładowanie ostatnich zmian…",
      empty: "Nie zarejestrowano jeszcze żadnych zmian.",
      requestFailed: "OpenClaw nie może załadować historii zmian.",
      loadMore: "Wczytaj więcej",
      loadingMore: "Ładowanie kolejnych…",
      changedPaths: "Zmienione ścieżki ({count})",
      invalidEdit: "Ta ręczna zmiana nie przeszła walidacji konfiguracji.",
      opaqueChange:
        "Formatowanie lub komentarze uległy zmianie bez widocznych zmian ścieżek konfiguracji.",
      sources: {
        ...
        manualEdit: "ręczna zmiana",
        unknown: "nieznane",
      },
    },
    nudge: {
      configReload:
        "Ponowne wczytywanie konfiguracji zostało zatrzymane — zapytaj mnie, co się stało",
      channelAuth:
        "Uwierzytelnianie kanału {channel} działa nieprawidłowo — zapytaj mnie, co się stało",
      channelDisconnected: "Kanał {channel} właśnie się rozłączył — zapytaj mnie, co się stało",
      channelDegraded: "Kanał {channel} działa nieprawidłowo — zapytaj mnie, co się stało",
  ...
  mcpServers: {
    ...
    configUnavailable: "Konfiguracja jest niedostępna; odśwież stronę i spróbuj ponownie.",
    connectRequired: "Połącz się z Gateway, aby zmienić serwery MCP.",
    adminRequired: "Zmiany serwerów MCP wymagają uprawnień operator.admin.",
    enable: "Włącz",
    disable: "Wyłącz",
  ...
  mcpPage: {
    connectorsLink: "Odkryj konektory instalowane jednym kliknięciem na stronie wtyczek.",
    servers: "Serwery",
    oauth: "OAuth",
    filtered: "Filtrowane",
  ...
  labsPage: {
    intro:
      "Laboratorium zawiera eksperymentalne funkcje, które mogą się zmienić, przestać działać lub zniknąć między wydaniami.",
    sectionTitle: "Funkcje eksperymentalne",
    sectionDescription:
      "Zmiany są zapisywane natychmiast i obowiązują przy przyszłych uruchomieniach agentów.",
    documentation: "Dokumentacja",
    restartRequired: "Wymagane ponowne uruchomienie Gateway.",
    saveErrorTitle: "Nie udało się zaktualizować funkcji",
    saveFailed: "Nie udało się zapisać ustawienia funkcji.",
    codeMode: {
      title: "Tryb kodu",
      description:
        "Pozwól agentom łączyć narzędzia w kompaktowych przepływach pracy JavaScript uruchamianych w piaskownicy.",
    },
    swarm: {
      title: "Rój",
  ...
  appsPage: {
    ...
    heroTagline:
      "Aplikacje towarzyszące na telefon, zegarek, komputer i do przeglądarki — oraz wtyczki rozszerzające możliwości Twojego agenta.",
    ...
    badgeBundledIos: "W zestawie z aplikacją na iOS",
    badgeBundledAndroid: "W zestawie z aplikacją na Androida",
    ctaAppStore: "App Store",
    ctaPlayStore: "Google Play",
    ctaDownload: "Pobierz",
    ctaDocs: "Dokumentacja",
    ctaSetupGuide: "Instrukcja konfiguracji",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Czatuj, rozmawiaj, zatwierdzaj działania i udostępniaj treści w OpenClaw z systemu iOS.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Czaty dostępne na pierwszy rzut oka i szybkie odpowiedzi prosto z nadgarstka.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Aplikacja towarzysząca na pasku menu dla Twojego Gateway — powiadomienia, zatwierdzenia i szybki czat.",
      },
      windows: {
        title: "Windows",
        desc: "Aplikacja towarzysząca dla systemu Windows łączy Twój komputer jako węzeł OpenClaw.",
      },
      linux: {
        title: "Linux",
        desc: "Natywna aplikacja komputerowa — wersje .deb i AppImage.",
      },
      chrome: {
        title: "Rozszerzenie Chrome",
        desc: "Pozwól OpenClaw sterować używaną przez Ciebie przeglądarką Chrome — kartami, stronami i formularzami.",
      },
      plugins: {
        title: "Wtyczki i ClawHub",
        desc: "Rozszerz OpenClaw o kanały, narzędzia i umiejętności tworzone przez społeczność.",
      },
    },
  },
  presence: {
  ...
  profilePage: {
    ...
    identity: {
      title: "Tożsamość",
      description: "Twój profil w tym gatewayu.",
      loading: "Wczytywanie Twojej tożsamości…",
      profileUnavailable: "Nie udało się wczytać Twojego profilu tożsamości.",
      avatar: "Awatar",
      avatarDescription:
      ...
      displayName: "Nazwa wyświetlana",
      displayNameDescription: "Wyświetlana innym osobom korzystającym z tego gatewaya.",
      linkedEmails: "Powiązane adresy e-mail",
      linkedEmailsDescription: "Adresy e-mail połączone z tym profilem.",
      openSettings: "Otwórz ustawienia tożsamości użytkownika {name}",
      avatarErrors: {
        invalid: "Nie udało się przetworzyć tego obrazu.",
        sourceTooLarge: "Wybierz obraz o rozmiarze nie większym niż 10 MB.",
  ...
  board: {
    ...
    emptyTitle: "Pusty pulpit, gotowy do pracy",
    emptyHint: "Twój agent może przypinać tutaj widżety — spróbuj poprosić o kartę stanu.",
    actionFailed: "Nie udało się zapisać zmiany na pulpicie.",
    actionInProgress: "Trwa zapisywanie innej zmiany na pulpicie.",
    announcement: {
      moved: "Przeniesiono {title}.",
      resized: "Zmieniono rozmiar {title}.",
      removed: "Usunięto {title}.",
      granted: "Zezwolono widżetowi na dostęp.",
      rejected: "Odrzucono prośbę widżetu o dostęp.",
    },
    widget: {
      cellLabel:
      ...
      actionErrorDetail: "Panel zachował poprzedni stan widżetu.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "Przełączanie gałęzi wymaga uprawnień administratora operatora.",
    ...
    board: {
      ...
      chatFace: "Czat",
      dashboardFace: "Panel",
      dockMenu: "Dokowanie czatu: {dock}",
      dockLeft: "Zadokuj czat po lewej",
      dockRight: "Zadokuj czat po prawej",
      dockBottom: "Zadokuj czat na dole",
      dockHidden: "Ukryj czat",
      resizeDock: "Zmień rozmiar zadokowanego czatu",
      reopenChat: "Pokaż czat",
      defaultTab: "Główna",
      mockPlaceholder: "Obszar widoku tablicy · karty: {tabs} · widżety: {widgets}",
      mockOverview: "Przegląd",
      mockResearch: "Badania",
      mockSessionStatus: "Stan wątku",
      mockRecentFindings: "Najnowsze ustalenia",
    ...
    sidebar: {
      ...
      toolActivity: "Używanie narzędzia {tool}",
    },
    welcome: {
    ...
    questions: {
      ...
      submitFailed: "Nie udało się przesłać: {error}",
      answered: "Odpowiedziano",
    ...
    modelControls: {
      ...
      reasoning: "Rozumowanie",
      speed: "Prędkość",
      sessionOverride: "Ustawienie dla sesji",
      usingDefault: "Używane jest ustawienie domyślne z Ustawień",
      resetToDefault: "Przywróć ustawienie domyślne ({model})",
    },
    sideChat: {
      title: "Czat boczny",
    ...
    composer: {
      ...
      microphoneAppliesNextSession:
        "Zmiany zostaną zastosowane po rozpoczęciu następnej sesji rozmowy.",
      ...
      holdToRecordSettingDescription:
        "Przytrzymaj przycisk mikrofonu w polu tworzenia wiadomości, zacznij mówić, a następnie zwolnij go, aby wstawić tekst bez wysyłania.",
      ...
      dictationConnecting: "Uruchamianie dyktowania…",
      dictationDisconnected: "Dyktowanie zostało zatrzymane, ponieważ Gateway się rozłączył.",
      dictationFailed: "Dyktowanie nie powiodło się.",
      dictationFinalizing: "Kończenie dyktowania…",
      dictationFinalizationTimedOut:
        "Dyktowanie zatrzymało się, zanim udało się sfinalizować ostatnią częściową transkrypcję.",
      dictationProviderUnavailable:
        "Nie skonfigurowano dostawcy transkrypcji na potrzeby dyktowania.",
      dictationRecording: "Nagrywanie {elapsed}",
      dictationReleaseToInsert: "Zwolnij, aby wstawić tekst podyktowany",
      ...
      selectedCameraUnavailable:
        "Wybrana kamera jest niedostępna. Wybierz inną kamerę lub opcję Domyślna systemowa.",
    ...
    toolCards: {
      ...
      widgetActions: "Działania widżetu",
      copyToClipboard: "Kopiuj do schowka",
      downloadFile: "Pobierz plik",
      widgetExportRerender:
        "Ten widżet musi zostać ponownie wyrenderowany, aby można go było wyeksportować jako obraz.",
    ...
    sessionDiscussion: {
      ...
      unavailable: "Nie można osadzić tej dyskusji.",
    },
    workspaceFiles: {
