...
export const pl: TranslationMap = {
  ...
  skillWorkshop: {
    viewSwitcher: {
      label: "Widok warsztatu",
      boardTitle: "Widok tablicy",
      board: "Tablica",
      todayTitle: "Widok dzisiejszy",
      today: "Dzisiaj",
    },
  },
  activity: {
  ...
  workboard: {
    ...
    detailNoNotes: "Nie ma jeszcze notatek operatora.",
    detailNotePlaceholder: "Dodaj notatkę o decyzji, blokadzie lub dowodzie...",
