...
export const pl: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      ...
      useCurrentChatTooltip:
        "Wysyłaj prośby o poprawki do bieżącej sesji czatu zamiast do sesji warsztatowej propozycji.",
    },
  },
  activity: {
    title: "Aktywność",
  ...
  workboard: {
    ...
    detailNotePlaceholder: "Dodaj decyzję, blokadę lub notatkę z dowodem...",
    ...
    dependenciesReady: "{count} gotowe",
    dependenciesReadyTitle: "{count} zależności jest ukończonych.",
    dependenciesBlocked: "{count} zablokowane",
