...
export const pl: TranslationMap = {
  ...
  dreaming: {
    ...
    advanced: {
      eyebrow: "Przegląd",
      title: "Odtwarzanie dziennego dziennika",
      description:
        "Zobacz, co zostało odtworzone z dziennego dziennika, co czeka na awans i co już zostało przepuszczone dalej.",
      ...
      stagedDescription:
        "Kandydaci do odtworzenia pobrani ze starszych wpisów dziennego dziennika.",
      shortTermTitle: "Oczekujące na awans",
      shortTermDescription:
        "Bieżący kandydaci krótkoterminowi oczekujący na przejście do prawdziwej pamięci.",
      ...
      promotedDescription: "Elementy, które niedawno przeszły już przez awans.",
      emptyGrounded: "Obecnie nie ma przygotowanych wpisów do odtworzenia z ugruntowanych danych.",
      emptyShortTerm: "Brak wpisów krótkoterminowych do sprawdzenia.",
