...
export const pl: TranslationMap = {
  ...
  configView: {
    ...
    autoSaveFailed: "Zapisywanie nie powiodło się",
    autoSaveConflict: "Ustawienia zostały zmienione w innym miejscu",
    retry: "Ponów",
    applyBannerText: "Zapisano w openclaw.json — uruchom ponownie Gateway, aby zastosować zmiany.",
    applyBannerAction: "Uruchom ponownie i zastosuj",
    rawDiscard: "Odrzuć",
    rawDraftBlocksApply:
    ...
    rawDraftPendingFormTitle:
      "Niezapisane zmiany w surowej konfiguracji — zapisz je lub odrzuć przed przejściem do widoku Form.",
    rawDraftBlocksFormEdit:
      "Nie udało się przetworzyć niezapisanych zmian w surowej konfiguracji; popraw je w edytorze Raw przed zmianą ustawień.",
    invalidConfig:
