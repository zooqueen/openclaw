...
export const pl: TranslationMap = {
  ...
  subtitles: {
    ...
    about: "Tożsamość kompilacji Control UI i połączonego Gateway.",
  ...
  aboutPage: {
    ...
    version: "Wersja",
    commit: "Hash commita",
    built: "Data kompilacji",
    unavailable: "Niedostępne",
    copyCommit: "Kopiuj pełny hash commita",
    copyingCommit: "Kopiowanie hasha commita",
    copiedCommit: "Skopiowano hash commita",
    copyCommitFailed: "Nie udało się skopiować hasha commita",
    gatewayVersion: "Wersja połączonego Gateway",
    gatewayVersionHint:
      "Zgłoszona przez aktywne połączenie Gateway; niezależna od tej kompilacji Control UI.",
  },
  profilePage: {
