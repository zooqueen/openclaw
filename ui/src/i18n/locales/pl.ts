...
export const pl: TranslationMap = {
  ...
  cockpit: {
    ...
    all: "Wszystkie",
    live: "na żywo",
    noStoredSessions: "Brak zapisanych sesji.",
    runtimeInspector: "Inspektor środowiska uruchomieniowego",
    skills: "Skills",
    cron: "Cron",
    hooks: "Hooki",
    gateway: "Gateway",
    ...
    noSkillSnapshot: "Brak migawki Skills.",
    blockedSkills: "{count} wymaga uwagi.",
    automation: "Automatyzacja",
    cronJobs: "{count} zadań cron",
    nextWake: "następne wybudzenie {time}",
    recentUiEvents: "{count} ostatnich zdarzeń UI",
    skillStateDisabled: "wyłączone",
    skillStateReady: "gotowe",
    skillStateNeedsSetup: "wymaga konfiguracji",
    timeNow: "teraz",
    timeNever: "nigdy",
