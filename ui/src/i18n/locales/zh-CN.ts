...
export const zh_CN: TranslationMap = {
  ...
  dreaming: {
    ...
    advanced: {
      eyebrow: "查看",
      title: "每日日志回放",
      description: "查看哪些内容已从每日日志中回放，哪些正在等待提升，以及哪些已经成功通过。",
      summaryFromDailyLog: "来自每日日志",
      summaryWaiting: "等待中",
      summaryPromotedToday: "今日已提升",
      stagedTitle: "来自每日日志",
      stagedDescription: "从较早的每日日志条目中提取的回放候选项。",
      shortTermTitle: "等待提升",
      shortTermDescription: "当前等待晋升为真实记忆的短期候选项。",
      sortRecent: "最新",
      sortSignals: "支持度最强",
      originDailyLog: "已回放",
      originLive: "实时",
      originMixed: "混合",
      promotedTitle: "最近提升",
      promotedDescription: "最近已成功完成提升的条目。",
      emptyGrounded: "当前没有已暂存的 grounded 回放条目。",
      emptyShortTerm: "当前没有可查看的短期条目。",
      emptyPromoted: "当前没有可查看的最近提升条目。",
      updatedPrefix: "更新于",
    },
    stats: {
      shortTerm: "短期",
