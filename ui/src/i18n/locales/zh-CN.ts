...
export const zh_CN: TranslationMap = {
  ...
  subtitles: {
    ...
    about: "Control UI 和已连接 Gateway 的构建标识。",
  ...
  aboutPage: {
    ...
    artifactSubtitle: "构建此浏览器产物时嵌入的标识信息。",
    artifactDetails: "Control UI 构建详情",
    version: "版本",
    commit: "提交",
    built: "构建时间",
    unavailable: "不可用",
    copyCommit: "复制完整提交哈希值",
    copyingCommit: "正在复制提交哈希值",
    copiedCommit: "已复制提交哈希值",
    copyCommitFailed: "无法复制提交哈希值",
    gatewayVersion: "已连接 Gateway 的版本",
    gatewayVersionHint: "由当前 Gateway 连接报告；此版本信息独立于这个 Control UI 构建。",
  },
  profilePage: {
