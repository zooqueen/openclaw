...
export const zh_CN: TranslationMap = {
  ...
  configView: {
    ...
    autoSaveSaved: "已保存",
    autoSaveFailed: "保存失败",
    autoSaveConflict: "设置已在其他位置更改",
    retry: "重试",
    applyBannerText: "已保存到 openclaw.json — 请重启 Gateway 以应用。",
    applyBannerAction: "重启并应用",
    rawDiscard: "放弃",
    rawDraftBlocksApply:
      "原始配置有未保存的编辑 — 请先在原始编辑器中保存或放弃这些编辑，然后再重启。",
    rawDraftPendingFormTitle: "原始配置有未保存的编辑 — 请先保存或放弃这些编辑，然后再切换到表单。",
    rawDraftBlocksFormEdit:
      "无法解析原始配置中未保存的编辑；请先在原始编辑器中解决这些问题，然后再更改设置。",
