...
export const zh_CN: TranslationMap = {
  ...
  cockpit: {
    ...
    manage: "管理",
    schedule: "计划",
    noSkillSnapshot: "尚无技能快照。",
    blockedSkills: "{count} 项需要注意。",
    automation: "自动化",
    cronJobs: "{count} 个 cron 作业",
    nextWake: "下次唤醒 {time}",
    recentUiEvents: "{count} 个最近的 UI 事件",
    skillStateDisabled: "已禁用",
    skillStateReady: "就绪",
    skillStateNeedsSetup: "需要设置",
    timeNow: "现在",
    timeNever: "从不",
    minutesAgo: "{count}分钟",
    hoursAgo: "{count}小时",
