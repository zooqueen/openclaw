...
export const zh_CN: TranslationMap = {
  ...
  nodes: {
    pairing: {
      button: "配对移动设备",
      adminRequired: "需要管理员权限才能创建设置代码。",
      title: "OpenClaw 移动端",
      subtitle: "在移动应用中扫描此二维码以连接新手机。",
      generating: "正在创建安全设置代码…",
      failed: "无法创建设置代码。",
      qrAlt: "OpenClaw 移动端配对二维码",
      qrUnavailable: "二维码不可用。请改为复制设置代码。",
      copySetupCode: "复制设置代码",
      newCode: "新代码",
      showSetupCode: "显示设置代码",
      pending: "等待审核的设备请求：{count}",
      review: "审核",
      waiting: "官方 OpenClaw 移动应用会在扫描后自动连接。",
      help: "配对帮助",
      manageDevices: "管理设备",
    },
    binding: {
