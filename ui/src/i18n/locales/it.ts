...
export const it: TranslationMap = {
  ...
  subtitles: {
    ...
    about: "Identità di build di Control UI e del Gateway connesso.",
  ...
  aboutPage: {
    ...
    artifactSubtitle: "Identità incorporata durante la build di questo artefatto del browser.",
    artifactDetails: "Dettagli della build di Control UI",
    version: "Versione",
    commit: "Commit",
    built: "Compilato",
    unavailable: "Non disponibile",
    copyCommit: "Copia l'hash completo del commit",
    copyingCommit: "Copia dell'hash del commit in corso",
    ...
    gatewayVersionHint:
      "Segnalata dalla connessione Gateway attiva; distinta da questa build di Control UI.",
  },
  profilePage: {
