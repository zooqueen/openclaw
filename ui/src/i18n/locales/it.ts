...
export const it: TranslationMap = {
  ...
  configView: {
    ...
    autoSaveConflict: "Le impostazioni sono state modificate altrove",
    retry: "Riprova",
    applyBannerText: "Salvato in openclaw.json — riavvia il gateway per applicare le modifiche.",
    applyBannerAction: "Riavvia e applica",
    rawDiscard: "Scarta",
    rawDraftBlocksApply:
      "Modifiche non salvate alla configurazione non elaborata — salvale o annullale nell'editor Raw prima di riavviare.",
    rawDraftPendingFormTitle:
      "Modifiche non salvate alla configurazione non elaborata — salvale o annullale prima di passare a Form.",
    rawDraftBlocksFormEdit:
      "Non è stato possibile analizzare le modifiche non salvate alla configurazione non elaborata; correggile nell'editor Raw prima di modificare le impostazioni.",
    invalidConfig:
