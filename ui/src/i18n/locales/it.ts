...
export const it: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      ...
      useCurrentChatTooltip:
        "Invia le richieste di revisione alla sessione di chat corrente invece che alla sessione workshop della proposta.",
    },
  },
  activity: {
    title: "Attività",
  ...
  workboard: {
    ...
    detailTitle: "Dettagli della scheda",
    detailTask: "Attività del Gateway",
    ...
    detailAutomationBoard: "Bacheca: {board}",
    ...
    detailNoNotes: "Non ci sono ancora note dell'operatore.",
    detailNotePlaceholder: "Aggiungi una nota su decisione, blocco o prova...",
    ...
    dependenciesReadyTitle: "{count} dipendenze sono completate.",
    dependenciesBlocked: "{count} bloccate",
    dependenciesBlockedTitle: "In attesa delle dipendenze: {parents}.",
