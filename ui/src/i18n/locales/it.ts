...
export const it: TranslationMap = {
  ...
  cockpit: {
    ...
    all: "Tutte",
    live: "live",
    noStoredSessions: "Nessuna sessione salvata finora.",
    runtimeInspector: "Ispettore runtime",
    skills: "Skills",
    cron: "Cron",
    hooks: "Hook",
    gateway: "Gateway",
    currentOrigin: "origine attuale",
    channels: "canali",
    nodes: "nodi",
    runs: "esecuzioni",
    manage: "Gestisci",
    schedule: "Pianificazione",
    noSkillSnapshot: "Nessuno snapshot delle skill al momento.",
    blockedSkills: "{count} richiedono attenzione.",
    automation: "Automazione",
    cronJobs: "{count} processi cron",
    nextWake: "prossima riattivazione {time}",
    recentUiEvents: "{count} eventi UI recenti",
    skillStateDisabled: "disabilitato",
    skillStateReady: "pronto",
    skillStateNeedsSetup: "richiede configurazione",
    timeNow: "ora",
    timeNever: "mai",
