...
export const uk: TranslationMap = {
  ...
  skillWorkshop: {
    viewSwitcher: {
      label: "Подання Workshop",
      boardTitle: "Подання дошки",
      board: "Дошка",
      todayTitle: "Подання на сьогодні",
      today: "Сьогодні",
    },
  },
  activity: {
  ...
  workboard: {
    ...
    detailWorkerLogs: "Журнали виконавця",
    detailWorkerProtocol: "Протокол виконавця",
    detailAutomation: "Автоматизація",
    detailUpdatedValue: "Оновлено: {time}",
    detailAutomationTenant: "Клієнт: {tenant}",
    ...
    detailNoNotes: "Приміток оператора поки немає.",
    detailNotePlaceholder: "Додайте примітку про рішення, перешкоду або доказ...",
    detailAddNote: "Додати примітку",
