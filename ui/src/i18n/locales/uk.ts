...
export const uk: TranslationMap = {
  ...
  cockpit: {
    ...
    all: "Усі",
    live: "наживо",
    noStoredSessions: "Збережених сеансів ще немає.",
    runtimeInspector: "Інспектор середовища виконання",
    skills: "Навички",
    cron: "Cron",
    hooks: "Хуки",
    gateway: "Gateway",
    currentOrigin: "поточне джерело",
    channels: "канали",
    nodes: "вузли",
    runs: "запуски",
    manage: "Керувати",
    schedule: "Розклад",
    noSkillSnapshot: "Знімка навичок ще немає.",
    blockedSkills: "{count} потребують уваги.",
    automation: "Автоматизація",
    cronJobs: "{count} завдань cron",
    nextWake: "наступне пробудження {time}",
    recentUiEvents: "{count} нещодавніх подій UI",
    skillStateDisabled: "вимкнено",
    skillStateReady: "готово",
    skillStateNeedsSetup: "потрібне налаштування",
    timeNow: "зараз",
    timeNever: "ніколи",
    minutesAgo: "{count} хв",
    hoursAgo: "{count} год",
