...
export const uk: TranslationMap = {
  ...
  dreaming: {
    ...
    advanced: {
      eyebrow: "Огляд",
      title: "Повторне відтворення щоденного журналу",
      description:
        "Перегляньте, що було повторно відтворено зі щоденного журналу, що очікує на просування та що вже пройшло далі.",
      summaryFromDailyLog: "зі щоденного журналу",
      summaryWaiting: "очікує",
      summaryPromotedToday: "просунуто сьогодні",
      stagedTitle: "Зі щоденного журналу",
      stagedDescription:
        "Кандидати для повторного відтворення, отримані зі старіших записів щоденного журналу.",
      shortTermTitle: "Очікує на просування",
      shortTermDescription:
        "Поточні короткострокові кандидати, які очікують переходу в реальну пам’ять.",
      sortRecent: "Найновіші",
      sortSignals: "Найсильніша підтримка",
      originDailyLog: "повторно відтворено",
      originLive: "наживо",
      originMixed: "змішане",
      promotedTitle: "Нещодавні просування",
      promotedDescription: "Елементи, які нещодавно вже пройшли просування.",
      emptyGrounded:
        "Зараз немає підготовлених записів для повторного відтворення з опорою на дані.",
      emptyShortTerm: "Немає короткострокових записів для перегляду.",
      emptyPromoted: "Немає нещодавніх просувань для перегляду.",
