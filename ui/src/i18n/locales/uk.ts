...
export const uk: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      useCurrentChat: "Використати поточний чат",
      useCurrentChatAria: "Використати поточний чат для запитів на доопрацювання",
      useCurrentChatTooltip:
        "Надсилати запити на доопрацювання до поточної сесії чату замість сесії майстерні пропозиції.",
    },
  },
  activity: {
    title: "Активність",
  ...
  workboard: {
    ...
    detailOperatorNotes: "Примітки оператора",
    detailNoNotes: "Поки що немає нотаток оператора.",
    detailNotePlaceholder: "Додайте рішення, блокер або нотатку з підтвердженням...",
    ...
    dependenciesReadyTitle: "{count} залежностей виконано.",
