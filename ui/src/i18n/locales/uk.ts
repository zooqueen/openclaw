...
export const uk: TranslationMap = {
  ...
  execApproval: {
    ...
    allowAlwaysUnavailable:
      "Ефективна політика схвалення вимагає схвалення щоразу, тому Allow Always недоступно.",
    deny: "Deny",
    labels: {
      host: "Host",
      agent: "Агент",
  ...
  activity: {
    title: "Активність",
    subtitle: "Тимчасова активність інструментів, отримана з подій живої сесії.",
    visibleCount: "{visible} з {total}",
    filtersLabel: "Фільтри активності",
    search: "Пошук",
    searchPlaceholder: "Фільтрувати за інструментом, зведенням, запуском, сесією",
    ...
    runId: "Запустити",
    session: "Сеанс",
    outputTruncated: "Попередній перегляд відредаговано й обрізано.",
    noOutputPreview: "Попередній перегляд виводу відсутній.",
    status: {
      running: "Запущено",
      done: "Готово",
      error: "Помилка",
