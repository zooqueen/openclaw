...
export const uk: TranslationMap = {
  ...
  configView: {
    ...
    retry: "Повторити",
    applyBannerText: "Збережено в openclaw.json — перезапустіть Gateway, щоб застосувати зміни.",
    applyBannerAction: "Перезапустити й застосувати",
    rawDiscard: "Відхилити",
    rawDraftBlocksApply:
      "Є незбережені зміни конфігурації у форматі Raw — збережіть або відкиньте їх у редакторі Raw перед перезапуском.",
    rawDraftPendingFormTitle:
      "Є незбережені зміни конфігурації у форматі Raw — збережіть або відкиньте їх перед переходом до Form.",
    rawDraftBlocksFormEdit:
      "Не вдалося розібрати незбережені зміни конфігурації у форматі Raw; виправте їх у редакторі Raw, перш ніж змінювати налаштування.",
    invalidConfig:
