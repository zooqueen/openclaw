...
export const uk: TranslationMap = {
  ...
  subtitles: {
    ...
    about: "Ідентифікація збірки Control UI та підключеного Gateway.",
  ...
  aboutPage: {
    ...
    artifactSubtitle: "Ідентифікаційні дані, вбудовані під час створення цієї браузерної збірки.",
    ...
    gatewayVersionHint: "Надано активним підключенням Gateway; окремо від цієї збірки Control UI.",
  },
  profilePage: {
