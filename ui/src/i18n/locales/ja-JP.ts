...
export const ja_JP: TranslationMap = {
  ...
  subtitles: {
    ...
    about: "Control UI と接続中の Gateway のビルド識別情報。",
  ...
  aboutPage: {
    ...
    artifactSubtitle: "このブラウザー向け成果物のビルド時に埋め込まれた識別情報。",
    ...
    gatewayVersion: "接続中の Gateway のバージョン",
    gatewayVersionHint:
      "アクティブな Gateway 接続から報告された情報です。この Control UI のビルドとは異なります。",
  },
  profilePage: {
