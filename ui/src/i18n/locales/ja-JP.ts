...
export const ja_JP: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      ...
      useCurrentChatTooltip:
        "提案のワークショップセッションではなく、現在のチャットセッションに修正リクエストを送信します。",
    },
  },
  activity: {
    title: "アクティビティ",
  ...
  workboard: {
    ...
    detailWorkerLogs: "Worker ログ",
    detailWorkerProtocol: "Worker プロトコル",
    ...
    detailNotePlaceholder: "判断、ブロッカー、または証跡メモを追加...",
    detailAddNote: "メモを追加",
    ...
    dependenciesReadyTitle: "{count} 件の依存関係が完了しています。",
    dependenciesBlocked: "{count} 件ブロック中",
    dependenciesBlockedTitle: "依存関係待ち: {parents}。",
    dependencyMissing: "{parent}（見つかりません）",
    dependencyStatusMissing: "見つかりません",
    unknownStatus: "不明",
