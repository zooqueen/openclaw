...
export const ja_JP: TranslationMap = {
  ...
  execApproval: {
    ...
    allowAlwaysUnavailable:
      "有効な承認ポリシーでは毎回承認が必要なため、常に許可は利用できません。",
    deny: "Deny",
    labels: {
      host: "Host",
      agent: "エージェント",
  ...
  activity: {
    ...
    argumentHiddenOne: "1 件の引数が非表示です",
    argumentsHidden: "{count} 件の引数が非表示です",
    streamLabel: "ツールアクティビティエントリ",
    toolCallId: "ツール呼び出し",
    runId: "実行",
    session: "セッション",
    outputTruncated: "プレビューは編集され、切り詰められました。",
