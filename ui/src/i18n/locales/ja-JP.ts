...
export const ja_JP: TranslationMap = {
  ...
  dreaming: {
    ...
    advanced: {
      ...
      title: "デイリーログの再生",
      description:
        "デイリーログから何が再生されたか、何が昇格待ちか、そして何がすでに通過したかを確認できます。",
      summaryFromDailyLog: "デイリーログから",
      summaryWaiting: "待機中",
      summaryPromotedToday: "今日昇格",
      stagedTitle: "デイリーログから",
      stagedDescription: "過去のデイリーログエントリから取り出された再生候補。",
      shortTermTitle: "昇格待ち",
      shortTermDescription: "実際の記憶に移行するのを待っている現在の短期候補。",
      sortRecent: "新しい順",
      sortSignals: "最も強い支持",
      originDailyLog: "再生済み",
      originLive: "ライブ",
      originMixed: "混合",
      promotedTitle: "最近の昇格",
      promotedDescription: "最近すでに昇格を通過した項目です。",
      emptyGrounded: "現在、段階的な grounded 再生エントリはありません。",
      emptyShortTerm: "確認できる短期エントリはありません。",
      emptyPromoted: "確認できる最近の昇格はありません。",
      updatedPrefix: "更新",
    },
    stats: {
      shortTerm: "短期",
