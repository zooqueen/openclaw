...
export const ja_JP: TranslationMap = {
  ...
  sessionsView: {
    ...
    deleteAllArchived: "アーカイブ済みをすべて削除…",
    deleteAllArchivedConfirm:
      "アーカイブ済みの {count} 件のスレッドとそのトランスクリプトを削除しますか？",
    ...
    dashboardAvailable: "ダッシュボードを利用できます",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      saving: "保存中…",
      uploading: "処理中…",
      profileHint: "JPEG、PNG、またはWebP。画像は中央で切り抜かれ、512pxにサイズ変更されます。",
      profileLoadFailed: "プロフィールを読み込めませんでした。",
      profileSaveFailed: "プロフィールを保存できませんでした。",
      avatarInvalid: "有効なJPEG、PNG、またはWebP画像を選択してください。",
      avatarTooLarge: "処理後のアバター画像がまだ大きすぎます。",
  ...
  configView: {
    ...
    syncedHint: "Gatewayを通じてデバイス間で同期されます。",
    notifications: {
      title: "プッシュ通知",
      nativeTitle: "通知",
      hint: "ゲートウェイからブラウザのプッシュ通知を受け取ります。",
      nativeHint: "通知は、このMac上のOpenClawアプリによってネイティブに表示されます。",
    ...
    sidebarPrefs: {
      ...
      liveActivity: "サイドバーにエージェントのリアルタイムアクティビティを表示",
      liveActivityHint:
  ...
  execApproval: {
    ...
    reviewRequest: "{agent}からの承認リクエストを確認: {command}",
  ...
  subtitles: {
    ...
    apps: "スマートフォン、腕時計、デスクトップ、ブラウザ向けのコンパニオンアプリ。",
    ...
    advanced: "残りのすべての設定セクションと、Rawファイルエディタ。",
  ...
  custodian: {
    ...
    subtitleCaretaker: "システムのセットアップとメンテナンス。",
    exitSetup: "セットアップを終了",
    newAgent: "新しいエージェント",
    ...
    history: {
      ...
      loading: "最近の変更を読み込み中…",
      empty: "記録された変更はまだありません。",
      requestFailed: "OpenClawは変更履歴を読み込めませんでした。",
      loadMore: "さらに読み込む",
      loadingMore: "さらに読み込み中…",
      changedPaths: "変更されたパス（{count}）",
      invalidEdit: "この手動編集は構成の検証に合格しませんでした。",
      opaqueChange:
        "表示されている構成パスに変更はありませんが、書式またはコメントが変更されました。",
      sources: {
    ...
    nudge: {
      configReload: "構成の再読み込みが停止しました — 何が起きたか私に尋ねてください",
      channelAuth: "{channel}の認証に問題があります — 何が起きたか私に尋ねてください",
      channelDisconnected: "{channel}が切断されました — 何が起きたか私に尋ねてください",
      channelDegraded: "{channel}に問題があります — 何が起きたか私に尋ねてください",
  ...
  mcpServers: {
    ...
    targetInvalid: "http(s) URLまたはコマンドラインを入力してください。",
    nameTaken: "「{name}」という名前のMCPサーバーはすでに存在します。",
    missing: "MCPサーバー「{name}」が設定に見つかりませんでした。",
    ...
    configUnavailable: "設定を利用できません。更新してからもう一度お試しください。",
    connectRequired: "MCPサーバーを変更するには、Gatewayに接続してください。",
    adminRequired: "MCPサーバーを変更するには、operator.adminアクセス権が必要です。",
    enable: "有効化：",
    disable: "無効にする",
  ...
  mcpPage: {
    connectorsLink: "Pluginsページでワンクリックコネクターを見つけましょう。",
    servers: "サーバー",
    oauth: "OAuth",
    filtered: "フィルター済み",
  ...
  labsPage: {
    intro:
      "Labsには、リリース間で変更、機能停止、または削除される可能性がある実験的な機能が含まれています。",
    sectionTitle: "実験的な機能",
    sectionDescription: "変更はすぐに保存され、今後のエージェント実行に適用されます。",
    ...
    codeMode: {
      title: "コードモード",
      description:
        "エージェントがコンパクトなサンドボックス化されたJavaScriptワークフローでツールを組み合わせられるようにします。",
    },
    swarm: {
      title: "スウォーム",
      description:
  ...
  appsPage: {
    ...
    havePhone: "アプリをすでにお持ちですか？",
    pairDevice: "デバイスをペアリング",
    sectionWatch: "手首で",
    sectionDesktop: "デスクトップで",
    sectionBrowser: "ブラウザで",
    sectionCommunity: "コミュニティ",
    badgeBundledIos: "iOSアプリに含まれています",
    badgeBundledAndroid: "Androidアプリに含まれています",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "手首からチャットをひと目で確認し、すばやく返信できます。",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Gateway用のメニューバーコンパニオンです。通知、承認、クイックチャットを利用できます。",
      },
      windows: {
        title: "Windows",
  ...
  profilePage: {
    ...
    identity: {
      ...
      loading: "本人情報を読み込んでいます…",
      profileUnavailable: "本人情報プロフィールを読み込めませんでした。",
      avatar: "アバター",
      avatarDescription: "PNG、JPEG、または WebP。画像は 256 × 256 以下にリサイズされます。",
      chooseAvatar: "画像を選択",
      processingAvatar: "処理中…",
      displayName: "表示名",
      displayNameDescription: "この Gateway を使用している他のユーザーに表示されます。",
      linkedEmails: "リンク済みのメールアドレス",
      linkedEmailsDescription: "このプロフィールに接続されているメールアドレスです。",
      openSettings: "{name} の本人情報設定を開く",
      avatarErrors: {
        invalid: "その画像を処理できませんでした。",
        sourceTooLarge: "10 MB 以下の画像を選択してください。",
        tooLarge: "処理後のアバターが 512 KB を超えています。",
      },
    },
  },
  tasksPage: {
  ...
  board: {
    ...
    emptyTitle: "作業を始められる空のボード",
    emptyHint:
      "エージェントはここにウィジェットを固定できます — ステータスカードを依頼してみてください。",
    actionFailed: "ダッシュボードの変更を保存できませんでした。",
    actionInProgress: "別のダッシュボードの変更を保存しています。",
    announcement: {
      moved: "{title}を移動しました。",
    ...
    widget: {
      cellLabel:
        "ダッシュボードウィジェット：{title}。矢印キーで移動できます。Altキーを押しながら矢印キーを押すと、ウィジェットを移動できます。",
      moveHandle: "{title}を移動",
      resizeHandle: "{title}のサイズを変更",
      menuLabel: "ウィジェットのオプション",
      moveToTab: "タブに移動",
      ...
      actionErrorDetail: "ダッシュボードでは以前のウィジェットの状態が維持されました。",
      errorShow: "詳細を表示",
      kindMcp: "MCP",
      kindHtml: "HTML",
    },
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "コピーしました",
      branches: "スレッドのブランチ",
      branchSwitchUnavailable: "エージェントの作業中はブランチを切り替えられません。",
      branchSwitchRequiresAdmin:
        "ブランチを切り替えるには、オペレーターの管理者アクセス権が必要です。",
    ...
    board: {
      ...
      dockLeft: "チャットを左側にドック",
      dockRight: "チャットを右側にドック",
      dockBottom: "チャットを下部にドック",
      dockHidden: "チャットを非表示",
      resizeDock: "チャットドックのサイズを変更",
      reopenChat: "チャットを表示",
      defaultTab: "メイン",
      mockPlaceholder: "ボードビューの境界 · {tabs} タブ · {widgets} ウィジェット",
      mockOverview: "概要",
      mockResearch: "リサーチ",
      mockSessionStatus: "スレッドのステータス",
    ...
    messages: {
      ...
      rewind: "巻き戻す",
      rewindConfirm: "このメッセージより前まで巻き戻しますか？",
      rewindToHere: "ここまで巻き戻す",
      rewindUnavailable: "エージェントの作業中は巻き戻せません",
    ...
    composer: {
      ...
      cameraInput: "カメラ",
      cameraListUnsupported: "このブラウザではカメラの一覧を取得できません。",
      ...
      microphoneAppliesNextSession: "変更は、次回のトークセッションを開始したときに適用されます。",
      ...
      holdToRecordSettingDescription:
        "入力欄のマイクボタンを長押しして話し、離すと、送信せずにテキストが挿入されます。",
      dictationAudioUnsupported:
        "Gatewayからサポートされていない形式の音声入力データが返されました。",
      dictationBrowserAudioUnsupported: "このブラウザでは、8 kHzの音声入力データを録音できません。",
      dictationConnecting: "音声入力を開始しています…",
      dictationDisconnected: "Gatewayとの接続が切断されたため、音声入力を停止しました。",
      dictationFailed: "音声入力に失敗しました。",
      dictationFinalizing: "音声入力を完了しています…",
      dictationFinalizationTimedOut:
        "最後の部分的な文字起こしが確定される前に、音声入力が停止しました。",
      dictationProviderUnavailable: "音声入力用の文字起こしプロバイダーが設定されていません。",
      dictationRecording: "録音中 {elapsed}",
      dictationReleaseToInsert: "離して音声入力を挿入",
      ...
      selectedCameraUnavailable:
        "選択したカメラは使用できません。別のカメラまたはシステムのデフォルトを選択してください。",
    ...
    toolCards: {
      ...
      widgetActions: "ウィジェットのアクション",
      copyToClipboard: "クリップボードにコピー",
      downloadFile: "ファイルをダウンロード",
      widgetExportRerender:
        "画像としてエクスポートするには、このウィジェットを再レンダリングする必要があります。",
      widgetExportFailed: "ウィジェットのエクスポートに失敗しました。もう一度お試しください。",
      pinToDashboard: "ダッシュボードに固定",
      pinToDashboardPending: "固定中…",
