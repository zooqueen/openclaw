...
export const ja_JP: TranslationMap = {
  ...
  newSession: {
    title: "新しいセッション",
    hint: "このセッションを実行する場所を選択してから、何をするかを指定してください。",
    draftRow: "新しいセッション",
    agent: "エージェント",
    where: "場所",
    gateway: "Gateway · local",
    folder: "フォルダー",
    folderPlaceholder: "エージェントのワークスペース",
    worktree: "Worktree",
    worktreeUnavailable: "エージェントのワークスペースは git checkout ではありません",
    baseBranch: "ベースブランチ",
    worktreeName: "Worktree 名",
    worktreeNamePlaceholder: "auto",
    worktreeNameInvalid: "Worktree 名には小文字、数字、ダッシュを使用します。",
