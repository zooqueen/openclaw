...
export const ja_JP: TranslationMap = {
  ...
  configView: {
    ...
    retry: "再試行",
    applyBannerText: "openclaw.json に保存しました — 適用するには Gateway を再起動してください。",
    applyBannerAction: "再起動して適用",
    rawDiscard: "破棄",
    rawDraftBlocksApply:
      "未保存の Raw 設定編集があります — 再起動する前に Raw エディターで保存または破棄してください。",
    rawDraftPendingFormTitle:
      "未保存の Raw 設定編集があります — Form に切り替える前に保存または破棄してください。",
    rawDraftBlocksFormEdit:
      "未保存の Raw 設定編集を解析できませんでした。設定を変更する前に、Raw エディターで問題を解決してください。",
