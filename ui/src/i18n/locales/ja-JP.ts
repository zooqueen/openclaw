...
export const ja_JP: TranslationMap = {
  ...
  cockpit: {
    ...
    all: "すべて",
    live: "ライブ",
    noStoredSessions: "保存されたセッションはまだありません。",
    runtimeInspector: "ランタイムインスペクター",
    skills: "Skills",
    cron: "Cron",
    hooks: "フック",
    gateway: "Gateway",
    ...
    manage: "管理",
    schedule: "スケジュール",
    noSkillSnapshot: "スキルのスナップショットはまだありません。",
    blockedSkills: "{count} 件に対応が必要です。",
    automation: "自動化",
    cronJobs: "{count} 件のcronジョブ",
    nextWake: "次回起動 {time}",
    recentUiEvents: "最近のUIイベント {count} 件",
    skillStateDisabled: "無効",
    skillStateReady: "準備完了",
    skillStateNeedsSetup: "セットアップが必要",
    timeNow: "今",
    timeNever: "なし",
    minutesAgo: "{count}分",
    hoursAgo: "{count}時間",
