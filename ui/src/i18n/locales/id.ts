...
export const id: TranslationMap = {
  ...
  cockpit: {
    ...
    all: "Semua",
    live: "langsung",
    noStoredSessions: "Belum ada sesi tersimpan.",
    runtimeInspector: "Inspektur runtime",
    skills: "Skills",
    cron: "Cron",
    hooks: "Hook",
    gateway: "Gateway",
    currentOrigin: "origin saat ini",
    channels: "channel",
    nodes: "node",
    runs: "proses berjalan",
    manage: "Kelola",
    schedule: "Jadwal",
    noSkillSnapshot: "Belum ada snapshot keterampilan.",
    blockedSkills: "{count} perlu perhatian.",
    automation: "Otomatisasi",
    cronJobs: "{count} pekerjaan cron",
    nextWake: "bangun berikutnya {time}",
    recentUiEvents: "{count} peristiwa UI terbaru",
    skillStateDisabled: "nonaktif",
    skillStateReady: "siap",
    skillStateNeedsSetup: "perlu penyiapan",
    timeNow: "sekarang",
  ...
  sessionsView: {
    ...
    showCheckpoints: "Tampilkan checkpoint",
    hideCheckpoints: "Sembunyikan checkpoint",
