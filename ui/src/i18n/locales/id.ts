...
export const id: TranslationMap = {
  ...
  skillWorkshop: {
    viewSwitcher: {
      label: "Tampilan Workshop",
      boardTitle: "Tampilan papan",
      board: "Papan",
      todayTitle: "Tampilan hari ini",
      today: "Hari ini",
    },
  },
  activity: {
  ...
  workboard: {
    ...
    detailAutomationBoard: "Papan: {board}",
    ...
    detailNotePlaceholder: "Tambahkan catatan keputusan, penghambat, atau bukti...",
