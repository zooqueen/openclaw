...
export const id: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Tidak ada sesi WhatsApp tersimpan yang dihapus. Sesi tersebut mungkin sudah tidak ada, atau direktori autentikasinya mungkin perlu dibersihkan secara manual.",
    },
  ...
  nodes: {
    pairing: {
      ...
      noApp: "Belum memiliki aplikasinya?",
      getApps: "Dapatkan aplikasi",
  ...
  sessionsView: {
    ...
    sessionState: "Status utas",
    viewArchived: "Lihat yang diarsipkan",
    sessionArchived: "Utas diarsipkan",
    sessionsArchived: "{count} utas diarsipkan",
    deleteAllArchived: "Hapus semua yang diarsipkan…",
    deleteAllArchivedConfirm: "Hapus {count} utas yang diarsipkan beserta transkripnya?",
    ...
    approvalNeeded: "Persetujuan diperlukan",
    ...
    runFailedReason: "Proses gagal: {reason}",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      uploading: "Memproses…",
      profileHint:
        "JPEG, PNG, atau WebP. Gambar dipotong dari tengah dan diubah ukurannya menjadi 512px.",
      ...
      avatarTooLarge: "Avatar yang telah diproses masih terlalu besar.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Notifikasi untuk OpenClaw dinonaktifkan di macOS. Izinkan melalui Pengaturan Sistem > Notifikasi.",
    },
    appearance: {
      theme: "Tema",
    ...
    sidebarPrefs: {
      title: "Bilah samping",
      hint: "Pilih yang ditampilkan saat sesi sedang berjalan.",
      liveActivity: "Tampilkan aktivitas agen langsung di bilah samping",
      liveActivityHint:
        "Tampilkan aktivitas asisten atau alat terbaru di bawah sesi yang sedang berjalan.",
    },
    connection: {
      title: "Koneksi",
      gateway: "Gateway",
  ...
  subtitles: {
    ...
    apps: "Aplikasi pendamping untuk ponsel, jam tangan, desktop, dan browser.",
    ...
    security: "Autentikasi Gateway, kebijakan eksekusi, profil alat, dan persetujuan.",
    advanced: "Semua bagian konfigurasi lainnya, ditambah editor file mentah.",
  ...
  custodian: {
    ...
    subtitleCaretaker: "Penyiapan dan pemeliharaan sistem.",
    ...
    history: {
      ...
      description: "Perubahan pada sistem ini, dari yang terbaru.",
      ...
      changedPaths: "Path yang diubah ({count})",
      invalidEdit: "Pengeditan manual ini tidak lolos validasi konfigurasi.",
      opaqueChange:
        "Pemformatan atau komentar berubah tanpa perubahan path konfigurasi yang terlihat.",
      sources: {
        systemAgent: "system-agent",
        doctor: "doctor",
        settings: "pengaturan",
        cli: "CLI",
        pluginInstall: "penginstalan plugin",
        manualEdit: "pengeditan manual",
        unknown: "tidak diketahui",
      },
    },
    nudge: {
      configReload: "Pemuatan ulang konfigurasi berhenti — tanyakan kepada saya apa yang terjadi",
      channelAuth:
        "Autentikasi {channel} mengalami gangguan — tanyakan kepada saya apa yang terjadi",
      channelDisconnected: "{channel} baru saja terputus — tanyakan kepada saya apa yang terjadi",
      channelDegraded: "{channel} mengalami gangguan — tanyakan kepada saya apa yang terjadi",
  ...
  mcpServers: {
    ...
    addedSuccess: "Server MCP {name} berhasil ditambahkan.",
    enabledSuccess: "Server MCP {name} berhasil diaktifkan.",
    disabledSuccess: "Server MCP {name} berhasil dinonaktifkan.",
    removedSuccess: "Server MCP {name} berhasil dihapus.",
    configUnavailable: "Konfigurasi tidak tersedia; muat ulang dan coba lagi.",
    connectRequired: "Hubungkan ke gateway untuk mengubah server MCP.",
  ...
  mcpPage: {
    connectorsLink: "Temukan konektor sekali klik di halaman Plugin.",
    servers: "Server",
    oauth: "OAuth",
    filtered: "Terfilter",
  ...
  labsPage: {
    intro:
      "Labs berisi kemampuan eksperimental yang dapat berubah, mengalami gangguan, atau menghilang di antara rilis.",
    sectionTitle: "Fitur eksperimental",
    sectionDescription: "Perubahan langsung disimpan dan diterapkan pada eksekusi agen berikutnya.",
    ...
    codeMode: {
      title: "Mode Kode",
      description:
        "Izinkan agen menggabungkan alat dalam alur kerja JavaScript yang ringkas dan terisolasi.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    havePhone: "Sudah memiliki aplikasinya?",
    ...
    badgeBundledIos: "Disertakan dengan aplikasi iOS",
    badgeBundledAndroid: "Disertakan dengan aplikasi Android",
    ctaAppStore: "App Store",
    ctaPlayStore: "Google Play",
    ctaDownload: "Unduh",
    ctaDocs: "Dokumentasi",
    ctaSetupGuide: "Panduan penyiapan",
    ctaOpenPlugins: "Buka Plugin",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Lihat sekilas obrolan dan kirim balasan cepat dari pergelangan tangan Anda.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Aplikasi pendamping di bilah menu untuk Gateway Anda — notifikasi, persetujuan, obrolan cepat.",
      },
      windows: {
        title: "Windows",
  ...
  presence: {
    rosterLabel: "Tampilkan siapa yang sedang online",
    rosterTitle: "Online",
    you: "Anda",
  },
  profilePage: {
    ...
    identity: {
      ...
      avatar: "Avatar",
      avatarDescription:
        "PNG, JPEG, atau WebP. Ukuran gambar diubah menjadi 256 × 256 atau lebih kecil.",
      ...
      linkedEmailsDescription: "Alamat email yang terhubung ke profil ini.",
      ...
      avatarErrors: {
        ...
        tooLarge: "Avatar yang telah diproses berukuran lebih dari 512 KB.",
      },
    },
  },
  tasksPage: {
  ...
  board: {
    ...
    emptyTitle: "Dasbor kosong, siap digunakan",
    ...
    actionInProgress: "Perubahan dasbor lainnya masih disimpan.",
    announcement: {
      moved: "{title} dipindahkan.",
      resized: "Ukuran {title} diubah.",
      removed: "{title} dihapus.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "Disalin",
      branches: "Cabang utas",
      branchSwitchUnavailable: "Peralihan cabang tidak tersedia saat agen sedang bekerja.",
      branchSwitchRequiresAdmin: "Peralihan cabang memerlukan akses admin operator.",
    ...
    board: {
      faceLabel: "Tampilan utas",
      chatFace: "Obrolan",
      dashboardFace: "Dasbor",
      dockMenu: "Dock chat: {dock}",
      dockLeft: "Pasang chat di kiri",
      dockRight: "Pasang chat di kanan",
      dockBottom: "Pasang chat di bawah",
      dockHidden: "Sembunyikan chat",
      resizeDock: "Ubah ukuran dock chat",
      reopenChat: "Tampilkan chat",
      defaultTab: "Utama",
      mockPlaceholder: "Sambungan tampilan papan · {tabs} tab · {widgets} widget",
      mockOverview: "Ikhtisar",
      mockResearch: "Riset",
      mockSessionStatus: "Status utas",
      mockRecentFindings: "Temuan terbaru",
      mockSourceMap: "Peta sumber",
      resetTitle: "Atur ulang percakapan?",
      resetDescription: "Konteks percakapan akan diatur ulang. Dasbor Anda tetap ada.",
    },
    catalog: {
    ...
    questions: {
      ...
      answered: "Terjawab",
      answeredElsewhere: "Dijawab di tempat lain",
      unavailable: "Tidak tersedia",
      expired: "Kedaluwarsa",
      cancelled: "Dibatalkan",
    },
    messages: {
      activity: "Aktivitas",
      forkFromHere: "Buat cabang dari sini",
      hide: "Sembunyikan",
      ...
      rewind: "Mundur",
      rewindConfirm: "Mundur ke sebelum pesan ini?",
      rewindToHere: "Mundur ke sini",
      rewindUnavailable: "Tidak dapat mundur saat agen sedang bekerja",
    ...
    modelControls: {
      ...
      reasoning: "Penalaran",
      speed: "Kecepatan",
      sessionOverride: "Penggantian sesi",
      usingDefault: "Menggunakan nilai default dari Pengaturan",
      resetToDefault: "Atur ulang ke default ({model})",
    },
    sideChat: {
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Tahan tombol mikrofon pada penyusun pesan, bicara, lalu lepaskan untuk menyisipkan teks tanpa mengirimkannya.",
      dictationAudioUnsupported: "Gateway mengembalikan format audio dikte yang tidak didukung.",
      dictationBrowserAudioUnsupported: "Browser ini tidak dapat merekam audio dikte pada 8 kHz.",
      ...
      dictationFinalizationTimedOut:
        "Dikte berhenti sebelum transkrip parsial terakhir dapat diselesaikan.",
      ...
      selectedCameraUnavailable:
        "Kamera yang dipilih tidak tersedia. Pilih kamera lain atau Default sistem.",
