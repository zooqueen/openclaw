...
export const id: TranslationMap = {
  ...
  execApproval: {
    ...
    allowAlwaysUnavailable:
      "Kebijakan persetujuan yang berlaku mewajibkan persetujuan setiap kali, jadi Izinkan Selalu tidak tersedia.",
    deny: "Deny",
    labels: {
      host: "Host",
      agent: "Agen",
  ...
  subtitles: {
    ...
    activity: "Ringkasan aktivitas tool lokal browser.",
  ...
  activity: {
    title: "Aktivitas",
    subtitle: "Aktivitas tool sementara yang berasal dari peristiwa sesi langsung.",
    visibleCount: "{visible} dari {total}",
    filtersLabel: "Filter aktivitas",
    search: "Cari",
    searchPlaceholder: "Filter berdasarkan tool, ringkasan, eksekusi, sesi",
    toolFilter: "Alat",
    allTools: "Semua tool",
    ...
    clear: "Bersihkan",
    empty: "Belum ada aktivitas tool.",
    ...
    streamLabel: "Entri aktivitas tool",
    toolCallId: "Panggilan tool",
    runId: "Jalankan",
    session: "Sesi",
