...
export const id: TranslationMap = {
  ...
  configView: {
    ...
    retry: "Coba lagi",
    applyBannerText: "Disimpan ke openclaw.json — mulai ulang Gateway untuk menerapkan.",
    applyBannerAction: "Mulai ulang & terapkan",
    rawDiscard: "Buang",
    rawDraftBlocksApply:
      "Ada perubahan konfigurasi mentah yang belum disimpan — simpan atau buang perubahan tersebut di editor Raw sebelum memulai ulang.",
    rawDraftPendingFormTitle:
      "Ada perubahan konfigurasi mentah yang belum disimpan — simpan atau buang perubahan tersebut sebelum beralih ke Form.",
    rawDraftBlocksFormEdit:
      "Perubahan konfigurasi mentah yang belum disimpan tidak dapat diurai; selesaikan masalah tersebut di editor Raw sebelum mengubah pengaturan.",
    invalidConfig:
