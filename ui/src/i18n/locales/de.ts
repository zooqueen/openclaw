...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    about: "Build-Identität der Control UI und des verbundenen Gateways.",
  ...
  aboutPage: {
    ...
    gatewayVersion: "Version des verbundenen Gateways",
    gatewayVersionHint: "Vom aktiven Gateway gemeldet; unabhängig von diesem Build der Control UI.",
  },
  profilePage: {
