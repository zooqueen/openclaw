...
export const de: TranslationMap = {
  ...
  dreaming: {
    ...
    advanced: {
      eyebrow: "Überprüfen",
      title: "Wiedergabe des Tagesprotokolls",
      description:
        "Sieh dir an, was aus dem Tagesprotokoll wiedergegeben wurde, was auf eine Übernahme wartet und was bereits übernommen wurde.",
      summaryFromDailyLog: "aus dem Tagesprotokoll",
      summaryWaiting: "wartet",
      summaryPromotedToday: "heute übernommen",
      stagedTitle: "Aus dem Tagesprotokoll",
      stagedDescription: "Wiedergabekandidaten aus älteren Einträgen im Tagesprotokoll.",
      shortTermTitle: "Wartet auf Übernahme",
      shortTermDescription:
        "Aktuelle kurzfristige Kandidaten, die darauf warten, in den echten Speicher übernommen zu werden.",
      sortRecent: "Neueste zuerst",
      sortSignals: "Stärkste Unterstützung",
      originDailyLog: "wiedergegeben",
      originLive: "live",
      originMixed: "gemischt",
      promotedTitle: "Letzte Übernahmen",
      promotedDescription: "Einträge, die die Übernahme vor Kurzem bereits durchlaufen haben.",
      emptyGrounded: "Derzeit keine vorbereiteten, verankerten Wiedergabeeinträge.",
      emptyShortTerm: "Keine kurzfristigen Einträge zum Prüfen.",
      emptyPromoted: "Keine letzten Übernahmen zum Prüfen.",
