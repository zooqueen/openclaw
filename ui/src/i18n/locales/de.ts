...
export const de: TranslationMap = {
  ...
  cockpit: {
    ...
    all: "Alle",
    live: "live",
    noStoredSessions: "Noch keine gespeicherten Sitzungen.",
    runtimeInspector: "Laufzeit-Inspector",
    skills: "Skills",
    cron: "Cron",
    hooks: "Hooks",
    gateway: "Gateway",
    currentOrigin: "aktueller Ursprung",
    channels: "Kanäle",
    nodes: "Knoten",
    runs: "Ausführungen",
    manage: "Verwalten",
    schedule: "Zeitplan",
    noSkillSnapshot: "Noch kein Skill-Snapshot.",
    blockedSkills: "{count} benötigen Aufmerksamkeit.",
    automation: "Automatisierung",
    cronJobs: "{count} Cron-Jobs",
    nextWake: "nächstes Aufwachen {time}",
    recentUiEvents: "{count} aktuelle UI-Ereignisse",
    skillStateDisabled: "deaktiviert",
    skillStateReady: "bereit",
    skillStateNeedsSetup: "Einrichtung erforderlich",
    timeNow: "jetzt",
    timeNever: "nie",
