...
export const de: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "QR-Code für OpenClaw Mobile-Kopplung",
      qrUnavailable: "QR nicht verfügbar. Kopieren Sie stattdessen den Einrichtungscode.",
      copySetupCode: "Einrichtungscode kopieren",
      newCode: "Neuer Code",
      showSetupCode: "Einrichtungscode anzeigen",
      pending: "Geräteanfragen, die auf Überprüfung warten: {count}",
      review: "Überprüfung",
