...
export const de: TranslationMap = {
  ...
  configView: {
    ...
    autoSaveConflict: "Einstellungen wurden an anderer Stelle geändert",
    retry: "Erneut versuchen",
    applyBannerText:
      "In openclaw.json gespeichert — starten Sie das Gateway neu, um die Änderungen anzuwenden.",
    applyBannerAction: "Neu starten und anwenden",
    rawDiscard: "Verwerfen",
    rawDraftBlocksApply:
      "Nicht gespeicherte Änderungen an der Rohkonfiguration — speichern oder verwerfen Sie sie vor dem Neustart im Rohdaten-Editor.",
    rawDraftPendingFormTitle:
      "Nicht gespeicherte Änderungen an der Rohkonfiguration — speichern oder verwerfen Sie sie, bevor Sie zur Formularansicht wechseln.",
    rawDraftBlocksFormEdit:
      "Nicht gespeicherte Änderungen an der Rohkonfiguration konnten nicht analysiert werden; beheben Sie sie im Rohdaten-Editor, bevor Sie Einstellungen ändern.",
    invalidConfig:
