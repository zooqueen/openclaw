...
export const de: TranslationMap = {
  ...
  skillWorkshop: {
    viewSwitcher: {
      label: "Workshop-Ansicht",
      boardTitle: "Board-Ansicht",
      board: "Board",
      todayTitle: "Heute-Ansicht",
      today: "Heute",
    },
  },
  activity: {
  ...
  workboard: {
    ...
    detailOperatorNotes: "Operator-Notizen",
    detailNoNotes: "Noch keine Operator-Notizen.",
    detailNotePlaceholder:
      "Fügen Sie eine Entscheidung, eine Blockade oder einen Nachweis als Notiz hinzu...",
