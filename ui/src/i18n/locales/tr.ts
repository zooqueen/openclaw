...
export const tr: TranslationMap = {
  ...
  execApproval: {
    ...
    allowAlwaysUnavailable:
      "Geçerli onay politikası her seferinde onay gerektiriyor, bu nedenle Her Zaman İzin Ver kullanılamaz.",
    deny: "Deny",
    labels: {
      host: "Host",
      agent: "Aracı",
  ...
  subtitles: {
    ...
    activity: "Tarayıcı yerelinde araç etkinliği özetleri.",
  ...
  activity: {
    ...
    argumentHiddenOne: "1 bağımsız değişken gizli",
    argumentsHidden: "{count} bağımsız değişken gizli",
    streamLabel: "Araç etkinliği girdileri",
    toolCallId: "Araç çağrısı",
    runId: "Çalıştır",
    session: "Oturum",
    outputTruncated: "Önizleme düzenlenip kısaltıldı.",
    noOutputPreview: "Çıktı önizlemesi yok.",
    status: {
      running: "Çalışıyor",
      done: "Tamamlandı",
      error: "Hata",
