...
export const tr: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Kayıtlı bir WhatsApp oturumu temizlenmedi. Oturum zaten mevcut olmayabilir veya kimlik doğrulama dizininin elle temizlenmesi gerekebilir.",
    },
  ...
  nodes: {
    pairing: {
      ...
      noApp: "Uygulama henüz sizde yok mu?",
      getApps: "Uygulamaları edin",
  ...
  agentChip: {
    ...
    offlineOpenSettings: "Çevrimdışı — Ayarlar'ı aç",
  ...
  sessionsView: {
    ...
    global: "Genel",
    unknown: "Bilinmiyor",
    sessionState: "Yazışma durumu",
    viewArchived: "Arşivlenenleri görüntüle",
    sessionArchived: "Yazışma arşivlendi",
    sessionsArchived: "{count} yazışma arşivlendi",
    deleteAllArchived: "Arşivlenenlerin tümünü sil…",
    deleteAllArchivedConfirm: "Arşivlenen {count} yazışma ve bunların dökümleri silinsin mi?",
    ...
    runFailedReason: "Çalıştırma başarısız oldu: {reason}",
    runErrorTimedOut: "Zaman aşımına uğradı",
    runErrorUnknown: "Bilinmeyen hata",
    attentionRequired: "Oturumla ilgilenilmesi gerekiyor",
    model: "Model",
    provider: "Sağlayıcı",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      uploading: "İşleniyor…",
      profileHint:
        "JPEG, PNG veya WebP. Görüntüler ortalanarak kırpılır ve 512px boyutuna yeniden ölçeklendirilir.",
      profileLoadFailed: "Profiliniz yüklenemedi.",
      profileSaveFailed: "Profiliniz kaydedilemedi.",
      avatarInvalid: "Geçerli bir JPEG, PNG veya WebP görüntüsü seçin.",
  ...
  configView: {
    ...
    syncedHint: "Gateway aracılığıyla cihazlarınız arasında eşzamanlanır.",
    notifications: {
      title: "Anlık bildirimler",
      nativeTitle: "Bildirimler",
      hint: "Gateway'inizden tarayıcı anlık bildirimleri alın.",
      nativeHint: "Bildirimler bu Mac'teki OpenClaw uygulaması tarafından yerel olarak gösterilir.",
      ...
      nativeBlockedHint:
        "macOS'te OpenClaw bildirimleri devre dışı bırakılmış. Sistem Ayarları > Bildirimler bölümünden bildirimlere izin verin.",
    },
    appearance: {
      theme: "Tema",
    ...
    sidebarPrefs: {
      title: "Kenar Çubuğu",
      hint: "Oturumlar çalışırken nelerin görüneceğini seçin.",
      liveActivity: "Canlı aracı etkinliğini kenar çubuğunda göster",
      liveActivityHint:
        "Çalışan oturumların altında en son asistan veya araç etkinliğini gösterin.",
    },
    connection: {
      title: "Bağlantı",
      gateway: "Gateway",
  ...
  execApproval: {
    ...
    otherPending: "Bekleyen diğer istekler",
    reviewRequest: "{agent} tarafından gönderilen onay isteğini inceleyin: {command}",
  ...
  subtitles: {
    ...
    labs: "Deneysel aracı ve araç özellikleri.",
    ...
    security: "Gateway kimlik doğrulaması, yürütme politikası, araç profili ve onaylar.",
  ...
  custodian: {
    ...
    history: {
      ...
      description: "Bu sistemde değişenler, en yeniden en eskiye doğru.",
      loading: "Son değişiklikler yükleniyor…",
      empty: "Henüz kaydedilmiş bir değişiklik yok.",
      requestFailed: "OpenClaw değişiklik geçmişini yükleyemedi.",
      loadMore: "Daha fazla yükle",
      loadingMore: "Daha fazlası yükleniyor…",
      changedPaths: "Değiştirilen yollar ({count})",
      invalidEdit: "Bu manuel düzenleme, yapılandırma doğrulamasını geçemedi.",
      opaqueChange:
        "Görünür yapılandırma yolu değişiklikleri olmadan biçimlendirme veya yorumlar değiştirildi.",
      sources: {
        systemAgent: "sistem aracısı",
        doctor: "doktor",
        settings: "ayarlar",
        cli: "CLI",
        pluginInstall: "eklenti yükleme",
        manualEdit: "manuel düzenleme",
        unknown: "bilinmiyor",
      },
    },
    nudge: {
      configReload: "Yapılandırmanın yeniden yüklenmesi durdu — ne olduğunu bana sorun",
      channelAuth: "{channel} kimlik doğrulaması sorunlu — ne olduğunu bana sorun",
      channelDisconnected: "{channel} bağlantısı az önce kesildi — ne olduğunu bana sorun",
      channelDegraded: "{channel} sorunlu durumda — ne olduğunu bana sorun",
  ...
  mcpServers: {
    ...
    targetInvalid: "Bir http(s) URL'si veya komut satırı girin.",
    nameTaken: "“{name}” adlı bir MCP sunucusu zaten mevcut.",
    missing: "“{name}” MCP sunucusu yapılandırmada bulunamadı.",
  ...
  mcpPage: {
    connectorsLink: "Plugins sayfasında tek tıklamayla kullanılabilen bağlayıcıları keşfedin.",
    servers: "Sunucular",
    oauth: "OAuth",
  ...
  sessionsPage: {
    hubTablistLabel: "Oturum bölümleri",
  },
  pluginsPage: {
  ...
  labsPage: {
    intro:
      "Labs, sürümler arasında değişebilen, bozulabilen veya ortadan kalkabilen deneysel özellikler içerir.",
    sectionTitle: "Deneysel özellikler",
    sectionDescription:
      "Değişiklikler hemen kaydedilir ve gelecekteki ajan çalıştırmalarına uygulanır.",
    documentation: "Belgeler",
    restartRequired: "Gateway'in yeniden başlatılması gerekiyor.",
    saveErrorTitle: "Özellik güncellenemedi",
    saveFailed: "Özellik ayarı kaydedilemedi.",
    codeMode: {
      title: "Kod Modu",
      description:
        "Ajanların araçları kompakt ve korumalı JavaScript iş akışlarında birleştirmesine izin verin.",
    },
    swarm: {
      title: "Sürü",
  ...
  appsPage: {
    ...
    havePhone: "Uygulama zaten yüklü mü?",
    ...
    badgeBundledIos: "iOS uygulamasına dahildir",
    badgeBundledAndroid: "Android uygulamasına dahildir",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Bileğinizden bir bakışta sohbetleri görün ve hızlı yanıtlar verin.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Gateway'iniz için menü çubuğu yardımcı uygulaması — bildirimler, onaylar ve hızlı sohbet.",
      },
      windows: {
        title: "Windows",
      ...
      linux: {
        title: "Linux",
        desc: "Yerel masaüstü uygulaması — .deb ve AppImage derlemeleri.",
      },
      chrome: {
  ...
  presence: {
    rosterLabel: "Kimlerin çevrimiçi olduğunu göster",
  ...
  board: {
    label: "İleti dizisi panosu",
    tabsLabel: "Pano sekmeleri",
    moreTabs: "Diğer pano sekmeleri",
    gridLabel: "Pano araç takımları",
    emptyTitle: "Çalışmaya hazır, boş bir pano",
    emptyHint: "Aracınız buraya araç takımları sabitleyebilir — bir durum kartı istemeyi deneyin.",
    ...
    announcement: {
      ...
      granted: "Araç takımına erişime izin verildi.",
      rejected: "Araç takımına erişim reddedildi.",
    },
    widget: {
      cellLabel:
        "Pano araç takımı: {title}. Gezinmek için ok tuşlarını kullanın. Taşımak için Alt tuşunu basılı tutup bir ok tuşuna basın.",
      moveHandle: "{title} öğesini taşı",
      resizeHandle: "{title} öğesini yeniden boyutlandır",
      menuLabel: "Araç takımı seçenekleri",
      ...
      actionErrorDetail: "Kontrol paneli, widget'ın önceki durumunu korudu.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "Kopyalandı",
      branches: "Konu dalları",
      branchSwitchUnavailable: "Temsilci çalışırken dal değiştirilemez.",
      branchSwitchRequiresAdmin: "Dal değiştirmek için operatör yönetici erişimi gerekir.",
    ...
    board: {
      faceLabel: "Konu yüzü",
      chatFace: "Sohbet",
      dashboardFace: "Kontrol paneli",
      dockMenu: "Sohbet sabitleme konumu: {dock}",
      dockLeft: "Sohbeti sola sabitle",
      dockRight: "Sohbeti sağa sabitle",
      dockBottom: "Sohbeti alta sabitle",
      dockHidden: "Sohbeti gizle",
      resizeDock: "Sohbet alanını yeniden boyutlandır",
      reopenChat: "Sohbeti göster",
      defaultTab: "Ana",
      mockPlaceholder: "Pano görünümü ayracı · {tabs} sekme · {widgets} bileşen",
      mockOverview: "Genel Bakış",
      mockResearch: "Araştırma",
      mockSessionStatus: "Konu durumu",
      mockRecentFindings: "Son bulgular",
      mockSourceMap: "Kaynak haritası",
      resetTitle: "Konuşma sıfırlansın mı?",
      resetDescription: "Konuşma bağlamı sıfırlanır. Kontrol paneliniz değişmeden kalır.",
    },
    catalog: {
    ...
    questions: {
      ...
      answered: "Yanıtlandı",
      answeredElsewhere: "Başka bir yerde yanıtlandı",
      unavailable: "Kullanılamıyor",
      expired: "Süresi doldu",
      cancelled: "İptal edildi",
    },
    messages: {
      activity: "Etkinlik",
      forkFromHere: "Buradan dallandır",
      hide: "Gizle",
      hideConfirm: "Bu mesaj bu tarayıcıda gizlensin mi? Aracı mesajı görmeye devam eder.",
      hideMessage: "Mesajı gizle",
      hideTooltip: "Yalnızca bu tarayıcıda gizle",
      openInCanvas: "Kanvasta aç",
      rewind: "Geri al",
      rewindConfirm: "Bu mesajdan öncesine geri alınsın mı?",
      rewindToHere: "Buraya geri al",
      rewindUnavailable: "Temsilci çalışırken geri alma kullanılamaz",
      forkUnavailable: "Temsilci çalışırken çatallama kullanılamaz",
    ...
    modelControls: {
      ...
      reasoning: "Akıl yürütme",
      speed: "Hız",
      sessionOverride: "Oturum geçersiz kılma",
    ...
    composer: {
      ...
      microphoneAppliesNextSession:
        "Değişiklikler bir sonraki Konuşma oturumunuzu başlattığınızda uygulanır.",
      microphoneListUnsupported: "Bu tarayıcı mikrofon girişlerini listeleyemiyor.",
      noCameras: "Başka kamera bulunamadı",
      ...
      holdToRecordSetting: "Dikte etmek için mikrofon düğmesini basılı tut",
      holdToRecordSettingDescription:
        "Metni göndermeden eklemek için oluşturucu mikrofon düğmesini basılı tutun, konuşun ve ardından bırakın.",
      dictationAudioUnsupported: "Gateway, desteklenmeyen bir dikte ses biçimi döndürdü.",
      dictationBrowserAudioUnsupported: "Bu tarayıcı 8 kHz'de dikte sesi kaydedemiyor.",
      ...
      dictationFinalizationTimedOut: "Son kısmi transkript tamamlanamadan dikte durdu.",
    ...
    toolCards: {
      ...
      widgetExportRerender:
        "Bu widget'ın görüntü olarak dışa aktarılabilmesi için yeniden oluşturulması gerekiyor.",
      widgetExportFailed: "Widget dışa aktarılamadı. Tekrar deneyin.",
    ...
    sessionDiscussion: {
      ...
      unavailable: "Bu tartışma gömülemez.",
    },
    workspaceFiles: {
