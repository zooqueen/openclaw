...
export const tr: TranslationMap = {
  ...
  configView: {
    ...
    autoSaveFailed: "Kaydetme başarısız oldu",
    autoSaveConflict: "Ayarlar başka bir yerde değiştirildi",
    retry: "Yeniden dene",
    applyBannerText:
    ...
    rawDiscard: "Vazgeç",
    rawDraftBlocksApply:
      "Kaydedilmemiş ham yapılandırma düzenlemeleri var — yeniden başlatmadan önce bunları Ham düzenleyicide kaydedin veya silin.",
    rawDraftPendingFormTitle:
      "Kaydedilmemiş ham yapılandırma düzenlemeleri var — Form görünümüne geçmeden önce bunları kaydedin veya silin.",
    rawDraftBlocksFormEdit:
      "Kaydedilmemiş ham yapılandırma düzenlemeleri ayrıştırılamadı; ayarları değiştirmeden önce bunları Ham düzenleyicide düzeltin.",
