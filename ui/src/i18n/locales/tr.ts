...
export const tr: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      useCurrentChat: "Geçerli sohbeti kullan",
      useCurrentChatAria: "Revizyon istekleri için geçerli sohbeti kullan",
      useCurrentChatTooltip:
        "Revizyon isteklerini teklifin workshop oturumu yerine geçerli sohbet oturumuna gönder.",
    },
  },
  activity: {
    title: "Etkinlik",
  ...
  workboard: {
    ...
    detailRun: "Çalıştırma",
    detailUpdated: "Güncellendi",
    detailProof: "Kanıt",
    detailDiagnostics: "Tanılamalar",
    detailWorkerLogs: "Worker günlükleri",
    detailWorkerProtocol: "Worker protokolü",
