...
export const tr: TranslationMap = {
  ...
  subtitles: {
    ...
    about: "Control UI ile bağlı Gateway'in derleme kimliği.",
  ...
  aboutPage: {
    ...
    artifactSubtitle: "Bu tarayıcı paketi derlenirken içine yerleştirilen kimlik.",
    artifactDetails: "Control UI derleme ayrıntıları",
    version: "Sürüm",
    commit: "Commit kimliği",
    built: "Derlenme tarihi",
    ...
    gatewayVersionHint:
      "Etkin Gateway bağlantısı tarafından bildirilir; bu Control UI derlemesinden ayrıdır.",
  },
  profilePage: {
