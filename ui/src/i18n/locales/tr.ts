...
export const tr: TranslationMap = {
  ...
  configFormView: {
    ...
    disableStreamReveal: "Disable stream mode to reveal value",
    secretRefRawMode: "Structured value (SecretRef) - use Raw mode to edit",
    secretRefConfigFile: "Structured value (SecretRef) - edit the config file directly",
  ...
  agentsView: {
    ...
    files: {
      ...
      extensionPreview: "{extension} Preview",
      preview: "Preview",
      ...
      previewRenderedMarkdown: "Preview rendered markdown",
      reset: "Reset",
      missingCreateHint: "This file is missing. Saving will create it in the agent workspace.",
      content: "Content",
  ...
  debugView: {
    ...
    securityAuditDetails: "for details.",
