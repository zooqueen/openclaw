...
export const tr: TranslationMap = {
  ...
  dreaming: {
    ...
    advanced: {
      eyebrow: "İncele",
      title: "Günlük Kayıt Tekrarı",
      description:
        "Günlük kayıttan nelerin tekrarlandığını, nelerin yükseltilmeyi beklediğini ve nelerin zaten geçtiğini görün.",
      summaryFromDailyLog: "günlük kayıttan",
      summaryWaiting: "bekliyor",
      summaryPromotedToday: "bugün yükseltildi",
      stagedTitle: "Günlük Kaydından",
      stagedDescription: "Eski günlük kayıt girişlerinden alınan tekrar adayları.",
      shortTermTitle: "Yükseltilmeyi Bekliyor",
      shortTermDescription: "Gerçek belleğe geçmeyi bekleyen mevcut kısa vadeli adaylar.",
      sortRecent: "En yeni",
      sortSignals: "En güçlü destek",
      originDailyLog: "tekrarlandı",
      originLive: "canlı",
      originMixed: "karma",
      promotedTitle: "Son Yükseltmeler",
      promotedDescription: "Yakın zamanda yükseltme sürecini tamamlayan öğeler.",
      emptyGrounded: "Şu anda aşamalandırılmış grounded tekrar girdisi yok.",
      emptyShortTerm: "İncelenecek kısa vadeli girdi yok.",
      emptyPromoted: "İncelenecek son yükseltme yok.",
