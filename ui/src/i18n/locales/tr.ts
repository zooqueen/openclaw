...
export const tr: TranslationMap = {
  ...
  cockpit: {
    ...
    all: "Tümü",
    live: "canlı",
    noStoredSessions: "Henüz kayıtlı oturum yok.",
    runtimeInspector: "Çalışma zamanı denetçisi",
    skills: "Skills",
    cron: "Cron",
    hooks: "Hook'lar",
    gateway: "Gateway",
    ...
    manage: "Yönet",
    schedule: "Zamanlama",
    noSkillSnapshot: "Henüz Skills anlık görüntüsü yok.",
    blockedSkills: "{count} dikkat gerektiriyor.",
    automation: "Otomasyon",
    cronJobs: "{count} cron jobs",
    nextWake: "sonraki uyanma {time}",
    recentUiEvents: "{count} son UI etkinliği",
    skillStateDisabled: "devre dışı",
    skillStateReady: "hazır",
    skillStateNeedsSetup: "kurulum gerekiyor",
    timeNow: "şimdi",
    timeNever: "asla",
    minutesAgo: "{count}dk",
    hoursAgo: "{count}sa",
