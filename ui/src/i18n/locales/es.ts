...
export const es: TranslationMap = {
  ...
  dreaming: {
    ...
    advanced: {
      eyebrow: "Revisar",
      title: "Reproducción del registro diario",
      description:
        "Consulta qué se reprodujo del registro diario, qué está esperando promoción y qué ya pasó.",
      ...
      stagedDescription:
        "Candidatos de reproducción extraídos de entradas antiguas del registro diario.",
      shortTermTitle: "Esperando promoción",
      shortTermDescription: "Candidatos actuales a corto plazo que esperan pasar a memoria real.",
      ...
      promotedDescription: "Elementos que ya pasaron por la promoción recientemente.",
      emptyGrounded: "No hay entradas de reproducción fundamentada preparadas en este momento.",
      emptyShortTerm: "No hay entradas a corto plazo para revisar.",
      emptyPromoted: "No hay promociones recientes para revisar.",
