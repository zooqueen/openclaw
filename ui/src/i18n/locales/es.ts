...
export const es: TranslationMap = {
  ...
  configView: {
    ...
    retry: "Reintentar",
    applyBannerText: "Guardado en openclaw.json — reinicia el Gateway para aplicar los cambios.",
    applyBannerAction: "Reiniciar y aplicar",
    rawDiscard: "Descartar",
    rawDraftBlocksApply:
      "Hay cambios sin guardar en la configuración sin formato — guárdalos o descártalos en el editor Raw antes de reiniciar.",
    rawDraftPendingFormTitle:
      "Hay cambios sin guardar en la configuración sin formato — guárdalos o descártalos antes de cambiar a Form.",
    rawDraftBlocksFormEdit:
      "No se pudieron analizar los cambios sin guardar en la configuración sin formato; corrígelos en el editor Raw antes de cambiar la configuración.",
    invalidConfig:
