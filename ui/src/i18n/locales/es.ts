...
export const es: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      ...
      useCurrentChatAria: "Usar el chat actual para solicitudes de revisión",
      useCurrentChatTooltip:
        "Enviar solicitudes de revisión a la sesión de chat actual en lugar de a la sesión de workshop de la propuesta.",
    },
  },
  activity: {
    title: "Actividad",
  ...
  workboard: {
    ...
    detailNotePlaceholder: "Añade una decisión, un bloqueo o una nota de prueba...",
    detailAddNote: "Añadir nota",
