...
export const es: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "No se eliminó ninguna sesión de WhatsApp almacenada. Puede que ya no exista o que su directorio de autenticación requiera una limpieza manual.",
    },
  ...
  agentChip: {
    ...
    offlineOpenSettings: "Sin conexión — abrir Ajustes",
  ...
  sessionsView: {
    ...
    sessionsArchived: "{count} hilos archivados",
    ...
    runFailedReason: "La ejecución falló: {reason}",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileIdentity: "Tu perfil del Gateway",
      ...
      profileHint:
        "JPEG, PNG o WebP. Las imágenes se recortan desde el centro y se redimensionan a 512 px.",
  ...
  configView: {
    ...
    syncedHint: "Sincronizado en todos tus dispositivos a través del Gateway.",
    notifications: {
      title: "Notificaciones push",
      nativeTitle: "Notificaciones",
      hint: "Recibe notificaciones push del navegador desde tu gateway.",
      nativeHint: "La app OpenClaw muestra las notificaciones de forma nativa en este Mac.",
      ...
      nativeBlockedHint:
        "Las notificaciones de OpenClaw están desactivadas en macOS. Permítelas en Ajustes del Sistema > Notificaciones.",
    },
    appearance: {
      theme: "Tema",
    ...
    sidebarPrefs: {
      title: "Barra lateral",
      hint: "Elige qué aparece mientras se ejecutan las sesiones.",
      liveActivity: "Mostrar la actividad del agente en tiempo real en la barra lateral",
      liveActivityHint:
        "Muestra la actividad más reciente del asistente o de las herramientas debajo de las sesiones en ejecución.",
    },
    connection: {
      title: "Conexión",
      gateway: "Gateway",
  ...
  execApproval: {
    ...
    reviewRequest: "Revisar la aprobación de {agent}: {command}",
  ...
  subtitles: {
    ...
    apps: "Apps complementarias para teléfono, reloj, ordenador y navegador.",
    ...
    labs: "Funcionalidades experimentales de agentes y herramientas.",
    ...
    security:
      "Autenticación del Gateway, política de ejecución, perfil de herramientas y aprobaciones.",
    advanced:
      "Todas las secciones de configuración restantes, además del editor de archivos sin formato.",
  ...
  custodian: {
    ...
    subtitleCaretaker: "Configuración y mantenimiento del sistema.",
    ...
    history: {
      ...
      description: "Cambios realizados en este sistema, del más reciente al más antiguo.",
      ...
      invalidEdit: "Esta edición manual no superó la validación de la configuración.",
      opaqueChange:
        "El formato o los comentarios cambiaron sin que hubiera cambios visibles en las rutas de configuración.",
      sources: {
        systemAgent: "agente del sistema",
        doctor: "diagnóstico",
        settings: "ajustes",
        cli: "CLI",
        pluginInstall: "instalación de plugin",
        manualEdit: "edición manual",
        unknown: "desconocido",
      },
    },
    nudge: {
      configReload: "La recarga de la configuración se detuvo — pregúntame qué ocurrió",
      channelAuth: "La autenticación de {channel} presenta problemas — pregúntame qué ocurrió",
      channelDisconnected: "{channel} acaba de desconectarse — pregúntame qué ocurrió",
      channelDegraded: "{channel} presenta problemas — pregúntame qué ocurrió",
  ...
  mcpServers: {
    ...
    enabledSuccess: "Se habilitó el servidor MCP {name}.",
    disabledSuccess: "Se deshabilitó el servidor MCP {name}.",
    ...
    adminRequired: "Los cambios en los servidores MCP requieren acceso operator.admin.",
    enable: "Activar",
    disable: "Desactivar",
  ...
  mcpPage: {
    connectorsLink: "Descubre conectores de un solo clic en la página Plugins.",
    servers: "Servidores",
    oauth: "OAuth",
    filtered: "Filtrado",
  ...
  sessionsPage: {
    hubTablistLabel: "Secciones de sesiones",
  },
  pluginsPage: {
  ...
  labsPage: {
    intro:
      "Labs contiene funciones experimentales que pueden cambiar, dejar de funcionar o desaparecer entre versiones.",
    sectionTitle: "Funciones experimentales",
    sectionDescription:
      "Los cambios se guardan inmediatamente y se aplican a futuras ejecuciones del agente.",
    documentation: "Documentación",
    restartRequired: "Es necesario reiniciar el Gateway.",
  ...
  appsPage: {
    ...
    pairDevice: "Empareja tu dispositivo",
    sectionWatch: "En tu muñeca",
    sectionDesktop: "En tu escritorio",
    sectionBrowser: "En tu navegador",
    sectionCommunity: "Comunidad",
    badgeBundledIos: "Incluido con la app para iOS",
    badgeBundledAndroid: "Incluido con la app para Android",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Consulta chats de un vistazo y responde rápidamente desde tu muñeca.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "App complementaria en la barra de menús para tu Gateway: notificaciones, aprobaciones y chat rápido.",
      },
      windows: {
        title: "Windows",
      ...
      linux: {
        title: "Linux",
        desc: "Aplicación de escritorio nativa — versiones .deb y AppImage.",
      },
      chrome: {
  ...
  profilePage: {
    ...
    identity: {
      ...
      linkedEmailsDescription: "Direcciones de correo electrónico conectadas a este perfil.",
      ...
      avatarErrors: {
        ...
        tooLarge: "El avatar procesado supera los 512 KB.",
      },
    },
  },
  tasksPage: {
  ...
  board: {
    ...
    emptyTitle: "Un panel despejado y listo para trabajar",
    emptyHint: "Tu agente puede fijar widgets aquí — prueba a pedir una tarjeta de estado.",
    actionFailed: "No se pudo guardar el cambio en el panel.",
    actionInProgress: "Todavía se está guardando otro cambio en el panel.",
    announcement: {
      moved: "Se movió {title}.",
      resized: "Se cambió el tamaño de {title}.",
      removed: "Se eliminó {title}.",
      granted: "Se permitió el acceso al widget.",
      rejected: "Se rechazó el acceso al widget.",
    },
    widget: {
      cellLabel:
        "Widget del panel: {title}. Usa las teclas de flecha para navegar. Mantén pulsada la tecla Alt y presiona una tecla de flecha para moverlo.",
      ...
      errorDetail: "El problema se limita a esta tarjeta.",
      actionErrorTitle: "No se pudo cambiar el widget",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "Copiado",
      branches: "Ramas de la conversación",
      branchSwitchUnavailable:
        "El cambio de rama no está disponible mientras el agente está trabajando.",
      branchSwitchRequiresAdmin: "El cambio de rama requiere acceso de administrador del operador.",
    ...
    board: {
      faceLabel: "Vista del hilo",
      chatFace: "Chat",
      dashboardFace: "Panel",
      dockMenu: "Acoplamiento del chat: {dock}",
      dockLeft: "Acoplar el chat a la izquierda",
      dockRight: "Acoplar el chat a la derecha",
      dockBottom: "Acoplar el chat abajo",
      dockHidden: "Ocultar el chat",
      resizeDock: "Cambiar el tamaño del chat acoplado",
      reopenChat: "Mostrar el chat",
      defaultTab: "Principal",
      mockPlaceholder: "Área de vista del tablero · {tabs} pestañas · {widgets} widgets",
      ...
      mockSourceMap: "Mapa de origen",
      resetTitle: "¿Restablecer la conversación?",
      resetDescription:
        "El contexto de la conversación se restablecerá. Tu panel permanecerá igual.",
    },
    catalog: {
    ...
    messages: {
      ...
      hide: "Ocultar",
      hideConfirm: "¿Ocultar este mensaje en este navegador? El agente seguirá viéndolo.",
      hideMessage: "Ocultar mensaje",
      hideTooltip: "Ocultar solo en este navegador",
      openInCanvas: "Abrir en lienzo",
      rewind: "Retroceder",
      rewindConfirm: "¿Retroceder hasta antes de este mensaje?",
      rewindToHere: "Retroceder hasta aquí",
      rewindUnavailable: "No se puede retroceder mientras el agente está trabajando",
      forkUnavailable: "No se puede bifurcar mientras el agente está trabajando",
    ...
    modelControls: {
      ...
      reasoning: "Razonamiento",
      speed: "Velocidad",
      sessionOverride: "Configuración específica de la sesión",
    ...
    composer: {
      ...
      cameraInput: "Cámara",
      cameraListUnsupported: "Este navegador no puede mostrar la lista de cámaras.",
      cameraNoneFound: "No se encontró ninguna cámara.",
      cameraPageInactive: "Las cámaras no están disponibles mientras esta página esté inactiva.",
      ...
      microphoneAppliesNextSession:
        "Los cambios se aplicarán cuando inicies tu próxima sesión de conversación.",
      ...
      holdToRecordSetting: "Mantener pulsado el botón del micrófono para dictar",
      holdToRecordSettingDescription:
        "Mantén pulsado el botón del micrófono del cuadro de redacción, habla y luego suéltalo para insertar el texto sin enviarlo.",
      ...
      dictationConnecting: "Iniciando el dictado…",
      dictationDisconnected: "El dictado se detuvo porque el Gateway se desconectó.",
      dictationFailed: "Error en el dictado.",
      dictationFinalizing: "Finalizando el dictado…",
      dictationFinalizationTimedOut:
        "El dictado se detuvo antes de que pudiera finalizarse la última transcripción parcial.",
      ...
      turnCameraOff: "Desactivar la cámara",
      turnCameraOn: "Activar la cámara",
    ...
    toolCards: {
      ...
      widgetExportFailed: "No se pudo exportar el widget. Inténtalo de nuevo.",
    ...
    sessionDiscussion: {
      ...
      unavailable: "Esta discusión no se puede insertar.",
    },
    workspaceFiles: {
