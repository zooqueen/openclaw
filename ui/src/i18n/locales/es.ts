...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    about: "Identidad de compilación de Control UI y del Gateway conectado.",
  ...
  aboutPage: {
    ...
    artifactSubtitle: "Identidad integrada al compilar este artefacto del navegador.",
    artifactDetails: "Detalles de compilación de Control UI",
    version: "Versión",
    commit: "Commit",
    built: "Compilado",
    unavailable: "No disponible",
    copyCommit: "Copiar el hash completo del commit",
    copyingCommit: "Copiando el hash del commit",
    ...
    gatewayVersionHint:
      "Informada por la conexión activa al Gateway; es independiente de esta compilación de Control UI.",
  },
  profilePage: {
