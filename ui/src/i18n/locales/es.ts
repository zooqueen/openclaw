...
export const es: TranslationMap = {
  ...
  cockpit: {
    ...
    all: "Todas",
    live: "en vivo",
    noStoredSessions: "Aún no hay sesiones guardadas.",
    runtimeInspector: "Inspector de runtime",
    skills: "Skills",
    cron: "Cron",
    hooks: "Hooks",
    gateway: "Gateway",
    ...
    manage: "Administrar",
    schedule: "Programar",
    noSkillSnapshot: "Aún no hay snapshot de skills.",
    blockedSkills: "{count} requieren atención.",
    automation: "Automatización",
    cronJobs: "{count} trabajos cron",
    nextWake: "próxima activación {time}",
    recentUiEvents: "{count} eventos recientes de la UI",
    skillStateDisabled: "deshabilitado",
    skillStateReady: "listo",
    skillStateNeedsSetup: "requiere configuración",
    timeNow: "ahora",
    timeNever: "nunca",
