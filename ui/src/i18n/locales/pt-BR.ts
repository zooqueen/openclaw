...
export const pt_BR: TranslationMap = {
  ...
  dreaming: {
    ...
    advanced: {
      eyebrow: "Revisão",
      title: "Reprodução do Registro Diário",
      description:
        "Veja o que foi reproduzido do registro diário, o que está aguardando promoção e o que já foi aprovado.",
      summaryFromDailyLog: "do registro diário",
      summaryWaiting: "aguardando",
      summaryPromotedToday: "promovido hoje",
      stagedTitle: "Do Registro Diário",
      stagedDescription:
        "Candidatos à reprodução extraídos de entradas antigas do registro diário.",
      shortTermTitle: "Aguardando Promoção",
      shortTermDescription:
        "Candidatos atuais de curto prazo aguardando para se tornarem memória real.",
      ...
      promotedDescription: "Itens que já passaram pela promoção recentemente.",
      emptyGrounded: "Nenhuma entrada de reprodução fundamentada preparada no momento.",
