...
export const pt_BR: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      title: "OpenClaw para dispositivos móveis",
      subtitle: "Escaneie este código QR no aplicativo móvel para conectar um novo telefone.",
      generating: "Criando um código de configuração seguro…",
      failed: "Não foi possível criar um código de configuração.",
      qrAlt: "Código QR de pareamento do OpenClaw para dispositivos móveis",
      ...
      pending: "Solicitações de dispositivos aguardando revisão: {count}",
      review: "Revisão",
      waiting:
        "Os aplicativos móveis oficiais do OpenClaw se conectam automaticamente após a leitura.",
