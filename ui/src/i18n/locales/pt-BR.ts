...
export const pt_BR: TranslationMap = {
  ...
  configView: {
    ...
    autoSaveConflict: "As configurações foram alteradas em outro local",
    retry: "Tentar novamente",
    ...
    rawDraftBlocksApply:
      "Há edições não salvas na configuração bruta — salve-as ou descarte-as no editor Raw antes de reiniciar.",
    rawDraftPendingFormTitle:
      "Há edições não salvas na configuração bruta — salve-as ou descarte-as antes de mudar para Form.",
    rawDraftBlocksFormEdit:
      "Não foi possível analisar as edições não salvas na configuração bruta; corrija-as no editor Raw antes de alterar as configurações.",
    invalidConfig:
