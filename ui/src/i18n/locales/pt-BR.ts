...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    about: "Identidade de compilação do Control UI e do Gateway conectado.",
  ...
  aboutPage: {
    ...
    artifactSubtitle: "Identidade incorporada quando este artefato do navegador foi compilado.",
    artifactDetails: "Detalhes da build do Control UI",
    version: "Versão",
    commit: "Commit",
    built: "Compilado",
    unavailable: "Indisponível",
    copyCommit: "Copiar o hash completo do commit",
    copyingCommit: "Copiando o hash do commit",
    ...
    gatewayVersionHint:
      "Informada pela conexão ativa ao Gateway; separada desta build do Control UI.",
  },
  profilePage: {
