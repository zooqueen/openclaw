...
export const pt_BR: TranslationMap = {
  ...
  cockpit: {
    ...
    all: "Todas",
    live: "ao vivo",
    noStoredSessions: "Ainda não há sessões armazenadas.",
    runtimeInspector: "Inspetor de runtime",
    skills: "Skills",
    cron: "Cron",
    hooks: "Hooks",
    gateway: "Gateway",
    ...
    noSkillSnapshot: "Ainda não há snapshot de skill.",
    blockedSkills: "{count} precisam de atenção.",
    automation: "Automação",
    cronJobs: "{count} tarefas cron",
    nextWake: "próximo despertar {time}",
    recentUiEvents: "{count} eventos recentes da UI",
    skillStateDisabled: "desativada",
    skillStateReady: "pronto",
    skillStateNeedsSetup: "precisa de configuração",
    timeNow: "agora",
    timeNever: "nunca",
