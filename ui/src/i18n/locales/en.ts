...
export const en: TranslationMap = {
  ...
  cockpit: {
    ...
    all: "All",
    live: "live",
    noStoredSessions: "No stored sessions yet.",
    ...
    manage: "Manage",
    schedule: "Schedule",
    noSkillSnapshot: "No skill snapshot yet.",
    blockedSkills: "{count} need attention.",
    automation: "Automation",
    cronJobs: "{count} cron jobs",
    nextWake: "next wake {time}",
    recentUiEvents: "{count} recent UI events",
    skillStateDisabled: "disabled",
    skillStateReady: "ready",
    skillStateNeedsSetup: "needs setup",
    timeNow: "now",
    timeNever: "never",
    minutesAgo: "{count}m",
    hoursAgo: "{count}h",
