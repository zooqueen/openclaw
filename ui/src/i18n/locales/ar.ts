...
export const ar: TranslationMap = {
  ...
  cockpit: {
    ...
    all: "الكل",
    live: "مباشر",
    noStoredSessions: "لا توجد جلسات محفوظة بعد.",
    runtimeInspector: "مفتش وقت التشغيل",
    skills: "Skills",
    cron: "Cron",
    hooks: "الخطافات",
    gateway: "Gateway",
    currentOrigin: "الأصل الحالي",
    channels: "القنوات",
    nodes: "العُقد",
    runs: "عمليات التشغيل",
    manage: "إدارة",
    schedule: "الجدول",
    noSkillSnapshot: "لا توجد لقطة Skills بعد.",
    blockedSkills: "{count} تحتاج إلى الانتباه.",
    automation: "الأتمتة",
    cronJobs: "{count} مهام cron",
    nextWake: "التنبيه التالي {time}",
    recentUiEvents: "{count} من أحداث واجهة المستخدم الأخيرة",
    skillStateDisabled: "معطّلة",
    skillStateReady: "جاهز",
    skillStateNeedsSetup: "يحتاج إلى إعداد",
    timeNow: "الآن",
    timeNever: "أبدًا",
    minutesAgo: "{count}د",
    hoursAgo: "{count}س",
