...
export const ar: TranslationMap = {
  ...
  configView: {
    ...
    retry: "إعادة المحاولة",
    applyBannerText: "تم الحفظ في openclaw.json — أعد تشغيل البوابة لتطبيق التغييرات.",
    applyBannerAction: "إعادة التشغيل والتطبيق",
    rawDiscard: "تجاهل",
    rawDraftBlocksApply:
      "توجد تعديلات غير محفوظة على الإعدادات الخام — احفظها أو تجاهلها في محرر الإعدادات الخام قبل إعادة التشغيل.",
    rawDraftPendingFormTitle:
      "توجد تعديلات غير محفوظة على الإعدادات الخام — احفظها أو تجاهلها قبل التبديل إلى «النموذج».",
    rawDraftBlocksFormEdit:
      "تعذر تحليل تعديلات الإعدادات الخام غير المحفوظة؛ عالجها في محرر الإعدادات الخام قبل تغيير الإعدادات.",
