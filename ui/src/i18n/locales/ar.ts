...
export const ar: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      ...
      useCurrentChatTooltip:
        "أرسل طلبات المراجعة إلى جلسة الدردشة الحالية بدلاً من جلسة ورشة عمل المقترح.",
    },
  },
  activity: {
    title: "النشاط",
  ...
  workboard: {
    ...
    dependenciesBlockedTitle: "بانتظار التبعيات: {parents}.",
