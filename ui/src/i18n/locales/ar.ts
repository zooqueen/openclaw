...
export const ar: TranslationMap = {
  ...
  subtitles: {
    ...
    about: "هوية إصدار Control UI وGateway المتصل.",
  ...
  aboutPage: {
    ...
    artifactSubtitle: "الهوية المضمّنة عند إنشاء نسخة المتصفح هذه.",
    artifactDetails: "تفاصيل إصدار Control UI",
    version: "الإصدار",
    commit: "الالتزام",
    built: "تاريخ البناء",
    unavailable: "غير متاح",
    copyCommit: "نسخ تجزئة الالتزام الكاملة",
    copyingCommit: "جارٍ نسخ تجزئة الالتزام",
    copiedCommit: "تم نسخ تجزئة الالتزام",
    copyCommitFailed: "تعذّر نسخ تجزئة الالتزام",
    gatewayVersion: "إصدار Gateway المتصل",
    gatewayVersionHint: "يُبلّغ عنه اتصال Gateway النشط، وهو منفصل عن إصدار Control UI هذا.",
  },
  profilePage: {
