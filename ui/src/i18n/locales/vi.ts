...
export const vi: TranslationMap = {
  ...
  subtitles: {
    ...
    about: "Thông tin nhận dạng bản dựng của Control UI và Gateway đã kết nối.",
  ...
  aboutPage: {
    ...
    artifactSubtitle: "Thông tin nhận dạng được nhúng khi tạo bản dựng cho trình duyệt này.",
    artifactDetails: "Chi tiết bản dựng Control UI",
    version: "Phiên bản",
    commit: "Mã commit",
    built: "Ngày dựng",
    unavailable: "Không có",
    copyCommit: "Sao chép đầy đủ mã băm commit",
    copyingCommit: "Đang sao chép mã băm commit",
    copiedCommit: "Đã sao chép mã băm commit",
    copyCommitFailed: "Không thể sao chép mã băm commit",
    gatewayVersion: "Phiên bản Gateway đã kết nối",
    gatewayVersionHint:
      "Được báo cáo bởi kết nối Gateway đang hoạt động; tách biệt với bản dựng Control UI này.",
  },
  profilePage: {
