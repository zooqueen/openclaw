...
export const vi: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      useCurrentChat: "Sử dụng cuộc trò chuyện hiện tại",
      useCurrentChatAria: "Sử dụng cuộc trò chuyện hiện tại cho các yêu cầu chỉnh sửa",
  ...
  workboard: {
    ...
    detailNoNotes: "Chưa có ghi chú của người vận hành.",
    detailNotePlaceholder: "Thêm ghi chú về quyết định, trở ngại hoặc bằng chứng...",
    ...
    dependenciesReady: "{count} đã sẵn sàng",
    dependenciesReadyTitle: "{count} phụ thuộc đã hoàn tất.",
    dependenciesBlocked: "{count} bị chặn",
    dependenciesBlockedTitle: "Đang chờ các phụ thuộc: {parents}.",
