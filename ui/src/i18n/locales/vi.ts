...
export const vi: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Không có phiên WhatsApp nào đã lưu được xóa. Phiên này có thể đã không còn tồn tại hoặc thư mục xác thực của phiên có thể cần được dọn dẹp thủ công.",
    },
  ...
  sessionsView: {
    ...
    viewArchived: "Xem mục đã lưu trữ",
    sessionArchived: "Đã lưu trữ luồng",
    sessionsArchived: "Đã lưu trữ {count} luồng",
    deleteAllArchived: "Xóa tất cả mục đã lưu trữ…",
    ...
    runFailedReason: "Lần chạy thất bại: {reason}",
    runErrorTimedOut: "Đã hết thời gian chờ",
    runErrorUnknown: "Lỗi không xác định",
    attentionRequired: "Phiên cần được chú ý",
    model: "Mô hình",
    ...
    invalidEmojiIcon: "Hãy nhập chính xác một emoji.",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint: "JPEG, PNG hoặc WebP. Hình ảnh được cắt từ giữa và đổi kích thước thành 512px.",
      ...
      avatarTooLarge: "Ảnh đại diện sau khi xử lý vẫn quá lớn.",
  ...
  configView: {
    ...
    syncedHint: "Được đồng bộ hóa trên các thiết bị của bạn thông qua Gateway.",
    notifications: {
      title: "Thông báo đẩy",
      nativeTitle: "Thông báo",
      hint: "Nhận thông báo đẩy trên trình duyệt từ gateway của bạn.",
      nativeHint: "Thông báo được ứng dụng OpenClaw trên máy Mac này hiển thị nguyên bản.",
      ...
      nativeBlockedHint:
        "Thông báo cho OpenClaw đã bị tắt trong macOS. Hãy cho phép thông báo trong Cài đặt hệ thống > Thông báo.",
    },
    appearance: {
      theme: "Giao diện",
    ...
    sidebarPrefs: {
      ...
      liveActivity: "Hiển thị hoạt động trực tiếp của tác nhân trong thanh bên",
      liveActivityHint:
  ...
  execApproval: {
    ...
    otherPending: "Các yêu cầu khác đang chờ xử lý",
    reviewRequest: "Xem xét yêu cầu phê duyệt từ {agent}: {command}",
  ...
  subtitles: {
    ...
    apps: "Ứng dụng đồng hành dành cho điện thoại, đồng hồ, máy tính và trình duyệt.",
    ...
    labs: "Các tính năng thử nghiệm dành cho tác nhân và công cụ.",
    ...
    notifications: "Thông báo đẩy trên trình duyệt từ Gateway của bạn.",
    security: "Xác thực Gateway, chính sách thực thi, hồ sơ công cụ và phê duyệt.",
    advanced: "Tất cả các mục cấu hình còn lại, cùng với trình chỉnh sửa tệp thô.",
  ...
  custodian: {
    ...
    history: {
      ...
      description: "Những thay đổi trên hệ thống này, mới nhất trước.",
      loading: "Đang tải các thay đổi gần đây…",
      empty: "Chưa có thay đổi nào được ghi lại.",
      requestFailed: "OpenClaw không thể tải lịch sử thay đổi.",
      loadMore: "Tải thêm",
      loadingMore: "Đang tải thêm…",
      changedPaths: "Các đường dẫn đã thay đổi ({count})",
      invalidEdit: "Chỉnh sửa thủ công này không vượt qua bước xác thực cấu hình.",
      opaqueChange:
        "Định dạng hoặc chú thích đã thay đổi nhưng không có thay đổi nào hiển thị đối với đường dẫn cấu hình.",
      sources: {
        systemAgent: "system-agent",
        doctor: "doctor",
        settings: "cài đặt",
        cli: "CLI",
        pluginInstall: "cài đặt plugin",
        manualEdit: "chỉnh sửa thủ công",
        unknown: "không xác định",
      },
    },
    nudge: {
      configReload: "Đã dừng tải lại cấu hình — hãy hỏi tôi chuyện gì đã xảy ra",
      channelAuth: "Xác thực {channel} đang gặp sự cố — hãy hỏi tôi chuyện gì đã xảy ra",
      channelDisconnected: "{channel} vừa ngắt kết nối — hãy hỏi tôi chuyện gì đã xảy ra",
      channelDegraded: "{channel} đang gặp sự cố — hãy hỏi tôi chuyện gì đã xảy ra",
      channelFallback: "Một kênh",
      dismiss: "Bỏ qua bản cập nhật này",
    },
  },
  mcpServers: {
    add: "Thêm máy chủ",
    ...
    targetInvalid: "Nhập URL http(s) hoặc một dòng lệnh.",
    nameTaken: "Một máy chủ MCP có tên “{name}” đã tồn tại.",
  ...
  mcpPage: {
    connectorsLink: "Khám phá các trình kết nối một lần nhấp trên trang Plugins.",
    servers: "Máy chủ",
    oauth: "OAuth",
    filtered: "Đã lọc",
  ...
  labsPage: {
    intro:
      "Labs chứa các tính năng thử nghiệm có thể thay đổi, gặp lỗi hoặc biến mất giữa các bản phát hành.",
    sectionTitle: "Tính năng thử nghiệm",
    sectionDescription:
      "Các thay đổi được lưu ngay lập tức và áp dụng cho những lần chạy tác nhân trong tương lai.",
    ...
    codeMode: {
      title: "Chế độ mã",
      description:
        "Cho phép các tác nhân kết hợp công cụ trong những quy trình JavaScript nhỏ gọn, được cách ly.",
    },
    swarm: {
      title: "Bầy tác tử",
  ...
  appsPage: {
    ...
    havePhone: "Bạn đã có ứng dụng?",
    pairDevice: "Ghép nối thiết bị của bạn",
    sectionWatch: "Trên cổ tay",
    sectionDesktop: "Trên máy tính",
    sectionBrowser: "Trong trình duyệt",
    sectionCommunity: "Cộng đồng",
    badgeBundledIos: "Đi kèm ứng dụng iOS",
    badgeBundledAndroid: "Đi kèm ứng dụng Android",
    ...
    ctaBrowseClawHub: "Khám phá ClawHub",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Xem nhanh cuộc trò chuyện và trả lời nhanh ngay trên cổ tay.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Ứng dụng đồng hành trên thanh menu dành cho Gateway của bạn — thông báo, phê duyệt và trò chuyện nhanh.",
      },
      windows: {
        title: "Windows",
      ...
      linux: {
        title: "Linux",
        desc: "Ứng dụng máy tính nguyên bản — các bản dựng .deb và AppImage.",
      },
      chrome: {
  ...
  presence: {
    rosterLabel: "Hiển thị những người đang trực tuyến",
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatar: "Ảnh đại diện",
      avatarDescription:
        "PNG, JPEG hoặc WebP. Hình ảnh được đổi kích thước thành 256 × 256 hoặc nhỏ hơn.",
      chooseAvatar: "Chọn hình ảnh",
      processingAvatar: "Đang xử lý…",
      displayName: "Tên hiển thị",
      displayNameDescription: "Hiển thị cho những người khác sử dụng gateway này.",
      linkedEmails: "Email được liên kết",
      ...
      avatarErrors: {
        ...
        sourceTooLarge: "Chọn hình ảnh có dung lượng từ 10 MB trở xuống.",
        tooLarge: "Ảnh đại diện sau khi xử lý lớn hơn 512 KB.",
      },
    },
  },
  tasksPage: {
  ...
  board: {
    ...
    moreTabs: "Thêm tab bảng điều khiển",
    gridLabel: "Tiện ích bảng điều khiển",
    emptyTitle: "Bảng trống, sẵn sàng để làm việc",
    emptyHint:
      "Agent của bạn có thể ghim các tiện ích tại đây — hãy thử yêu cầu một thẻ trạng thái.",
    actionFailed: "Không thể lưu thay đổi trên bảng điều khiển.",
    actionInProgress: "Một thay đổi khác trên bảng điều khiển vẫn đang được lưu.",
    announcement: {
      moved: "Đã di chuyển {title}.",
      resized: "Đã thay đổi kích thước {title}.",
      removed: "Đã xóa {title}.",
      granted: "Đã cho phép tiện ích truy cập.",
      rejected: "Đã từ chối tiện ích truy cập.",
    },
    widget: {
      cellLabel:
        "Tiện ích bảng điều khiển: {title}. Dùng các phím mũi tên để điều hướng. Giữ Alt và nhấn một phím mũi tên để di chuyển tiện ích.",
      moveHandle: "Di chuyển {title}",
      resizeHandle: "Thay đổi kích thước {title}",
      menuLabel: "Tùy chọn tiện ích",
      moveToTab: "Di chuyển sang tab",
      ...
      actionErrorDetail: "Bảng điều khiển đã giữ nguyên trạng thái trước đó của tiện ích.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "Đã sao chép",
      branches: "Các nhánh hội thoại",
      branchSwitchUnavailable: "Không thể chuyển nhánh khi tác nhân đang làm việc.",
      branchSwitchRequiresAdmin: "Việc chuyển nhánh yêu cầu quyền quản trị viên vận hành.",
      untitledBranch: "Nhánh chưa có tiêu đề",
      oneMessage: "{count} tin nhắn",
      messages: "{count} tin nhắn",
      activeBranch: "Nhánh đang hoạt động",
    },
    board: {
      faceLabel: "Mặt hội thoại",
      chatFace: "Trò chuyện",
      dashboardFace: "Bảng điều khiển",
      dockMenu: "Thanh neo trò chuyện: {dock}",
      dockLeft: "Neo trò chuyện sang trái",
      dockRight: "Neo trò chuyện sang phải",
      dockBottom: "Neo trò chuyện xuống dưới",
      dockHidden: "Ẩn trò chuyện",
      resizeDock: "Đổi kích thước thanh neo trò chuyện",
      reopenChat: "Hiển thị trò chuyện",
      defaultTab: "Chính",
      mockPlaceholder: "Đường phân cách chế độ xem bảng · {tabs} thẻ · {widgets} tiện ích",
      mockOverview: "Tổng quan",
      mockResearch: "Nghiên cứu",
      mockSessionStatus: "Trạng thái luồng",
      mockRecentFindings: "Phát hiện gần đây",
      mockSourceMap: "Sơ đồ nguồn",
      resetTitle: "Đặt lại cuộc trò chuyện?",
      resetDescription:
        "Ngữ cảnh cuộc trò chuyện sẽ được đặt lại. Bảng điều khiển của bạn vẫn được giữ nguyên.",
    },
    catalog: {
    ...
    sidebar: {
      ...
      toolActivity: "Đang sử dụng {tool}",
    },
    welcome: {
    ...
    questions: {
      ...
      answered: "Đã phản hồi",
      answeredElsewhere: "Đã trả lời ở nơi khác",
      unavailable: "Không khả dụng",
      expired: "Đã hết hạn",
      cancelled: "Đã hủy",
    },
    messages: {
      activity: "Hoạt động",
      forkFromHere: "Tạo nhánh từ đây",
      hide: "Ẩn",
      hideConfirm: "Ẩn tin nhắn này trong trình duyệt này? Tác nhân vẫn nhìn thấy tin nhắn.",
      hideMessage: "Ẩn tin nhắn",
      hideTooltip: "Chỉ ẩn trong trình duyệt này",
      openInCanvas: "Mở trong canvas",
      rewind: "Quay lại",
      rewindConfirm: "Quay lại thời điểm trước tin nhắn này?",
      rewindToHere: "Quay lại đây",
      rewindUnavailable: "Không thể quay lại khi tác nhân đang hoạt động",
      forkUnavailable: "Không thể tạo nhánh khi tác nhân đang hoạt động",
    ...
    modelControls: {
      ...
      reasoning: "Lập luận",
      speed: "Tốc độ",
      sessionOverride: "Ghi đè cho phiên",
      usingDefault: "Đang dùng giá trị mặc định từ Cài đặt",
    ...
    composer: {
      ...
      cameraInput: "Camera",
      cameraListUnsupported: "Trình duyệt này không thể liệt kê camera.",
      cameraNoneFound: "Không tìm thấy máy ảnh.",
      cameraPageInactive: "Camera không khả dụng khi trang này không hoạt động.",
      ...
      microphoneAppliesNextSession:
        "Các thay đổi sẽ được áp dụng khi bạn bắt đầu phiên Talk tiếp theo.",
      microphoneListUnsupported: "Trình duyệt này không thể liệt kê đầu vào micrô.",
      noCameras: "Không tìm thấy camera bổ sung",
      ...
      holdToRecordSetting: "Nhấn giữ nút micrô để đọc chính tả",
      holdToRecordSettingDescription:
        "Nhấn giữ nút micrô trong ô soạn thảo, nói, rồi thả ra để chèn văn bản mà không gửi.",
      ...
      dictationBrowserAudioUnsupported:
        "Trình duyệt này không thể thu âm thanh đọc chính tả ở tần số 8 kHz.",
      dictationConnecting: "Đang bắt đầu đọc chính tả…",
      dictationDisconnected: "Đã dừng đọc chính tả vì Gateway bị ngắt kết nối.",
      dictationFailed: "Đọc chính tả không thành công.",
      dictationFinalizing: "Đang hoàn tất đọc chính tả…",
      dictationFinalizationTimedOut:
        "Tính năng đọc chính tả đã dừng trước khi phần bản chép lời cuối cùng có thể được hoàn tất.",
      dictationProviderUnavailable:
        "Chưa cấu hình nhà cung cấp dịch vụ chuyển lời nói thành văn bản cho tính năng đọc chính tả.",
      dictationRecording: "Đang ghi âm {elapsed}",
      dictationReleaseToInsert: "Thả để chèn nội dung đọc chính tả",
      ...
      selectedCameraUnavailable:
        "Camera đã chọn không khả dụng. Hãy chọn camera khác hoặc Mặc định của hệ thống.",
    ...
    toolCards: {
      ...
      widgetActions: "Thao tác với tiện ích",
      copyToClipboard: "Sao chép vào bảng nhớ tạm",
      downloadFile: "Tải tệp xuống",
      widgetExportRerender: "Tiện ích này cần được hiển thị lại để xuất dưới dạng hình ảnh.",
      widgetExportFailed: "Không thể xuất tiện ích. Hãy thử lại.",
    ...
    sessionDiscussion: {
      ...
      unavailable: "Không thể nhúng cuộc thảo luận này.",
    },
    workspaceFiles: {
