...
export const vi: TranslationMap = {
  ...
  setup: {
    eyebrow: "OpenClaw onboarding",
    title: "Set up your local assistant",
    connecting: "Connecting to the local setup host…",
    connected: "Connected to the local setup host",
    waiting: "Waiting for the setup wizard…",
    currentStep: "OpenClaw setup",
    localModel: "Local model: Gemma 4 E2B",
    noApiKey: "No API key is used by the browser assistant.",
    modelLoading: "Loading local model…",
    modelReady: "Local model ready",
    structuredMode: "Structured setup mode",
    modelPreparing: "Preparing local model…",
    missingToken: "The setup link is missing its one-time token.",
    setupComplete: "Setup complete.",
    closeTab: "Close this tab and continue in the OpenClaw dashboard.",
    continue: "Continue",
    yes: "Yes",
    no: "No",
    useExactValue: "Use exact value",
    sensitiveNote:
      "This value is sent directly to OpenClaw and is not passed through the local model.",
    sensitiveSubmitted: "Sensitive value submitted.",
    plannerFallback: "I could not interpret that locally. Use the setup control directly.",
  },
};
