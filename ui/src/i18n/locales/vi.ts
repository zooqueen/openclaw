...
export const vi: TranslationMap = {
  ...
  workspaces: {
    ...
    widget: {
      ...
      agentStatus: {
        empty: "Chưa có agent hoặc phiên nào.",
        busy: "Bận",
        idle: "Đang chờ",
        progress: "Hoàn thành {percent}%",
      },
      customWidgetApprovals: {
        empty: "Không có widget tùy chỉnh nào đang chờ phê duyệt.",
        kind: "Widget tùy chỉnh",
        requestedBy: "Được yêu cầu bởi {agent}",
        approve: "Chấp thuận",
        reject: "Từ chối",
        permissionRequired: "Cần quyền phê duyệt",
      },
      usage: {
        cost: "Cost",
        tokens: "Tokens",
