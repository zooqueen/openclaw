...
export const vi: TranslationMap = {
  ...
  cockpit: {
    ...
    all: "Tất cả",
    live: "trực tiếp",
    noStoredSessions: "Chưa có phiên nào được lưu.",
    runtimeInspector: "Trình kiểm tra runtime",
    skills: "Skills",
    cron: "Cron",
    hooks: "Hooks",
    gateway: "Gateway",
    currentOrigin: "nguồn gốc hiện tại",
    channels: "kênh",
    nodes: "nút",
    runs: "lượt chạy",
    manage: "Quản lý",
    schedule: "Lịch",
    noSkillSnapshot: "Chưa có bản chụp nhanh skill.",
    blockedSkills: "{count} cần chú ý.",
    automation: "Tự động hóa",
    cronJobs: "{count} cron jobs",
    nextWake: "lần thức tiếp theo {time}",
    recentUiEvents: "{count} sự kiện UI gần đây",
    skillStateDisabled: "đã tắt",
    skillStateReady: "sẵn sàng",
    skillStateNeedsSetup: "cần thiết lập",
    timeNow: "bây giờ",
