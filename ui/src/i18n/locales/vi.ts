...
export const vi: TranslationMap = {
  ...
  execApproval: {
    ...
    allowAlwaysUnavailable:
      "Chính sách phê duyệt có hiệu lực yêu cầu phê duyệt mỗi lần, nên Allow Always không khả dụng.",
    deny: "Từ chối",
    labels: {
      host: "Máy chủ",
      agent: "Agent",
  ...
  activity: {
    title: "Hoạt động",
    subtitle: "Hoạt động công cụ tạm thời được suy ra từ các sự kiện phiên trực tiếp.",
    visibleCount: "{visible} trên {total}",
    filtersLabel: "Bộ lọc hoạt động",
    search: "Tìm kiếm",
    searchPlaceholder: "Lọc theo công cụ, tóm tắt, lần chạy, phiên",
    toolFilter: "Công cụ",
    ...
    argumentHiddenOne: "Đã ẩn 1 đối số",
    argumentsHidden: "Đã ẩn {count} đối số",
    streamLabel: "Mục hoạt động công cụ",
    toolCallId: "Lệnh gọi công cụ",
    runId: "Chạy",
    session: "Phiên",
    outputTruncated: "Bản xem trước đã được biên tập và rút gọn.",
