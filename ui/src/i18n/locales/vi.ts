...
export const vi: TranslationMap = {
  ...
  configView: {
    ...
    retry: "Thử lại",
    applyBannerText: "Đã lưu vào openclaw.json — hãy khởi động lại Gateway để áp dụng.",
    applyBannerAction: "Khởi động lại và áp dụng",
    rawDiscard: "Loại bỏ",
    rawDraftBlocksApply:
      "Có chỉnh sửa cấu hình thô chưa được lưu — hãy lưu hoặc hủy các chỉnh sửa đó trong trình chỉnh sửa Raw trước khi khởi động lại.",
    rawDraftPendingFormTitle:
      "Có chỉnh sửa cấu hình thô chưa được lưu — hãy lưu hoặc hủy các chỉnh sửa đó trước khi chuyển sang Form.",
    rawDraftBlocksFormEdit:
      "Không thể phân tích cú pháp các chỉnh sửa cấu hình thô chưa được lưu; hãy xử lý chúng trong trình chỉnh sửa Raw trước khi thay đổi cài đặt.",
    invalidConfig:
