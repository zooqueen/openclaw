...
export const vi: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      adminRequired: "Cần có quyền truy cập của quản trị viên để tạo mã thiết lập.",
      title: "OpenClaw mobile",
      subtitle: "Quét mã QR này trong ứng dụng di động để kết nối điện thoại mới.",
      generating: "Đang tạo mã thiết lập an toàn…",
      failed: "Không thể tạo mã thiết lập.",
      qrAlt: "Mã QR ghép nối OpenClaw mobile",
      qrUnavailable: "Không có mã QR. Thay vào đó, hãy sao chép mã thiết lập.",
      copySetupCode: "Sao chép mã thiết lập",
      newCode: "Mã mới",
      showSetupCode: "Hiển thị mã thiết lập",
      pending: "Yêu cầu thiết bị đang chờ xem xét: {count}",
      review: "Đánh giá",
      waiting: "Các ứng dụng OpenClaw mobile chính thức sẽ tự động kết nối sau khi quét.",
