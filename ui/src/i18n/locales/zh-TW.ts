...
export const zh_TW: TranslationMap = {
  ...
  dreaming: {
    ...
    advanced: {
      eyebrow: "檢視",
      title: "每日日誌重播",
      description: "查看有哪些內容從每日日誌重播、有哪些正在等待提升，以及哪些已經成功通過。",
      summaryFromDailyLog: "來自每日日誌",
      summaryWaiting: "等待中",
      summaryPromotedToday: "今日已提升",
      stagedTitle: "來自每日日誌",
      stagedDescription: "從較早的每日日誌項目中提取的重播候選內容。",
      shortTermTitle: "等待提升",
      shortTermDescription: "目前正在等待晉升為真實記憶的短期候選內容。",
      sortRecent: "最近",
      sortSignals: "支持度最高",
      originDailyLog: "已重播",
      originLive: "即時",
      originMixed: "混合",
      promotedTitle: "最近提升",
      promotedDescription: "最近已成功完成提升的項目。",
      emptyGrounded: "目前沒有已暫存的 grounded 重播項目。",
      emptyShortTerm: "沒有可檢視的短期項目。",
      emptyPromoted: "沒有可檢視的最近提升項目。",
      updatedPrefix: "更新於",
    },
    stats: {
      shortTerm: "短期",
