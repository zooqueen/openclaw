...
export const zh_TW: TranslationMap = {
  ...
  cockpit: {
    ...
    all: "全部",
    live: "即時",
    noStoredSessions: "尚無已儲存的工作階段。",
    runtimeInspector: "執行階段檢查器",
    skills: "Skills",
    cron: "Cron",
    hooks: "Hooks",
    gateway: "Gateway",
    ...
    manage: "管理",
    schedule: "排程",
    noSkillSnapshot: "尚無 skill 快照。",
    blockedSkills: "{count} 個需要注意。",
    automation: "自動化",
    cronJobs: "{count} 個 cron jobs",
    nextWake: "下次喚醒 {time}",
    recentUiEvents: "{count} 個最近的 UI 事件",
    skillStateDisabled: "已停用",
    skillStateReady: "就緒",
    skillStateNeedsSetup: "需要設定",
    timeNow: "現在",
    timeNever: "永不",
