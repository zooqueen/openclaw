...
export const zh_TW: TranslationMap = {
  ...
  configView: {
    ...
    autoSaveSaved: "已儲存",
    autoSaveFailed: "儲存失敗",
    autoSaveConflict: "設定已在其他位置變更",
    retry: "重試",
    applyBannerText: "已儲存至 openclaw.json — 請重新啟動 Gateway 以套用。",
    applyBannerAction: "重新啟動並套用",
    rawDiscard: "捨棄",
    rawDraftBlocksApply: "原始設定有未儲存的編輯內容 — 請先在 Raw 編輯器中儲存或捨棄，再重新啟動。",
    rawDraftPendingFormTitle: "原始設定有未儲存的編輯內容 — 請先儲存或捨棄，再切換至 Form。",
    rawDraftBlocksFormEdit:
      "無法解析原始設定中未儲存的編輯內容；請先在 Raw 編輯器中解決問題，再變更設定。",
