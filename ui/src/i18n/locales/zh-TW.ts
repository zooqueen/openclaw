...
export const zh_TW: TranslationMap = {
  ...
  nodes: {
    pairing: {
      button: "配對行動裝置",
      adminRequired: "需要管理員存取權限才能建立設定代碼。",
      title: "OpenClaw 行動版",
      subtitle: "在行動應用程式中掃描此 QR 碼以連接新手機。",
      generating: "正在建立安全設定代碼…",
      failed: "無法建立設定代碼。",
      qrAlt: "OpenClaw 行動版配對 QR 碼",
      qrUnavailable: "QR 碼無法使用。請改為複製設定代碼。",
      copySetupCode: "複製設定代碼",
      newCode: "新代碼",
      showSetupCode: "顯示設定代碼",
      pending: "等待審核的裝置請求：{count}",
      review: "審查",
      waiting: "官方 OpenClaw 行動應用程式會在掃描後自動連接。",
      help: "配對說明",
      manageDevices: "管理裝置",
    },
    binding: {
