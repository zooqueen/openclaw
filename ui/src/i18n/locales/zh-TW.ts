...
export const zh_TW: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      ...
      useCurrentChatAria: "使用目前聊天進行修訂要求",
      useCurrentChatTooltip: "將修訂要求傳送到目前的聊天工作階段，而不是提案的 workshop 工作階段。",
    },
  },
  activity: {
    title: "活動",
  ...
  workboard: {
    ...
    detailNoNotes: "尚無操作員註記。",
    detailNotePlaceholder: "新增決策、阻礙因素或證明註記...",
    detailAddNote: "新增註記",
    openSession: "開啟工作階段",
    ...
    start: "開始",
    dependencies: "相依項目",
    dependenciesReady: "{count} 已就緒",
    dependenciesReadyTitle: "{count} 個相依項目已完成。",
    dependenciesBlocked: "{count} 已封鎖",
    dependenciesBlockedTitle: "正在等待相依項目：{parents}。",
