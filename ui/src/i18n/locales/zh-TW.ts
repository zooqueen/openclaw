...
export const zh_TW: TranslationMap = {
  ...
  subtitles: {
    ...
    about: "Control UI 與已連線 Gateway 的建置識別資訊。",
  ...
  aboutPage: {
    ...
    artifactSubtitle: "建置此瀏覽器產物時嵌入的識別資訊。",
    artifactDetails: "Control UI 建置詳細資料",
    version: "版本",
    commit: "提交",
    built: "建置時間",
    unavailable: "無法取得",
    copyCommit: "複製完整提交雜湊值",
    copyingCommit: "正在複製提交雜湊值",
    copiedCommit: "已複製提交雜湊值",
    copyCommitFailed: "無法複製提交雜湊值",
    gatewayVersion: "已連線 Gateway 版本",
    gatewayVersionHint: "由目前的 Gateway 連線回報；此版本資訊獨立於這個 Control UI 建置。",
  },
  profilePage: {
