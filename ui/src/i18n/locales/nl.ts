...
export const nl: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      adminRequired: "Beheerderstoegang is vereist om instelcodes te maken.",
      title: "OpenClaw mobiel",
      subtitle: "Scan deze QR-code in de mobiele app om een nieuwe telefoon te verbinden.",
      generating: "Een veilige instelcode maken…",
      failed: "Kan geen instelcode maken.",
      qrAlt: "QR-code voor koppelen met OpenClaw mobiel",
      qrUnavailable: "QR niet beschikbaar. Kopieer in plaats daarvan de instelcode.",
      copySetupCode: "Instelcode kopiëren",
      newCode: "Nieuwe code",
      showSetupCode: "Instelcode tonen",
      pending: "Apparaatverzoeken die op beoordeling wachten: {count}",
      review: "Beoordeling",
