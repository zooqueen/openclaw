...
export const nl: TranslationMap = {
  ...
  subtitles: {
    ...
    about: "Buildidentiteit van de Control UI en de verbonden Gateway.",
  ...
  aboutPage: {
    ...
    artifactDetails: "Buildgegevens van de Control UI",
    version: "Versie",
    commit: "Commit-hash",
    built: "Gebouwd",
    unavailable: "Niet beschikbaar",
    copyCommit: "Volledige commit-hash kopiëren",
    copyingCommit: "Commit-hash wordt gekopieerd",
    copiedCommit: "Commit-hash gekopieerd",
    copyCommitFailed: "Commit-hash kon niet worden gekopieerd",
    gatewayVersion: "Versie van de verbonden Gateway",
    gatewayVersionHint:
      "Gerapporteerd door de actieve Gateway-verbinding; staat los van de build van deze Control UI.",
  },
  profilePage: {
