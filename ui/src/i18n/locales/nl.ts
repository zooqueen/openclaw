...
export const nl: TranslationMap = {
  ...
  cockpit: {
    ...
    all: "Alle",
    live: "live",
    noStoredSessions: "Nog geen opgeslagen sessies.",
    runtimeInspector: "Runtime-inspector",
    skills: "Skills",
    cron: "Cron",
    hooks: "Hooks",
    gateway: "Gateway",
    currentOrigin: "huidige oorsprong",
    channels: "kanalen",
    nodes: "nodes",
    runs: "runs",
    manage: "Beheren",
    schedule: "Schema",
    noSkillSnapshot: "Nog geen vaardighedensnapshot.",
    blockedSkills: "{count} vereisen aandacht.",
    automation: "Automatisering",
    cronJobs: "{count} cronjobs",
    nextWake: "volgende wake {time}",
    recentUiEvents: "{count} recente UI-gebeurtenissen",
    skillStateDisabled: "uitgeschakeld",
    skillStateReady: "gereed",
    skillStateNeedsSetup: "moet worden ingesteld",
    timeNow: "nu",
    timeNever: "nooit",
    minutesAgo: "{count}m",
    hoursAgo: "{count}u",
