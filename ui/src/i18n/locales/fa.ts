...
export const fa: TranslationMap = {
  ...
  cockpit: {
    ...
    all: "همه",
    live: "زنده",
    noStoredSessions: "هنوز هیچ نشستی ذخیره نشده است.",
    runtimeInspector: "بازرس زمان اجرا",
    skills: "Skills",
    cron: "Cron",
    hooks: "Hookها",
    gateway: "Gateway",
    currentOrigin: "مبدأ فعلی",
    channels: "کانال‌ها",
    nodes: "گره‌ها",
    runs: "اجراها",
    manage: "مدیریت",
    schedule: "زمان‌بندی",
    noSkillSnapshot: "هنوز هیچ snapshot مهارتی وجود ندارد.",
    blockedSkills: "{count} مورد نیاز به توجه دارد.",
    automation: "اتوماسیون",
    cronJobs: "{count} کار cron",
    nextWake: "بیدارباش بعدی {time}",
    recentUiEvents: "{count} رویداد اخیر UI",
    skillStateDisabled: "غیرفعال",
    skillStateReady: "آماده",
    skillStateNeedsSetup: "نیازمند راه‌اندازی",
    timeNow: "اکنون",
    timeNever: "هرگز",
