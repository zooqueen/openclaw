...
export const fa: TranslationMap = {
  ...
  subtitles: {
    ...
    about: "شناسهٔ ساخت Control UI و Gateway متصل.",
  ...
  aboutPage: {
    ...
    artifactSubtitle: "شناسه‌ای که هنگام ساخت این خروجی مرورگر در آن جاسازی شده است.",
    ...
    copyCommitFailed: "کپی هش کامیت ممکن نشد",
    gatewayVersion: "نسخهٔ Gateway متصل",
    gatewayVersionHint: "از اتصال فعال Gateway گزارش شده است و با این ساخت Control UI تفاوت دارد.",
  },
  profilePage: {
