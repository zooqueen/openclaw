...
export const fa: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "هیچ نشست ذخیره‌شده‌ای از WhatsApp پاک نشد. ممکن است از قبل وجود نداشته باشد یا پوشه احراز هویت آن به پاک‌سازی دستی نیاز داشته باشد.",
    },
  ...
  agentChip: {
    ...
    offlineOpenSettings: "آفلاین — باز کردن تنظیمات",
    switchAgent: "تغییر عامل",
    working: "در حال کار…",
    ready: "آماده گفت‌وگو",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint:
        "JPEG، PNG یا WebP. تصاویر از مرکز برش داده می‌شوند و اندازه آن‌ها به 512px تغییر می‌کند.",
      ...
      avatarTooLarge: "آواتار پردازش‌شده همچنان بیش از حد بزرگ است.",
  ...
  configView: {
    ...
    syncedHint: "از طریق Gateway میان دستگاه‌های شما همگام‌سازی می‌شود.",
    notifications: {
      title: "اعلان‌های Push",
      nativeTitle: "اعلان‌ها",
      hint: "اعلان‌های Push مرورگر را از Gateway خود دریافت کنید.",
      nativeHint: "اعلان‌ها به‌صورت بومی توسط برنامه OpenClaw در این Mac نمایش داده می‌شوند.",
      ...
      nativeBlockedHint:
        "اعلان‌های OpenClaw در macOS غیرفعال هستند. آن‌ها را در تنظیمات سیستم > اعلان‌ها مجاز کنید.",
    },
    appearance: {
      theme: "پوسته",
    ...
    sidebarPrefs: {
      title: "نوار کناری",
      hint: "انتخاب کنید هنگام اجرای نشست‌ها چه مواردی نمایش داده شوند.",
      liveActivity: "نمایش فعالیت زنده عامل در نوار کناری",
      liveActivityHint: "آخرین فعالیت دستیار یا ابزار را زیر نشست‌های در حال اجرا نمایش دهید.",
    },
    connection: {
      title: "اتصال",
      gateway: "Gateway",
  ...
  subtitles: {
    ...
    apps: "برنامه‌های همراه برای تلفن، ساعت، رایانه و مرورگر.",
    ...
    notifications: "اعلان‌های فوری مرورگر از Gateway شما.",
    security: "احراز هویت Gateway، سیاست اجرا، نمایه ابزار و تأییدها.",
    advanced: "همه بخش‌های باقی‌مانده پیکربندی، به‌همراه ویرایشگر فایل خام.",
  ...
  custodian: {
    ...
    history: {
      button: "تاریخچه",
      title: "تغییرات اخیر",
      description: "تغییرات این سیستم، از جدیدترین به قدیمی‌ترین.",
      loading: "در حال بارگیری تغییرات اخیر…",
      empty: "هنوز تغییری ثبت نشده است.",
      requestFailed: "OpenClaw نتوانست تاریخچه تغییرات را بارگیری کند.",
      loadMore: "بارگیری بیشتر",
      loadingMore: "در حال بارگیری موارد بیشتر…",
      changedPaths: "مسیرهای تغییرکرده ({count})",
      invalidEdit: "این ویرایش دستی از اعتبارسنجی پیکربندی عبور نکرد.",
      opaqueChange: "قالب‌بندی یا دیدگاه‌ها بدون تغییر قابل‌مشاهده در مسیرهای پیکربندی تغییر کردند.",
      sources: {
    ...
    nudge: {
      ...
      channelAuth: "احراز هویت {channel} با اختلال مواجه شده است — از من بپرسید چه اتفاقی افتاد",
      channelDisconnected: "اتصال {channel} همین حالا قطع شد — از من بپرسید چه اتفاقی افتاد",
      channelDegraded: "عملکرد {channel} با اختلال مواجه شده است — از من بپرسید چه اتفاقی افتاد",
      channelFallback: "یک کانال",
      dismiss: "نادیده گرفتن این به‌روزرسانی",
    },
  },
  mcpServers: {
    add: "افزودن سرور",
    ...
    missing: "سرور MCP با نام «{name}» در پیکربندی یافت نشد.",
    missingTransport: "انتقال موجود نیست",
    addedSuccess: "سرور MCP با نام {name} اضافه شد.",
    enabledSuccess: "سرور MCP با نام {name} فعال شد.",
    disabledSuccess: "سرور MCP با نام {name} غیرفعال شد.",
    removedSuccess: "سرور MCP با نام {name} حذف شد.",
  ...
  mcpPage: {
    connectorsLink: "اتصال‌دهنده‌های تک‌کلیکی را در صفحه افزونه‌ها پیدا کنید.",
    servers: "سرورها",
    oauth: "OAuth",
    filtered: "فیلترشده",
  ...
  labsPage: {
    intro:
      "آزمایشگاه شامل قابلیت‌های آزمایشی است که ممکن است بین نسخه‌ها تغییر کنند، از کار بیفتند یا ناپدید شوند.",
    sectionTitle: "ویژگی‌های آزمایشی",
    sectionDescription: "تغییرات بلافاصله ذخیره می‌شوند و در اجراهای بعدی عامل اعمال می‌شوند.",
    documentation: "مستندات",
    restartRequired: "راه‌اندازی مجدد Gateway الزامی است.",
    saveErrorTitle: "ویژگی به‌روزرسانی نشد",
    saveFailed: "تنظیمات ویژگی ذخیره نشد.",
    codeMode: {
      title: "حالت کد",
      description:
        "به عامل‌ها اجازه دهید ابزارها را در گردش‌کارهای فشرده و ایزوله‌شده JavaScript ترکیب کنند.",
    },
    swarm: {
      title: "گروه",
  ...
  appsPage: {
    ...
    havePhone: "از قبل اپلیکیشن را دارید؟",
    pairDevice: "دستگاهتان را جفت کنید",
    sectionWatch: "روی مچ شما",
    sectionDesktop: "در رایانه شما",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "مشاهده سریع چت‌ها و ارسال پاسخ‌های کوتاه از روی مچ دست.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "برنامه همراه نوار منو برای Gateway شما — اعلان‌ها، تأییدها و چت سریع.",
      },
      windows: {
        title: "Windows",
      ...
      linux: {
        title: "Linux",
        desc: "برنامه بومی دسکتاپ — نسخه‌های .deb و AppImage.",
      },
      chrome: {
        title: "افزونه Chrome",
  ...
  profilePage: {
    ...
    identity: {
      title: "هویت",
      description: "پروفایل شما در این gateway.",
      loading: "در حال بارگذاری هویت شما…",
      profileUnavailable: "پروفایل هویت شما بارگذاری نشد.",
      avatar: "تصویر پروفایل",
      avatarDescription: "PNG، JPEG یا WebP. اندازه تصاویر به 256 × 256 یا کوچک‌تر تغییر می‌کند.",
      chooseAvatar: "انتخاب تصویر",
      processingAvatar: "در حال پردازش…",
      displayName: "نام نمایشی",
      displayNameDescription: "به سایر افرادی که از این gateway استفاده می‌کنند نشان داده می‌شود.",
      linkedEmails: "ایمیل‌های پیوندشده",
      linkedEmailsDescription: "نشانی‌های ایمیل متصل به این پروفایل.",
      openSettings: "باز کردن تنظیمات هویت برای {name}",
      avatarErrors: {
        invalid: "این تصویر پردازش نشد.",
        sourceTooLarge: "تصویری با حجم 10 MB یا کمتر انتخاب کنید.",
        tooLarge: "حجم تصویر پروفایل پردازش‌شده بیشتر از 512 KB است.",
      },
    },
  },
  tasksPage: {
  ...
  board: {
    label: "داشبورد رشته گفتگو",
    tabsLabel: "زبانه‌های داشبورد",
    moreTabs: "برگه‌های بیشتر داشبورد",
    gridLabel: "ویجت‌های داشبورد",
    emptyTitle: "داشبوردی خلوت و آمادهٔ کار",
    emptyHint:
      "عامل شما می‌تواند ویجت‌ها را اینجا سنجاق کند — از او بخواهید یک کارت وضعیت اضافه کند.",
    ...
    announcement: {
      ...
      resized: "اندازهٔ {title} تغییر کرد.",
    ...
    widget: {
      cellLabel:
        "ویجت داشبورد: {title}. برای پیمایش از کلیدهای جهت‌نما استفاده کنید. برای جابه‌جایی آن، Alt را نگه دارید و یکی از کلیدهای جهت‌نما را فشار دهید.",
      moveHandle: "جابه‌جایی {title}",
      resizeHandle: "تغییر اندازهٔ {title}",
      menuLabel: "گزینه‌های ویجت",
      moveToTab: "انتقال به برگه",
      noOtherTabs: "برگهٔ دیگری وجود ندارد",
      resize: "تغییر اندازه",
      remove: "حذف",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "کپی شد",
      branches: "شاخه‌های رشته گفتگو",
      branchSwitchUnavailable: "تا زمانی که عامل در حال کار است، تغییر شاخه امکان‌پذیر نیست.",
      branchSwitchRequiresAdmin: "تغییر شاخه به دسترسی مدیر اپراتور نیاز دارد.",
    ...
    board: {
      faceLabel: "نمای رشته گفتگو",
      chatFace: "گفتگو",
      dashboardFace: "داشبورد",
      dockMenu: "جایگاه چت: {dock}",
      dockLeft: "قرار دادن چت در چپ",
      dockRight: "قرار دادن چت در راست",
      dockBottom: "قرار دادن چت در پایین",
      dockHidden: "پنهان کردن چت",
      resizeDock: "تغییر اندازه جایگاه چت",
      reopenChat: "نمایش چت",
      defaultTab: "اصلی",
      mockPlaceholder: "نمای برد · {tabs} زبانه · {widgets} ویجت",
      mockOverview: "نمای کلی",
      mockResearch: "پژوهش",
      mockSessionStatus: "وضعیت رشته",
      mockRecentFindings: "یافته‌های اخیر",
      mockSourceMap: "نقشه منابع",
      resetTitle: "گفت‌وگو بازنشانی شود؟",
      resetDescription: "بافت گفت‌وگو بازنشانی می‌شود. داشبورد شما باقی می‌ماند.",
    },
    catalog: {
    ...
    messages: {
      ...
      rewindToHere: "بازگردانی تا اینجا",
      rewindUnavailable: "هنگام کار عامل، بازگردانی در دسترس نیست",
      forkUnavailable: "هنگام کار عامل، انشعاب در دسترس نیست",
    ...
    modelControls: {
      ...
      usingDefault: "استفاده از مقدار پیش‌فرض تنظیمات",
    ...
    composer: {
      ...
      cameraInput: "دوربین",
      cameraListUnsupported: "این مرورگر نمی‌تواند فهرست دوربین‌ها را نمایش دهد.",
      cameraNoneFound: "هیچ دوربینی یافت نشد.",
      cameraPageInactive: "تا زمانی که این صفحه غیرفعال است، دوربین‌ها در دسترس نیستند.",
      ...
      microphoneAppliesNextSession: "تغییرات با شروع نشست بعدی Talk اعمال می‌شوند.",
      ...
      holdToRecordSetting: "برای گفتار به نوشتار، دکمه میکروفون را نگه دارید",
      holdToRecordSettingDescription:
        "دکمه میکروفون کادر نوشتن را نگه دارید، صحبت کنید، سپس آن را رها کنید تا متن بدون ارسال درج شود.",
      dictationAudioUnsupported: "Gateway قالب صوتی پشتیبانی‌نشده‌ای برای گفتار به نوشتار برگرداند.",
      dictationBrowserAudioUnsupported:
        "این مرورگر نمی‌تواند صدای گفتار به نوشتار را با نرخ 8 کیلوهرتز ضبط کند.",
      dictationConnecting: "در حال شروع گفتار به نوشتار…",
      dictationDisconnected: "گفتار به نوشتار به‌دلیل قطع اتصال Gateway متوقف شد.",
      dictationFailed: "گفتار به نوشتار ناموفق بود.",
      dictationFinalizing: "در حال پایان دادن به گفتار به نوشتار…",
    ...
    toolCards: {
      ...
      pinToDashboard: "سنجاق کردن به داشبورد",
    ...
    sessionDiscussion: {
      ...
      unavailable: "این گفت‌وگو را نمی‌توان جاسازی کرد.",
    },
    workspaceFiles: {
