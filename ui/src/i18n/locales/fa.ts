...
export const fa: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      ...
      useCurrentChatTooltip:
        "درخواست‌های بازبینی را به‌جای جلسهٔ کارگاهِ پیشنهاد، به جلسهٔ گفتگوی فعلی ارسال کنید.",
    },
  },
  activity: {
    title: "فعالیت",
  ...
  workboard: {
    ...
    detailTask: "وظیفهٔ Gateway",
    detailRun: "اجرا",
    detailUpdated: "به‌روزرسانی‌شده",
    detailProof: "اثبات",
    detailDiagnostics: "تشخیص‌ها",
    detailWorkerLogs: "گزارش‌های Worker",
    detailWorkerProtocol: "پروتکل Worker",
    detailAutomation: "اتوماسیون",
    detailUpdatedValue: "به‌روزرسانی‌شده: {time}",
    detailAutomationTenant: "مستأجر: {tenant}",
    detailAutomationBoard: "برد: {board}",
    ...
    detailNoNotes: "هنوز یادداشت اپراتور وجود ندارد.",
    detailNotePlaceholder: "یک تصمیم، مانع، یا یادداشت اثبات اضافه کنید...",
