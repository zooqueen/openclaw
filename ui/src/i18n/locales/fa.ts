...
export const fa: TranslationMap = {
  ...
  cron: {
    ...
    runNotStarted: {
      notDue: "هنوز زمان اجرای این خودکارسازی فرا نرسیده است.",
      alreadyRunning: "این خودکارسازی هم‌اکنون در حال اجرا است.",
      recoveryPending: "بازیابی زمان‌بند همچنان در حال انجام است.",
      invalidSpec: "زمان‌بندی یا داده‌های این خودکارسازی نامعتبر است.",
