...
export const fa: TranslationMap = {
  ...
  nodes: {
    pairing: {
      button: "جفت‌سازی دستگاه موبایل",
      adminRequired: "برای ایجاد کدهای راه‌اندازی، دسترسی مدیر لازم است.",
      title: "OpenClaw موبایل",
      subtitle: "برای اتصال یک تلفن جدید، این کد QR را در اپلیکیشن موبایل اسکن کنید.",
      generating: "در حال ایجاد کد راه‌اندازی امن…",
      failed: "امکان ایجاد کد راه‌اندازی وجود نداشت.",
      qrAlt: "کد QR جفت‌سازی OpenClaw موبایل",
      ...
      review: "بازبینی",
      waiting: "اپلیکیشن‌های رسمی OpenClaw موبایل پس از اسکن به‌طور خودکار متصل می‌شوند.",
