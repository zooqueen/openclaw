...
export const fa: TranslationMap = {
  ...
  configView: {
    ...
    autoSaveConflict: "تنظیمات در جای دیگری تغییر کرده‌اند",
    retry: "تلاش مجدد",
    applyBannerText:
      "در openclaw.json ذخیره شد — برای اعمال تغییرات، Gateway را راه‌اندازی مجدد کنید.",
    applyBannerAction: "راه‌اندازی مجدد و اعمال",
    rawDiscard: "نادیده گرفتن",
    rawDraftBlocksApply:
      "ویرایش‌های ذخیره‌نشده پیکربندی خام — پیش از راه‌اندازی مجدد، آن‌ها را در ویرایشگر Raw ذخیره یا لغو کنید.",
    rawDraftPendingFormTitle:
      "ویرایش‌های ذخیره‌نشده پیکربندی خام — پیش از رفتن به Form، آن‌ها را ذخیره یا لغو کنید.",
    rawDraftBlocksFormEdit:
      "ویرایش‌های ذخیره‌نشده پیکربندی خام قابل تجزیه نبودند؛ پیش از تغییر تنظیمات، آن‌ها را در ویرایشگر Raw برطرف کنید.",
