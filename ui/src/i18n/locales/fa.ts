...
export const fa: TranslationMap = {
  ...
  subtitles: {
    ...
    activity: "خلاصه‌های فعالیت ابزار محلیِ مرورگر.",
  ...
  activity: {
    title: "فعالیت",
    subtitle: "فعالیت موقت ابزار که از رویدادهای زندهٔ نشست به دست آمده است.",
    ...
    clear: "پاک کردن",
    empty: "هنوز فعالیت ابزاری وجود ندارد.",
    ...
    argumentsHidden: "{count} آرگومان پنهان شده است",
