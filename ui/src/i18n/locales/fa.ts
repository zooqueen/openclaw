...
export const fa: TranslationMap = {
  ...
  newSession: {
    ...
    folder: "پوشه",
    folderPlaceholder: "فضای کاری عامل",
    worktree: "Worktree",
    worktreeUnavailable: "فضای کاری عامل یک git checkout نیست",
    baseBranch: "شاخه پایه",
    worktreeName: "نام Worktree",
    worktreeNamePlaceholder: "خودکار",
    worktreeNameInvalid: "نام‌های Worktree از حروف کوچک، ارقام و خط تیره استفاده می‌کنند.",
    messagePlaceholder: "این جلسه باید روی چه کاری کار کند؟",
    start: "شروع جلسه",
  ...
  chat: {
    ...
    runControls: {
      ...
      newSessionDisconnected: "برای ایجاد یک جلسهٔ جدید متصل شوید",
