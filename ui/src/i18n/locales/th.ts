...
export const th: TranslationMap = {
  ...
  cockpit: {
    ...
    all: "ทั้งหมด",
    live: "สด",
    noStoredSessions: "ยังไม่มีเซสชันที่จัดเก็บไว้",
    runtimeInspector: "ตัวตรวจสอบรันไทม์",
    skills: "ทักษะ",
    cron: "Cron",
    hooks: "Hooks",
    gateway: "Gateway",
    currentOrigin: "ต้นทางปัจจุบัน",
    channels: "ช่องทาง",
    nodes: "โหนด",
    runs: "การรัน",
    manage: "จัดการ",
    schedule: "กำหนดเวลา",
    noSkillSnapshot: "ยังไม่มีสแนปช็อต Skills",
    blockedSkills: "{count} รายการต้องการการดูแล",
    automation: "ระบบอัตโนมัติ",
    cronJobs: "งาน cron {count} รายการ",
    nextWake: "ปลุกครั้งถัดไป {time}",
    recentUiEvents: "เหตุการณ์ UI ล่าสุด {count} รายการ",
    skillStateDisabled: "ปิดใช้งาน",
    skillStateReady: "พร้อม",
    skillStateNeedsSetup: "ต้องตั้งค่า",
    timeNow: "ตอนนี้",
    timeNever: "ไม่เคย",
