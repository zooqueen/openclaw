...
export const th: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      ...
      useCurrentChatTooltip: "ส่งคำขอแก้ไขไปยังเซสชันแชทปัจจุบันแทนเซสชันเวิร์กช็อปของข้อเสนอ",
    },
  },
  activity: {
    title: "กิจกรรม",
  ...
  workboard: {
    ...
    detailOperatorNotes: "หมายเหตุของผู้ปฏิบัติงาน",
    detailNoNotes: "ยังไม่มีบันทึกของผู้ปฏิบัติงาน",
    detailNotePlaceholder: "เพิ่มบันทึกการตัดสินใจ อุปสรรค หรือหลักฐาน...",
    ...
    open: "Open",
    start: "เริ่ม",
    dependencies: "รายการที่ต้องพึ่งพา",
    dependenciesReady: "พร้อมแล้ว {count} รายการ",
    dependenciesReadyTitle: "รายการที่ต้องพึ่งพา {count} รายการเสร็จแล้ว",
    dependenciesBlocked: "ถูกบล็อก {count} รายการ",
    dependenciesBlockedTitle: "กำลังรอรายการที่ต้องพึ่งพา: {parents}",
    dependencyMissing: "{parent} (ขาดหาย)",
    dependencyStatusMissing: "ขาดหาย",
