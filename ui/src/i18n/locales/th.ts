...
export const th: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      adminRequired: "ต้องมีสิทธิ์ผู้ดูแลระบบเพื่อสร้างรหัสตั้งค่า",
      title: "OpenClaw mobile",
      subtitle: "สแกนรหัส QR นี้ในแอปมือถือเพื่อเชื่อมต่อโทรศัพท์เครื่องใหม่",
      generating: "กำลังสร้างรหัสตั้งค่าที่ปลอดภัย…",
      failed: "ไม่สามารถสร้างรหัสตั้งค่าได้",
      qrAlt: "รหัส QR สำหรับจับคู่ OpenClaw mobile",
      qrUnavailable: "QR ไม่พร้อมใช้งาน คัดลอกรหัสตั้งค่าแทน",
      copySetupCode: "คัดลอกรหัสตั้งค่า",
      newCode: "รหัสใหม่",
      showSetupCode: "แสดงรหัสตั้งค่า",
      pending: "คำขออุปกรณ์ที่รอการตรวจสอบ: {count}",
      review: "ตรวจทาน",
      waiting: "แอปมือถือ OpenClaw อย่างเป็นทางการจะเชื่อมต่อโดยอัตโนมัติหลังจากสแกน",
