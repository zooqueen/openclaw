...
export const th: TranslationMap = {
  ...
  configView: {
    ...
    autoSaveConflict: "มีการเปลี่ยนแปลงการตั้งค่าจากที่อื่น",
    retry: "ลองอีกครั้ง",
    applyBannerText: "บันทึกลงใน openclaw.json แล้ว — รีสตาร์ท Gateway เพื่อปรับใช้",
    applyBannerAction: "รีสตาร์ทและปรับใช้",
    rawDiscard: "ละทิ้ง",
    rawDraftBlocksApply:
      "มีการแก้ไขการกำหนดค่าแบบ Raw ที่ยังไม่ได้บันทึก — บันทึกหรือละทิ้งการแก้ไขเหล่านั้นในตัวแก้ไข Raw ก่อนรีสตาร์ท",
    rawDraftPendingFormTitle:
      "มีการแก้ไขการกำหนดค่าแบบ Raw ที่ยังไม่ได้บันทึก — บันทึกหรือละทิ้งการแก้ไขเหล่านั้นก่อนสลับไปยัง Form",
    rawDraftBlocksFormEdit:
      "ไม่สามารถแยกวิเคราะห์การแก้ไขการกำหนดค่าแบบ Raw ที่ยังไม่ได้บันทึกได้ โปรดแก้ไขในตัวแก้ไข Raw ก่อนเปลี่ยนการตั้งค่า",
