...
export const th: TranslationMap = {
  ...
  subtitles: {
    ...
    about: "ข้อมูลระบุบิลด์ของ Control UI และ Gateway ที่เชื่อมต่ออยู่",
  ...
  aboutPage: {
    ...
    artifactSubtitle: "ข้อมูลระบุที่ฝังไว้ขณะบิลด์อาร์ติแฟกต์ของเบราว์เซอร์นี้",
    ...
    gatewayVersion: "เวอร์ชัน Gateway ที่เชื่อมต่ออยู่",
    gatewayVersionHint: "รายงานโดยการเชื่อมต่อ Gateway ที่ใช้งานอยู่ และแยกจากบิลด์ Control UI นี้",
  },
  profilePage: {
