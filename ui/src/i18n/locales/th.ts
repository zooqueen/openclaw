...
export const th: TranslationMap = {
  ...
  skillWorkshop: {
    viewSwitcher: {
      label: "มุมมอง Workshop",
      boardTitle: "มุมมองบอร์ด",
      board: "บอร์ด",
      todayTitle: "มุมมองวันนี้",
      today: "วันนี้",
    },
  },
  activity: {
  ...
  workboard: {
    ...
    detailOperatorNotes: "บันทึกของผู้ปฏิบัติงาน",
    detailNoNotes: "ยังไม่มีบันทึกของผู้ปฏิบัติงาน",
    detailNotePlaceholder: "เพิ่มบันทึกเกี่ยวกับการตัดสินใจ อุปสรรค หรือหลักฐาน...",
