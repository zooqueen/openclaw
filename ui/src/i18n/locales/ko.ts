...
export const ko: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      ...
      useCurrentChatTooltip: "제안의 워크숍 세션 대신 현재 채팅 세션으로 수정 요청을 보냅니다.",
    },
  },
  activity: {
    title: "활동",
  ...
  workboard: {
    ...
    detailWorkerLogs: "Worker 로그",
    detailWorkerProtocol: "Worker 프로토콜",
    ...
    detailNotePlaceholder: "결정 사항, 차단 요인 또는 증빙 메모 추가...",
    detailAddNote: "메모 추가",
    openSession: "세션 열기",
    ...
    dependencyMissing: "{parent}(누락됨)",
    dependencyStatusMissing: "누락됨",
