...
export const ko: TranslationMap = {
  ...
  cockpit: {
    ...
    all: "전체",
    live: "실시간",
    noStoredSessions: "아직 저장된 세션이 없습니다.",
    runtimeInspector: "런타임 검사기",
    skills: "Skills",
    cron: "Cron",
    hooks: "Hooks",
    gateway: "Gateway",
    ...
    manage: "관리",
    schedule: "일정",
    noSkillSnapshot: "아직 Skills 스냅샷이 없습니다.",
    blockedSkills: "{count}개 항목에 주의가 필요합니다.",
    automation: "자동화",
    cronJobs: "{count}개 cron 작업",
    nextWake: "다음 깨우기 {time}",
    recentUiEvents: "최근 UI 이벤트 {count}개",
    skillStateDisabled: "사용 안 함",
    skillStateReady: "준비됨",
    skillStateNeedsSetup: "설정 필요",
    timeNow: "지금",
    timeNever: "없음",
    minutesAgo: "{count}분",
    hoursAgo: "{count}시간",
