...
export const ko: TranslationMap = {
  ...
  dreaming: {
    ...
    advanced: {
      ...
      title: "일일 로그 다시 보기",
      description:
        "일일 로그에서 다시 재생된 내용, 승격을 기다리는 항목, 그리고 이미 통과한 항목을 확인하세요.",
      summaryFromDailyLog: "일일 로그에서",
      summaryWaiting: "대기 중",
      summaryPromotedToday: "오늘 승격됨",
      stagedTitle: "일일 로그에서",
      stagedDescription: "이전 일일 로그 항목에서 가져온 다시 보기 후보입니다.",
      shortTermTitle: "승격 대기 중",
      shortTermDescription: "실제 메모리로 승격되기를 기다리는 현재 단기 후보입니다.",
      sortRecent: "최신순",
      sortSignals: "가장 강한 지원",
      originDailyLog: "다시 재생됨",
      originLive: "실시간",
      originMixed: "혼합",
      promotedTitle: "최근 승격",
      promotedDescription: "최근에 이미 승격을 통과한 항목입니다.",
      emptyGrounded: "현재 준비된 grounded 다시 보기 항목이 없습니다.",
