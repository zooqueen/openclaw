...
export const ko: TranslationMap = {
  ...
  subtitles: {
    ...
    about: "Control UI 및 연결된 Gateway의 빌드 식별 정보입니다.",
  ...
  aboutPage: {
    ...
    artifactSubtitle: "이 브라우저 아티팩트가 빌드될 때 포함된 식별 정보입니다.",
    ...
    copiedCommit: "커밋 해시를 복사했습니다",
    copyCommitFailed: "커밋 해시를 복사할 수 없습니다",
    gatewayVersion: "연결된 Gateway 버전",
    gatewayVersionHint: "활성 Gateway 연결에서 보고한 버전이며, 이 Control UI 빌드와는 별개입니다.",
  },
  profilePage: {
