...
export const ko: TranslationMap = {
  ...
  configView: {
    ...
    retry: "다시 시도",
    applyBannerText: "openclaw.json에 저장됨 — 적용하려면 Gateway를 다시 시작하세요.",
    applyBannerAction: "다시 시작 및 적용",
    rawDiscard: "변경 사항 버리기",
    rawDraftBlocksApply:
      "저장되지 않은 원시 구성 편집 내용이 있습니다 — 다시 시작하기 전에 Raw 편집기에서 저장하거나 삭제하세요.",
    rawDraftPendingFormTitle:
      "저장되지 않은 원시 구성 편집 내용이 있습니다 — Form으로 전환하기 전에 저장하거나 삭제하세요.",
    rawDraftBlocksFormEdit:
      "저장되지 않은 원시 구성 편집 내용을 구문 분석할 수 없습니다. 설정을 변경하기 전에 Raw 편집기에서 문제를 해결하세요.",
