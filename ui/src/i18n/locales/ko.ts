...
export const ko: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "로그아웃되었습니다.",
      logoutNotCleared:
        "저장된 WhatsApp 세션이 삭제되지 않았습니다. 이미 존재하지 않거나 인증 디렉터리를 수동으로 정리해야 할 수 있습니다.",
    },
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "클라우드 워커에는 OpenClaw 런타임이 필요합니다. 현재 {runtime}이(가) 선택되어 있습니다.",
  ...
  sessionsView: {
    ...
    sessionArchived: "스레드가 보관되었습니다",
    sessionsArchived: "{count}개 스레드가 보관되었습니다",
    deleteAllArchived: "보관된 항목 모두 삭제…",
    deleteAllArchivedConfirm: "보관된 스레드 {count}개와 해당 기록을 삭제하시겠습니까?",
    ...
    attentionRequired: "세션에 확인이 필요합니다",
    model: "모델",
    provider: "제공업체",
    runtime: "런타임",
    runDuration: "실행 시간",
    ...
    changeIcon: "아이콘 변경",
    customEmoji: "사용자 지정 이모지",
    invalidEmojiIcon: "이모지 하나만 입력하세요.",
    removeIcon: "아이콘 제거",
  ...
  quickSettings: {
    ...
    personal: {
      ...
      uploading: "처리 중…",
      profileHint:
        "JPEG, PNG 또는 WebP. 이미지는 중앙을 기준으로 잘라내고 512px로 크기가 조정됩니다.",
  ...
  configView: {
    ...
    syncedHint: "Gateway를 통해 기기 간에 동기화됩니다.",
    notifications: {
      title: "푸시 알림",
      nativeTitle: "알림",
      hint: "Gateway에서 브라우저 푸시 알림을 받습니다.",
      nativeHint: "이 Mac의 OpenClaw 앱에서 알림을 기본 방식으로 표시합니다.",
    ...
    sidebarPrefs: {
      title: "사이드바",
      hint: "세션이 실행되는 동안 표시할 항목을 선택하세요.",
  ...
  nav: {
    ...
    settings: "설정",
    settingsGeneral: "일반",
    askOpenClaw: "OpenClaw에 질문하기",
    settingsGroupConnections: "연결",
    settingsGroupAgents: "에이전트 및 도구",
    settingsGroupSecurity: "개인정보 보호 및 보안",
  ...
  subtitles: {
    ...
    apps: "휴대폰, 시계, 데스크톱 및 브라우저용 연동 앱입니다.",
    ...
    security: "Gateway 인증, 실행 정책, 도구 프로필 및 승인.",
    advanced: "나머지 모든 구성 섹션과 원시 파일 편집기.",
    debug: "스냅샷, 이벤트, RPC.",
    logs: "실시간 Gateway 로그.",
  ...
  custodian: {
    title: "OpenClaw",
    subtitle: "시스템 설정 가이드",
    subtitleCaretaker: "시스템 설정 및 관리입니다.",
    exitSetup: "설정 종료",
    newAgent: "새 에이전트",
    hatchDraft: "일어나, 친구야!",
    placeholder: "OpenClaw에 메시지 보내기…",
    sensitivePlaceholder: "민감한 값 입력…",
    sensitiveReply: "민감한 답변을 보냈습니다",
    send: "보내기",
    ...
    history: {
      button: "기록",
      title: "최근 변경 사항",
      description: "이 시스템에서 변경된 내용을 최신순으로 표시합니다.",
      loading: "최근 변경 사항을 불러오는 중…",
      empty: "아직 기록된 변경 사항이 없습니다.",
      requestFailed: "OpenClaw에서 변경 내역을 불러오지 못했습니다.",
      loadMore: "더 보기",
      loadingMore: "더 불러오는 중…",
      changedPaths: "변경된 경로 ({count})",
      invalidEdit: "이 수동 편집은 구성 유효성 검사를 통과하지 못했습니다.",
      opaqueChange: "표시되는 구성 경로 변경 없이 서식 또는 주석이 변경되었습니다.",
      sources: {
  ...
  mcpServers: {
    ...
    nameTaken: "“{name}”이라는 이름의 MCP 서버가 이미 존재합니다.",
    ...
    configUnavailable: "구성을 사용할 수 없습니다. 새로 고친 후 다시 시도하세요.",
    connectRequired: "MCP 서버를 변경하려면 Gateway에 연결하세요.",
    adminRequired: "MCP 서버를 변경하려면 operator.admin 액세스 권한이 필요합니다.",
    enable: "활성화",
    disable: "비활성화",
    removeNamed: "{name} 제거",
    working: "작업 중…",
  ...
  mcpPage: {
    connectorsLink: "Plugins 페이지에서 원클릭 커넥터를 찾아보세요.",
    servers: "서버",
    oauth: "OAuth",
    filtered: "필터링됨",
  ...
  labsPage: {
    intro:
      "Labs에는 릴리스 간에 변경되거나, 제대로 작동하지 않거나, 사라질 수 있는 실험적 기능이 포함되어 있습니다.",
    sectionTitle: "실험적 기능",
    sectionDescription: "변경 사항은 즉시 저장되며 이후 에이전트 실행부터 적용됩니다.",
    documentation: "문서",
    restartRequired: "Gateway를 다시 시작해야 합니다.",
    saveErrorTitle: "기능을 업데이트할 수 없음",
    saveFailed: "기능 설정을 저장할 수 없습니다.",
    codeMode: {
      title: "Code Mode",
      description:
        "에이전트가 간결하고 샌드박스 처리된 JavaScript 워크플로에서 도구를 조합할 수 있도록 합니다.",
    },
    swarm: {
      title: "스웜",
  ...
  appsPage: {
    heroTitle: "어디서든 OpenClaw를 사용하세요",
    heroTagline:
      "휴대폰, 시계, 데스크톱 및 브라우저용 컴패니언 앱과 에이전트의 기능을 확장하는 플러그인.",
    sectionMobile: "휴대폰에서",
    ...
    badgeBundledIos: "iOS 앱에 포함",
    badgeBundledAndroid: "Android 앱에 포함",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Android 휴대폰을 채팅, 카메라, Canvas를 지원하는 완전한 OpenClaw 노드로 활용하세요.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "손목에서 채팅을 한눈에 확인하고 빠르게 답장하세요.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Android 컴패니언 앱으로 시계에서도 OpenClaw를 사용할 수 있습니다.",
      },
      macos: {
        title: "macOS",
        desc: "Gateway를 위한 메뉴 막대 도우미 — 알림, 승인, 빠른 채팅.",
      },
      windows: {
        title: "Windows",
        desc: "Windows 도우미는 PC를 OpenClaw 노드로 연결합니다.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "OpenClaw가 기존 Chrome의 탭, 페이지, 양식을 제어할 수 있게 합니다.",
      },
      plugins: {
        title: "플러그인 및 ClawHub",
        desc: "커뮤니티의 채널, 도구, 스킬로 OpenClaw를 확장하세요.",
      },
    },
  },
  presence: {
    rosterLabel: "온라인 사용자 표시",
    rosterTitle: "온라인",
    you: "나",
  },
  profilePage: {
    ...
    identity: {
      title: "ID",
      description: "이 Gateway의 프로필입니다.",
      loading: "ID를 불러오는 중…",
      profileUnavailable: "ID 프로필을 불러올 수 없습니다.",
      avatar: "아바타",
      avatarDescription: "PNG, JPEG 또는 WebP. 이미지는 256 × 256 이하로 크기가 조정됩니다.",
      chooseAvatar: "이미지 선택",
      processingAvatar: "처리 중…",
      displayName: "표시 이름",
      displayNameDescription: "이 Gateway를 사용하는 다른 사람에게 표시됩니다.",
  ...
  board: {
    label: "스레드 대시보드",
    tabsLabel: "대시보드 탭",
    moreTabs: "더 많은 대시보드 탭",
    gridLabel: "대시보드 위젯",
    emptyTitle: "작업할 준비가 된 깔끔한 보드",
    emptyHint: "에이전트가 여기에 위젯을 고정할 수 있습니다. 상태 카드를 요청해 보세요.",
    actionFailed: "대시보드 변경 사항을 저장할 수 없습니다.",
    actionInProgress: "다른 대시보드 변경 사항을 아직 저장하고 있습니다.",
    announcement: {
      moved: "{title}을(를) 이동했습니다.",
      resized: "{title}의 크기를 조정했습니다.",
      removed: "{title}을(를) 제거했습니다.",
      granted: "위젯 접근을 허용했습니다.",
      rejected: "위젯 접근을 거부했습니다.",
    },
    widget: {
      cellLabel:
        "대시보드 위젯: {title}. 화살표 키로 탐색하세요. Alt 키를 누른 상태에서 화살표 키를 눌러 이동하세요.",
      moveHandle: "{title} 이동",
      ...
      actionErrorDetail: "대시보드에서 이전 위젯 상태를 유지했습니다.",
      errorShow: "세부 정보 표시",
      kindMcp: "MCP",
      kindHtml: "HTML",
    },
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "분기를 전환하려면 운영자 관리자 액세스 권한이 필요합니다.",
    ...
    board: {
      ...
      dockMenu: "채팅 도킹: {dock}",
      dockLeft: "채팅을 왼쪽에 도킹",
      dockRight: "채팅을 오른쪽에 도킹",
      dockBottom: "채팅을 아래쪽에 도킹",
      dockHidden: "채팅 숨기기",
      resizeDock: "채팅 도킹 영역 크기 조절",
      reopenChat: "채팅 표시",
      defaultTab: "메인",
      mockPlaceholder: "보드 보기 구분선 · 탭 {tabs}개 · 위젯 {widgets}개",
      mockOverview: "개요",
      mockResearch: "조사",
      mockSessionStatus: "스레드 상태",
      mockRecentFindings: "최근 조사 결과",
      mockSourceMap: "소스 맵",
      resetTitle: "대화를 초기화하시겠습니까?",
    ...
    questions: {
      ...
      timeRemaining: "남은 시간",
      ownAnswer: "직접 답변 입력…",
      ownAnswerFor: "{header}에 직접 답변 입력",
      submitting: "제출 중…",
    ...
    messages: {
      activity: "활동",
      forkFromHere: "여기에서 분기",
      hide: "숨기기",
      hideConfirm: "이 브라우저에서 이 메시지를 숨기시겠습니까? 에이전트는 계속 볼 수 있습니다.",
      hideMessage: "메시지 숨기기",
      hideTooltip: "이 브라우저에서만 숨기기",
      openInCanvas: "캔버스에서 열기",
      rewind: "되돌리기",
      rewindConfirm: "이 메시지 이전으로 되돌리시겠습니까?",
      rewindToHere: "여기까지 되돌리기",
      rewindUnavailable: "에이전트가 작업 중인 동안에는 되돌릴 수 없습니다",
      forkUnavailable: "에이전트가 작업 중인 동안에는 분기할 수 없습니다",
    ...
    composer: {
      ...
      cameraInput: "카메라",
      cameraListUnsupported: "이 브라우저에서는 카메라 목록을 표시할 수 없습니다.",
      ...
      holdToRecordSetting: "마이크 버튼을 길게 눌러 받아쓰기",
      holdToRecordSettingDescription:
        "작성창의 마이크 버튼을 길게 누르고 말한 다음, 버튼에서 손을 떼면 전송하지 않고 텍스트가 입력됩니다.",
      dictationAudioUnsupported: "Gateway에서 지원되지 않는 받아쓰기 오디오 형식을 반환했습니다.",
      dictationBrowserAudioUnsupported:
        "이 브라우저에서는 8 kHz로 받아쓰기 오디오를 캡처할 수 없습니다.",
      ...
      dictationFinalizationTimedOut:
        "마지막 부분 음성 기록이 완료되기 전에 받아쓰기가 중지되었습니다.",
      dictationProviderUnavailable: "받아쓰기에 사용할 음성 기록 제공자가 구성되어 있지 않습니다.",
      dictationRecording: "녹음 중 {elapsed}",
      dictationReleaseToInsert: "놓아서 받아쓰기 삽입",
