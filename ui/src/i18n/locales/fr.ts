...
export const fr: TranslationMap = {
  ...
  cockpit: {
    ...
    all: "Tous",
    live: "en direct",
    noStoredSessions: "Aucune session enregistrée pour le moment.",
    runtimeInspector: "Inspecteur d’exécution",
    skills: "Skills",
    cron: "Cron",
    hooks: "Hooks",
    gateway: "Gateway",
    ...
    noSkillSnapshot: "Aucun instantané de skill pour le moment.",
    blockedSkills: "{count} nécessitent une attention.",
    automation: "Automatisation",
    cronJobs: "{count} tâches cron",
    nextWake: "prochain réveil {time}",
    recentUiEvents: "{count} événements d’interface récents",
    skillStateDisabled: "désactivée",
    skillStateReady: "prêt",
    skillStateNeedsSetup: "configuration requise",
    timeNow: "maintenant",
    timeNever: "jamais",
