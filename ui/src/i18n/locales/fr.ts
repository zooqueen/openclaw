...
export const fr: TranslationMap = {
  ...
  subtitles: {
    ...
    about: "Identité de compilation de Control UI et du Gateway connecté.",
  ...
  aboutPage: {
    ...
    artifactSubtitle: "Identité intégrée lors de la compilation de cet artefact de navigateur.",
    artifactDetails: "Détails de compilation de Control UI",
    version: "Version",
    commit: "Commit",
    built: "Compilation",
    unavailable: "Indisponible",
    copyCommit: "Copier le hash complet du commit",
    copyingCommit: "Copie du hash du commit en cours",
    ...
    gatewayVersionHint:
      "Indiquée par la connexion active au Gateway; distincte de cette compilation de Control UI.",
  },
  profilePage: {
