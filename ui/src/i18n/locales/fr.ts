...
export const fr: TranslationMap = {
  ...
  dreaming: {
    ...
    advanced: {
      eyebrow: "Vérifier",
      title: "Relecture du journal quotidien",
      description:
        "Voyez ce qui a été relu depuis le journal quotidien, ce qui attend une promotion et ce qui a déjà été validé.",
      summaryFromDailyLog: "depuis le journal quotidien",
      summaryWaiting: "en attente",
      summaryPromotedToday: "promu aujourd’hui",
      stagedTitle: "Depuis le journal quotidien",
      stagedDescription:
        "Candidats à la relecture extraits d’anciennes entrées du journal quotidien.",
      shortTermTitle: "En attente de promotion",
      shortTermDescription:
        "Candidats actuels à court terme en attente de passer en mémoire réelle.",
      sortRecent: "Les plus récents",
      sortSignals: "Soutien le plus fort",
      originDailyLog: "relu",
      originLive: "en direct",
      originMixed: "mixte",
      promotedTitle: "Promotions récentes",
      promotedDescription: "Éléments qui sont récemment passés par la promotion.",
