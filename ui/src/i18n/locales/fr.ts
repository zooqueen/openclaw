...
export const fr: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      ...
      useCurrentChatTooltip:
        "Envoyer les demandes de révision à la session de discussion actuelle au lieu de la session d’atelier de la proposition.",
    },
  },
  activity: {
    title: "Activité",
  ...
  workboard: {
    ...
    dependenciesBlockedTitle: "En attente des dépendances : {parents}.",
