...
export const ru: TranslationMap = {
  ...
  subtitles: {
    ...
    about: "Идентификаторы сборки Control UI и подключённого Gateway.",
  ...
  aboutPage: {
    ...
    artifactSubtitle: "Идентификатор, встроенный при сборке этого браузерного артефакта.",
    ...
    gatewayVersion: "Версия подключённого Gateway",
    gatewayVersionHint:
      "Эту версию сообщает активное подключение к Gateway; она не относится к сборке Control UI.",
  },
  profilePage: {
