...
function buildDockerE2eHarnessEntries(): Record<string, string> {
  return {
    ...
    "config/sessions/archive-compression": "src/config/sessions/archive-compression.ts",
    "config/sessions/session-accessor": "src/config/sessions/session-accessor.ts",
    "config/sessions/session-accessor.sqlite": "src/config/sessions/session-accessor.sqlite.ts",
    ...
    "gateway/test-helpers.e2e": "src/gateway/test-helpers.e2e.ts",
