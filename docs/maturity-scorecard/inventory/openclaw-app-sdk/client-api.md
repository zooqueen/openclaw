---
title: "OpenClaw App SDK - Client API Maturity Note"
version: 3
last_refreshed: 2026-06-01
last_refreshed_by: codex
---

# OpenClaw App SDK - Client API Maturity Note

## Summary

Docs and API design describe the client shape, exports, event helpers, and package use. Source exposes typed client API and high-level helpers. E2E and package-consumer tests exercise SDK import and client calls.

## Category Scope

This category covers the taxonomy-defined Client API capability area for the OpenClaw App SDK surface.

## Features

- SDK entrypoints: Public package imports and helper objects for external apps.
- Namespace layout: High-level and low-level namespaces such as agents and sessions.
- Package split: Core SDK, React helpers, and testing package boundaries.
- App/plugin boundary: Clear distinction between external app integrations and in-process plugin authoring.
...
- Score: `Stable (86%)`
- Positive signals: Docs and API design describe the client shape, exports, event helpers, and package use; Source exposes typed client API and high-level helpers; E2E and package-consumer tests exercise SDK import and client calls.
- Negative signals: Package remains private/0.0.0-private; Some designed convenience layers are not yet implemented.
- Integration gaps: Package remains private/0.0.0-private; Some designed convenience layers are not yet implemented.
...
- Good qualities: Docs and API design describe the client shape, exports, event helpers, and package use; Source exposes typed client API and high-level helpers.
- Bad qualities: Package remains private/0.0.0-private; Some designed convenience layers are not yet implemented.
...
- Positive signals: archived docs, source, test, Gitcrawl, and Discrawl evidence cover the taxonomy scope for SDK entrypoints, Namespace layout, Package split, App/plugin boundary.
- Negative signals: Package remains private/0.0.0-private; Some designed convenience layers are not yet implemented.
- Missing capability branches: Package remains private/0.0.0-private; Some designed convenience layers are not yet implemented.
...
- Package remains private/0.0.0-private.
- Some designed convenience layers are not yet implemented.
