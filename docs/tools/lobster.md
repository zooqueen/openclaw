...
Lobster is one authoring layer above [TaskFlow](/automation/taskflow). Lobster can decide step logic, but TaskFlow still owns the job identity, owner context, and how detached work returns to the original conversation.
