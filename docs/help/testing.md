...
<AccordionGroup>
  <Accordion title="Projects, shards, and scoped lanes">
    ...
    - Live Docker ACP harness edits run a focused local gate: shell syntax for the live Docker auth scripts, live Docker scheduler dry-run, ACP bind unit tests, and the ACPX extension tests. They do not trigger the full Vitest matrix unless the diff also touches a root/global surface such as dependencies or shared Vitest setup.
