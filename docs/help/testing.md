...
parallel jobs. Scheduled QA and release checks run the Matrix release
...
parity plus the Matrix live-adapter profile and Telegram lane before release approval. Release
