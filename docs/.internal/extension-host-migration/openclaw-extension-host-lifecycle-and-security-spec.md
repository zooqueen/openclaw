...
- broader embedding- and media-runtime execution and fallback ownership, plus remaining TTS config/status and facade cleanup, including explicit fallback and override policy instead of plugin-era capability reads
...
7. Finish broader embedding- and media-runtime execution and fallback ownership, plus remaining TTS config/status and facade cleanup, instead of widening `registerProvider(...)`.
