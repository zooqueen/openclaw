...
- ACP backend registration and runtime resolution now route through `src/extension-host/contributions/acp-runtime-backend-registry.ts` while `src/acp/runtime/registry.ts` remains the compatibility facade
