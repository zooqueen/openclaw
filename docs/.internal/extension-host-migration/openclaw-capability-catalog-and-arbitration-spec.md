...
- remaining embedding index-file execution ownership, remaining media compatibility-facade cleanup, plus remaining TTS facade cleanup, should become runtime-internal subsystem registries rather than remaining part of a universal plugin-provider API
...
9. Finish remaining embedding index-file execution ownership, remaining media compatibility-facade cleanup, plus remaining TTS facade cleanup, with explicit capability routing and built-in fallback policy.
