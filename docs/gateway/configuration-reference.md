...
- **Legacy bind aliases**: host aliases in `gateway.bind` (`0.0.0.0`, `127.0.0.1`, `localhost`, `::`, `::1`) are auto-migrated to bind modes (`lan`/`loopback`) during startup and `openclaw doctor`.
