...
| `blacksmith-8vcpu-ubuntu-2404`   | `security-scm-fast`, `security-dependency-audit`, `build-artifacts`, Linux checks, long-matrix aggregate verifiers, docs checks, Python skills, `android`                                                                      |
