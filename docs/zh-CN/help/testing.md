...
- OpenAI（非 Codex）：`openai/gpt-5.4`（可选：`openai/gpt-5.1`）
- OpenAI Codex：`openai-codex/gpt-5.4`（可选：`openai-codex/gpt-5.4-codex`）
...
`OPENCLAW_LIVE_GATEWAY_MODELS="openai/gpt-5.4,openai-codex/gpt-5.4,anthropic/claude-opus-4-6,google/gemini-3-pro-preview,google/gemini-3-flash-preview,google-antigravity/claude-opus-4-6-thinking,google-antigravity/gemini-3-flash,zai/glm-4.7,minimax/minimax-m2.1" pnpm test:live src/gateway/gateway-models.profiles.live.test.ts`
