...
- **[computer-use](/plugins/reference/computer-use)** (`@openclaw/plugin-computer-use`) - included in OpenClaw. Control a paired macOS node through screenshots and single computer input actions.
