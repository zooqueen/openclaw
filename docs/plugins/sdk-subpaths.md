...
<AccordionGroup>
  ...
  <Accordion title="Provider subpaths">
    ...
    | `plugin-sdk/embedding-providers` | General embedding provider registry types and helpers, including `EmbeddingProviderAdapter`, `registerEmbeddingProvider(...)`, `getEmbeddingProvider(...)`, and list/restore/reset helpers |
