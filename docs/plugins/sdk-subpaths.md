...
usage endpoint failed or returned no usable usage data.
  ...
  <Accordion title="Runtime and storage subpaths">
    ...
    | `plugin-sdk/session-store-runtime` | Session-store helpers, scoped lifecycle repair helpers, and transitional SQLite marker helpers without broad config writes/maintenance imports |
