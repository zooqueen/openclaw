...
- Gateway/install: treat state-dir `.env` password vars as durable install auth inputs so token inference stays aligned with the service environment during gateway install and onboarding. (#52492) Thanks @Chevron7Locked.
