...
- Feishu/Lark bundled installs: restore `@larksuiteoapi/node-sdk` at the root package level so npm/global installs can still resolve the bundled Feishu channel runtime. (#39814) Thanks @ayanesakura.
