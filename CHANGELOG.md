...
- Telegram: default `replyToMode` to `off` so DM replies no longer auto-quote every message; opt back in with `replyToMode="first"` or `"all"`. (#16034) Thanks @pejmanjohn.
