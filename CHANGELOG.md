...
- Providers/Ollama: resolve `createStreamFn` against the active provider id so multi-provider setups such as `ollama2/...` stop reusing the default Ollama `baseUrl`. (#61776) Thanks @zozo123.
