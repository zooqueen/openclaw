...
- Memory/search: keep trigram-backed CJK memory search working for 1-2 character Chinese, Japanese, and Korean queries by combining FTS matches with substring fallback filters. (#41810) Thanks @carrotRakko.
