...
- Exec/tool timeout UX: include actionable retry guidance (`exec timeout=300`) in overall-timeout error messages, and document longer timeout usage in the OpenAI image generation skill guide. (#32401) Thanks @AaronWander.
