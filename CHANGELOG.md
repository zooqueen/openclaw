...
- Slack/AI Assistant channel context: add assistant thread-start/context-change event handling, suggested prompts, and optional channel-aware context injection for assistant threads via `channels.slack.assistant.channelContext` and `channels.slack.assistant.channelContextMessageLimit`. (#9985)
