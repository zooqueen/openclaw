...
- Security/Config: block prototype-key merges in `mergeConfigSection` and reuse the shared prototype-key guard so config section patch merges cannot pollute object prototypes. (#23008) Thanks @Clawborn.
