...
- Gateway/connect challenge: align the client's default connect-challenge timeout with the shared gateway handshake default so slow local loopback connects stop failing early on the client side. (#53909) Thanks @dobbylorenzbot.
