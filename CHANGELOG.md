...
- Gateway/sessions: require local-direct authorization for `POST /sessions/:sessionKey/kill` so bearer-auth HTTP callers cannot stop another session by supplying a requester header. Thanks @LucifielHack and @vincentkoc.
