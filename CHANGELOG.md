...
- Slack/native streaming Markdown rendering: remove pre-normalization from the native `markdown_text` streaming path (`start/append/stop`) so Markdown content is not double-converted before Slack rendering. (synthesis from #34931, #34759, #34716, #34682, #34814) Thanks @littleben, @dunamismax, @Octane0411, @carrotRakko, and @RealKai42.
