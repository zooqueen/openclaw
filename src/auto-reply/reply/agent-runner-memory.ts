...
export async function runPreflightCompactionIfNeeded(params: {
  ...
  try {
    ...
    const result = await deps.compactEmbeddedAgentSession({
      ...
      memberRoleIds: params.followupRun.run.memberRoleIds,
      senderIsOwner: params.followupRun.run.senderIsOwner,
      isAuthorizedSender: params.followupRun.run.isAuthorizedSender,
      turnAuthority: params.followupRun.run.turnAuthority,
      sessionFile,
