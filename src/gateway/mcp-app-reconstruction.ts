...
function matchesLookup(
  ...
  return (
    readString(rawDescriptor, "serverName") === lookup.descriptor.serverName &&
    readString(rawDescriptor, "toolName") === lookup.descriptor.toolName &&
    readString(rawDescriptor, "uiResourceUri") === lookup.descriptor.uiResourceUri &&
    readString(rawDescriptor, "toolCallId") === lookup.descriptor.toolCallId
  );
}
