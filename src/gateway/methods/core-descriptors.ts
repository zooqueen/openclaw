...
export const CORE_GATEWAY_METHOD_SPECS: readonly CoreGatewayMethodSpec[] = [
  ...
  { name: "routines.list", scope: "operator.read" },
  { name: "routines.get", scope: "operator.read" },
  { name: "routines.create", scope: "operator.admin" },
  { name: "routines.enable", scope: "operator.admin" },
  { name: "routines.disable", scope: "operator.admin" },
  { name: "routines.delete", scope: "operator.admin" },
