...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.browser.enabled": "Enable Browser Screenshot Vision",
  "tools.browser.maxBytes": "Browser Screenshot Vision Max Bytes",
  "tools.browser.maxChars": "Browser Screenshot Vision Max Chars",
  "tools.browser.prompt": "Browser Screenshot Vision Prompt",
  "tools.browser.timeoutSeconds": "Browser Screenshot Vision Timeout (sec)",
  "tools.browser.attachments": "Browser Screenshot Vision Attachment Policy",
  "tools.browser.models": "Browser Screenshot Vision Models",
  "tools.browser.scope": "Browser Screenshot Vision Scope",
