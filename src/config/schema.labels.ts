...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.list[].commandLane": "Agent Command Lane",
  "agents.list[].commandLane.id": "Agent Command Lane ID",
  "agents.list[].commandLane.maxConcurrent": "Agent Command Lane Max Concurrent",
  agents: "Agents",
  ...
  "agents.defaults.commandLane": "Default Agent Command Lane",
  "agents.defaults.commandLane.id": "Default Agent Command Lane ID",
  "agents.defaults.commandLane.maxConcurrent": "Default Agent Command Lane Max Concurrent",
