...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "memory.search.remote.nonBatchConcurrency": "Remote Non-Batch Embedding Concurrency",
  ...
  "memory.search.sync.sessions.postCompactionForce": "Force Reindex After Compaction",
  ...
  "memory.search.query.hybrid.temporalDecay.enabled": "Memory Search Temporal Decay",
  ...
  "agents.list.*.typingMode": "Agent Typing Mode",
  "agents.list.*.typingIntervalSeconds": "Agent Typing Interval (Seconds)",
