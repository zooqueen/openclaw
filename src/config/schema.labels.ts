...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "bindings[].session.channelGroup": "Binding Session Channel Group",
  ...
  "session.channelGroups": "Session Channel Groups",
  "session.channelGroups[].key": "Session Channel Group Key",
  "session.channelGroups[].peers": "Session Channel Group Peers",
  "session.channelGroups[].peers[].channel": "Session Channel Group Peer Channel",
  "session.channelGroups[].peers[].accountId": "Session Channel Group Peer Account",
  "session.channelGroups[].peers[].kind": "Session Channel Group Peer Kind",
  "session.channelGroups[].peers[].id": "Session Channel Group Peer ID",
