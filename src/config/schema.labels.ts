...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "memory.search.remote.batch.wait": "Remote Batch Wait for Completion",
  "memory.search.remote.batch.concurrency": "Remote Batch Concurrency",
  "memory.search.remote.batch.pollIntervalMs": "Remote Batch Poll Interval (ms)",
  "memory.search.remote.batch.timeoutMinutes": "Remote Batch Timeout (min)",
  ...
  "memory.search.local.contextSize": "Local Embedding Context Size",
  ...
  "memory.search.chunking.tokens": "Memory Chunk Tokens",
  "memory.search.chunking.overlap": "Memory Chunk Overlap Tokens",
  "memory.search.sync.onSessionStart": "Index on Session Start",
  "memory.search.sync.onSearch": "Index on Search (Lazy)",
  "memory.search.sync.watch": "Watch Memory Files",
  "memory.search.sync.watchDebounceMs": "Memory Watch Debounce (ms)",
  "memory.search.sync.embeddingBatchTimeoutSeconds": "Embedding Batch Timeout (s)",
  "memory.search.sync.sessions.deltaBytes": "Session Delta Bytes",
  "memory.search.sync.sessions.deltaMessages": "Session Delta Messages",
  ...
  "memory.search.query.hybrid.enabled": "Memory Search Hybrid",
  "memory.search.query.hybrid.vectorWeight": "Memory Search Vector Weight",
  "memory.search.query.hybrid.textWeight": "Memory Search Text Weight",
  "memory.search.query.hybrid.candidateMultiplier":
    "Memory Search Hybrid Candidate Multiplier",
  "memory.search.query.hybrid.mmr.enabled": "Memory Search MMR Re-ranking",
  "memory.search.query.hybrid.mmr.lambda": "Memory Search MMR Lambda",
  ...
  "memory.search.cache.maxEntries": "Memory Search Embedding Cache Max Entries",
  "memory": "Memory",
