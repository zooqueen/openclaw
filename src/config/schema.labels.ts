...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.memory.search": "Memory Search",
  "agents.defaults.memory.search.enabled": "Enable Memory Search",
  "agents.defaults.memory.search.sources": "Memory Search Sources",
  "agents.defaults.memory.search.extraPaths": "Extra Memory Paths",
  "agents.defaults.memory.search.qmd": "Memory Search QMD Collections",
  "agents.defaults.memory.search.qmd.extraCollections": "QMD Extra Collections",
  "agents.defaults.memory.search.qmd.extraCollections.path": "QMD Extra Collection Path",
  "agents.defaults.memory.search.qmd.extraCollections.name": "QMD Extra Collection Name",
  "agents.defaults.memory.search.qmd.extraCollections.pattern": "QMD Extra Collection Pattern",
  "agents.defaults.memory.search.multimodal": "Memory Search Multimodal",
  "agents.defaults.memory.search.multimodal.enabled": "Enable Memory Search Multimodal",
  "agents.defaults.memory.search.multimodal.modalities": "Memory Search Multimodal Modalities",
  ...
  "agents.defaults.memory.search.provider": "Memory Search Provider",
  "agents.defaults.memory.search.remote.baseUrl": "Remote Embedding Base URL",
  "agents.defaults.memory.search.remote.apiKey": "Remote Embedding API Key",
  "agents.defaults.memory.search.remote.headers": "Remote Embedding Headers",
  "agents.defaults.memory.search.remote.nonBatchConcurrency":
    "Remote Non-Batch Embedding Concurrency",
  "agents.defaults.memory.search.remote.batch.enabled": "Remote Batch Embedding Enabled",
  "agents.defaults.memory.search.remote.batch.wait": "Remote Batch Wait for Completion",
  "agents.defaults.memory.search.remote.batch.concurrency": "Remote Batch Concurrency",
  "agents.defaults.memory.search.remote.batch.pollIntervalMs": "Remote Batch Poll Interval (ms)",
  "agents.defaults.memory.search.remote.batch.timeoutMinutes": "Remote Batch Timeout (min)",
  "agents.defaults.memory.search.model": "Memory Search Model",
  "agents.defaults.memory.search.inputType": "Memory Search Input Type",
  "agents.defaults.memory.search.queryInputType": "Memory Search Query Input Type",
  "agents.defaults.memory.search.documentInputType": "Memory Search Document Input Type",
  "agents.defaults.memory.search.outputDimensionality": "Memory Search Output Dimensionality",
  ...
  "agents.defaults.memory.search.chunking.overlap": "Memory Chunk Overlap Tokens",
  "agents.defaults.memory.search.sync.onSessionStart": "Index on Session Start",
  "agents.defaults.memory.search.sync.onSearch": "Index on Search (Lazy)",
  "agents.defaults.memory.search.sync.watch": "Watch Memory Files",
  "agents.defaults.memory.search.sync.watchDebounceMs": "Memory Watch Debounce (ms)",
  "agents.defaults.memory.search.sync.embeddingBatchTimeoutSeconds": "Embedding Batch Timeout (s)",
  "agents.defaults.memory.search.sync.sessions.deltaBytes": "Session Delta Bytes",
  "agents.defaults.memory.search.sync.sessions.deltaMessages": "Session Delta Messages",
  "agents.defaults.memory.search.sync.sessions.postCompactionForce":
    "Force Reindex After Compaction",
  "agents.defaults.memory.search.query.maxResults": "Memory Search Max Results",
  "agents.defaults.memory.search.query.minScore": "Memory Search Min Score",
  "agents.defaults.memory.search.query.hybrid.enabled": "Memory Search Hybrid",
  "agents.defaults.memory.search.query.hybrid.vectorWeight": "Memory Search Vector Weight",
  "agents.defaults.memory.search.query.hybrid.textWeight": "Memory Search Text Weight",
  "agents.defaults.memory.search.query.hybrid.candidateMultiplier":
    "Memory Search Hybrid Candidate Multiplier",
  "agents.defaults.memory.search.query.hybrid.mmr.enabled": "Memory Search MMR Re-ranking",
  "agents.defaults.memory.search.query.hybrid.mmr.lambda": "Memory Search MMR Lambda",
  ...
  "agents.defaults.memory.search.cache.enabled": "Memory Search Embedding Cache",
  "agents.defaults.memory.search.cache.maxEntries": "Memory Search Embedding Cache Max Entries",
  "agents.defaults.memory": "Memory",
  "agents.defaults.memory.backend": "Memory Backend",
  "agents.defaults.memory.citations": "Memory Citations Mode",
  "agents.defaults.memory.qmd.command": "QMD Binary",
  "agents.defaults.memory.qmd.mcporter": "QMD MCPorter",
  "agents.defaults.memory.qmd.mcporter.enabled": "QMD MCPorter Enabled",
  "agents.defaults.memory.qmd.mcporter.serverName": "QMD MCPorter Server Name",
  "agents.defaults.memory.qmd.mcporter.startDaemon": "QMD MCPorter Start Daemon",
  "agents.defaults.memory.qmd.searchMode": "QMD Search Mode",
  "agents.defaults.memory.qmd.rerank": "QMD Rerank",
  "agents.defaults.memory.qmd.searchTool": "QMD Search Tool Override",
  "agents.defaults.memory.qmd.includeDefaultMemory": "QMD Include Default Memory",
  "agents.defaults.memory.qmd.paths": "QMD Extra Paths",
  "agents.defaults.memory.qmd.paths.path": "QMD Path",
  "agents.defaults.memory.qmd.paths.pattern": "QMD Path Pattern",
  "agents.defaults.memory.qmd.paths.name": "QMD Path Name",
  "agents.defaults.memory.qmd.sessions.enabled": "QMD Session Indexing",
  "agents.defaults.memory.qmd.sessions.exportDir": "QMD Session Export Directory",
  "agents.defaults.memory.qmd.sessions.retentionDays": "QMD Session Retention (days)",
  "agents.defaults.memory.qmd.update.interval": "QMD Update Interval",
  "agents.defaults.memory.qmd.update.debounceMs": "QMD Update Debounce (ms)",
  "agents.defaults.memory.qmd.update.onBoot": "QMD Update on Manager Start",
  "agents.defaults.memory.qmd.update.startup": "QMD Gateway Startup Refresh",
  "agents.defaults.memory.qmd.update.startupDelayMs": "QMD Gateway Startup Delay (ms)",
  "agents.defaults.memory.qmd.update.waitForBootSync": "QMD Wait for Manager-Start Sync",
  "agents.defaults.memory.qmd.update.embedInterval": "QMD Embed Interval",
  "agents.defaults.memory.qmd.update.commandTimeoutMs": "QMD Command Timeout (ms)",
  "agents.defaults.memory.qmd.update.updateTimeoutMs": "QMD Update Timeout (ms)",
  "agents.defaults.memory.qmd.update.embedTimeoutMs": "QMD Embed Timeout (ms)",
  "agents.defaults.memory.qmd.limits.maxResults": "QMD Max Results",
  "agents.defaults.memory.qmd.limits.maxSnippetChars": "QMD Max Snippet Chars",
  "agents.defaults.memory.qmd.limits.maxInjectedChars": "QMD Max Injected Chars",
  "agents.defaults.memory.qmd.limits.timeoutMs": "QMD Search Timeout (ms)",
  "agents.defaults.memory.qmd.scope": "QMD Surface Scope",
  auth: "Auth",
