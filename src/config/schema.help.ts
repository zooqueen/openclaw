...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.memorySearch.store.path":
    "SQLite database path for the memory-search index. Supports `{agentId}` substitution. Hosts can keep this path on local disk and persist it via `openclaw snapshot create --target memory-search --agent <id>`.",
