...
function createMediaGenerationTaskRun(params: {
  ...
  try {
    ...
    log.warn(
      ...
      {
        event: "agents.tools.media.generation.ledger.record",
        outcome: "warning",
        reason: "failed",
      },
    );
...
async function wakeMediaGenerationTaskCompletion(params: {
  ...
  if (delivery.terminal) {
    log.warn(
      ...
      {
        event: "agents.tools.media.completion.stopped.terminal",
        outcome: "warning",
        reason: "fallback",
      },
    );
  ...
  if (delivery.error) {
    log.error(
      ...
      {
        event: "agents.tools.media.requester.session",
        outcome: "failure",
        reason: "failed",
      },
    );
...
async function tryDeliverMediaGenerationDirect(params: {
  ...
  try {
    ...
    log.warn(
      ...
      {
        event: "agents.tools.media.falling",
        outcome: "warning",
        reason: "failed",
      },
    );
