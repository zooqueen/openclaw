...
export const __testing = {
  setDepsForTest(
    ...
    if (overrides.spawnSubagentDirect) {
      sessionsSpawnToolDeps.spawnSubagentDirect = overrides.spawnSubagentDirect;
    }
    if (overrides.spawnAcpDirect) {
      sessionsSpawnToolDeps.spawnAcpDirect = overrides.spawnAcpDirect;
    }
  },
  resetDepsForTest() {
    sessionsSpawnToolDeps.spawnSubagentDirect = spawnSubagentDirect;
    sessionsSpawnToolDeps.spawnAcpDirect = spawnAcpDirect;
  },
};
  ...
  return {
    ...
    execute: async (_toolCallId, args) => {
      ...
      if (runtime === "acp") {
        ...
        const result = await sessionsSpawnToolDeps.spawnAcpDirect(
          {
            task,
      ...
      const result = await sessionsSpawnToolDeps.spawnSubagentDirect(
        {
          task,
          label: label || undefined,
          agentId: requestedAgentId,
