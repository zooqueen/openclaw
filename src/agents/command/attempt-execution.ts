...
export function runAgentAttempt(params: {
  ...
  if (!isRawModelRun && isCliExecutionProvider) {
    ...
    const runCliWithSession = (
      ...
      runCliAgent({
        ...
        policyMessageProvider: params.opts.policyMessageProvider,
  ...
  return runEmbeddedAgent({
    ...
    messageProvider: params.opts.messageProvider ?? params.messageChannel,
    policyMessageProvider: params.opts.policyMessageProvider,
    chatType: params.runContext.chatType,
    routeMatchedBy: params.runContext.routeMatchedBy,
    agentAccountId: params.runContext.accountId,
    ...
    memberRoleIds: params.runContext.memberRoleIds,
