...
import type { ImageContent, Message, TextContent, Usage } from "../../llm/types.js";
...
export class SessionManager {
  ...
  private appendEntry(entry: SessionEntry, options?: AppendPersistenceOptions): void {
    const sideAppend = isSessionTranscriptSideAppendEntry(entry);
    if (
      !sideAppend &&
      entry.parentId === this.appendParentId &&
      this.leafId !== this.appendParentId
  ...
  appendCompactionUsageAccounting(data: unknown): string {
  ...
  createBranchedSession(leafId: string): string | undefined {
    ...
    const usageFamilyKey = previousSessionFile
      ? resolveSessionFileUsageFamilyKey({
