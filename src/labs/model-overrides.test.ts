...
describe("labs model overrides", () => {
  it("loads model and agent AGENTS addenda only when the Labs feature is enabled", async () => {
    const workspaceDir = await makeTempWorkspace("openclaw-labs-");
  ...
  it("keeps Labs addenda separate and inserts model then agent before the root AGENTS.md", () => {
  ...
  it("detects truncation for Labs AGENTS addenda by explicit paths or Labs pattern", () => {
