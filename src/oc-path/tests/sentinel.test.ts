...
describe("guardSentinel", () => {
  it("passes through normal strings", () => {
    expect(guardSentinel("normal value", "oc://SOUL.md")).toBeUndefined();
  });

  it("passes through non-string values", () => {
    expect(guardSentinel(42, "oc://SOUL.md")).toBeUndefined();
    expect(guardSentinel(null, "oc://SOUL.md")).toBeUndefined();
    expect(guardSentinel(undefined, "oc://SOUL.md")).toBeUndefined();
  });
