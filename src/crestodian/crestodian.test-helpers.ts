...
export type CrestodianVerifiedInferenceTestFixture = {
...
export async function createCrestodianVerifiedInferenceTestFixture(
  config: OpenClawConfig,
): Promise<CrestodianVerifiedInferenceTestFixture> {
